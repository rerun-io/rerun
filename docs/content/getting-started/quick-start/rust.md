...
After you have [installed the viewer](../../overview/installing-rerun/viewer.md) you can simply add [the Rerun crate](https://crates.io/crates/rerun) to your project with `cargo add rerun`.
