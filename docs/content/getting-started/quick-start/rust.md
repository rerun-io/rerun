...
The Rerun SDK for Rust requires a working installation of Rust 1.90+.

After you have [installed the viewer](../../overview/installing-rerun.md#installing-the-viewer) you can simply add [the Rerun crate](https://crates.io/crates/rerun) to your project with `cargo add rerun`.
