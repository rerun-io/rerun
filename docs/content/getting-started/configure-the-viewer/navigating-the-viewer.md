...
There are several ways to rearrange the viewer layout to your liking: through the Viewer [user interface](./interactively.md),
via the [Blueprint API](./through-code-tutorial.md), or by [loading an .rbl file](./save-and-load.md).
