...
-   [Recordings panel](../concepts/logging-and-ingestion/recordings-and-datasets.md) (top left): Lists loaded recordings and their applications, and allows navigation back to the welcome screen.
