...
If you'd rather learn from examples, check out the [example gallery](/examples) for some more realistic examples, or browse the [Loggable Types](../reference/loggable-types.md) section for more simple examples of how to use the main datatypes.
