...
* [images](../reference/loggable-types/archetypes/image.md) that were captured from a camera.
* [2d keypoints](../reference/loggable-types/archetypes/points2d.md) that were detected and tracked in those images.
* a [pinhole](../reference/loggable-types/archetypes/pinhole.md) camera model that describes the relationship between 2D and 3D space.
* [3d points](../reference/loggable-types/archetypes/points3d.md) that were computed by the COLMAP slam pipeline.
* A sequence of [transforms](../reference/loggable-types/archetypes/transform3d.md) describing the 3D location of the camera in space.
* A [scalar](../reference/loggable-types/archetypes/time_series_scalar.md) error metric that was computed by the algorithm for each frame.
