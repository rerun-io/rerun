...
Our [Python SDK](https://ref.rerun.io/docs/python) integrates with the rest of the Python ecosystem: the points and colors returned by [`build_color_spiral`](https://ref.rerun.io/docs/python/stable/common/demo_utilities/?speculative-link#rerun.utilities.build_color_spiral) in this example are vanilla `numpy` arrays.
