...
As a next step, browse through our [example gallery](/examples) for some more realistic example use-cases, or browse the [Loggable Types](../reference/loggable-types.md) section for more simple examples of how to use the main data types.
