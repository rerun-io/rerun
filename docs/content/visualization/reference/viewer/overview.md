...
The timeline panel gives you controls over what point in time you're looking at on which [timeline](../../../logging/concepts/timelines.md) for the rest of the viewer.
