...
The timeline controls sit at the top of the timeline panel and allow you to control the playback and what [timeline](../../../logging/concepts/timelines.md) is active.
...
On the right side you see circles for each logged [event](../../../logging/concepts/timelines.md) on the currently selected timeline over time.
