...
Annotation Context is typically logged as [static](../../logging/concepts/timelines.md#static-data) data, but can change over time if needed.
...
the nearest ancestor that in the [entity path hierarchy](../../concepts/entity-path.md#path-hierarchy-functions) that has an Annotation Context defined.
