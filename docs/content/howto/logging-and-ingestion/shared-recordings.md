...
Rerun has the notion of a [Recording ID](../../concepts/logging-and-ingestion/recordings-and-datasets.md) for that: any recorded datasets that share the same Recording ID will be visualized as one shared dataset.
