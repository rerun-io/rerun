...
All you need to do is implement the `AsComponents` [Python protocol](https://ref.rerun.io/docs/python/prerelease/package/rerun/__init__/#rerun.AsComponents) or [Rust trait](https://docs.rs/rerun/latest/rerun/trait.AsComponents.html), which means implementing the function, `as_component_batches()`.
