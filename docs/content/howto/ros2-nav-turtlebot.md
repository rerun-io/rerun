 ...
 * `map/robot` is a transform representing the robot pose logged as a rigid [transform3d](../reference/loggable-types/archetypes/transform3d.md).
 * `map/robot/urdf` contains the `URDF` logged as a [mesh](../reference/loggable-types/archetypes/mesh3d.md).
 * `map/robot/scan` contains a `LaserScan` msg logged as a [linestrip3d](../reference/loggable-types/archetypes/line_strips3d.md). (This will eventually be a
   native type: [#1534](https://github.com/rerun-io/rerun/issues/1534).)
 * `map/robot/camera` contains a `CameraInfo` msg logged as a [pinhole](../reference/loggable-types/archetypes/pinhole.md) transform.
 * `map/robot/camera/img` contains an `Image` msg logged as an [image](../reference/loggable-types/archetypes/image.md).
 * `map/robot/camera/points` contains a `PointCloud2` msg logged as a [point3d](../reference/loggable-types/archetypes/points3d.md).
 ...
 * `odometry/vel` is a plot of the linear velocity of the robot logged as a [scalar](../reference/loggable-types/archetypes/time_series_scalar.md).
 * `odometry/ang_vel` is a plot of the angular velocity of the robot logged as a [scalar](../reference/loggable-types/archetypes/time_series_scalar.md).
