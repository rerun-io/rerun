 ...
 * `map/robot/urdf` contains the `URDF` logged as a [mesh](../reference/data_types/mesh3d.md).
 * `map/robot/scan` contains a `LaserScan` msg logged as a [linestrip3d](../reference/data_types/line_strips3d.md). (This will eventually be a
 ...
 * `map/robot/camera/points` contains a `PointCloud2` msg logged as a [point3d](../reference/data_types/points3d.md).
 ...
 * `odometry/vel` is a plot of the linear velocity of the robot logged as a [scalar](../reference/data_types/time_series_scalar.md).
 * `odometry/ang_vel` is a plot of the angular velocity of the robot logged as a [scalar](../reference/data_types/time_series_scalar.md).
