...
There are currently two major ways of extending Rerun. You can use Rerun with [your own custom data](custom-data), or [extend the the Rerun Viewer](extend-ui) (currently Rust only).
