...
-   Web browsers, through our [JS package](../embed-rerun-viewer.md#callbacks)
-   Jupyter notebooks, through our [Notebook API](../notebook.md#reacting-to-events-in-the-viewer)
