...
* [`Ellipsoids`](../archetypes/ellipsoids.md) (if logged above active projection)
* [`LeafTransforms3D`](../archetypes/leaf_transforms3d.md) (if logged above active projection)
