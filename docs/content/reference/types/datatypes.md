...
* [`VideoPresentationTimestampOffset`](datatypes/video_presentation_timestamp_offset.md): An offset from decode timestamp (DTS) to presentation timestamp (PTS) for a video sample.
