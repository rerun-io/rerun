...
* [`IVec3D`](datatypes/ivec3d.md): An int32 vector in 3D space.
...
* [`SphericalHarmonics3Rgb`](datatypes/spherical_harmonics3rgb.md): Spherical harmonics coefficients of degrees 1 through 3 for RGB, as 15 half-precision RGB triples.
...
* [`ViewCoordinates`](datatypes/view_coordinates.md): An orientation convention for three-dimensional coordinates.
* [`ViewDir`](datatypes/view_dir.md): The six cardinal directions for 3D view-space.
