...
**Optional**: [`Color`](../components/color.md), [`StrokeWidth`](../components/stroke_width.md), [`Name`](../components/name.md), [`Text`](../components/text.md), [`AggregationPolicy`](../components/aggregation_policy.md)
