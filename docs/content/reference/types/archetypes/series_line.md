...
**Optional**: [`Color`](../components/color.md), [`StrokeWidth`](../components/stroke_width.md), [`Name`](../components/name.md), [`Visible`](../components/visible.md), [`AggregationPolicy`](../components/aggregation_policy.md)
