...
A monochrome or color image with optional alpha (opacity).

For compressed images and image files (JPEG, PNG, …), use [`archetypes.ImageEncoded`](https://rerun.io/docs/reference/types/archetypes/image_encoded?speculative-link).
