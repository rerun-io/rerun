...
Recording-level statistics about an MCAP file, logged as a part of [`archetypes.RecordingInfo`](/docs/reference/types/archetypes/recording_info).
...
See also [`archetypes.McapChannel`](/docs/reference/types/archetypes/mcap_channel) for individual channel definitions,
[`archetypes.McapMessage`](/docs/reference/types/archetypes/mcap_message) for message content, [`archetypes.McapSchema`](/docs/reference/types/archetypes/mcap_schema) for schema definitions,
