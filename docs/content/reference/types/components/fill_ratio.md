...
Used for instance to scale the points of the point cloud created from [`archetypes.DepthImage`](/docs/reference/types/archetypes/depth_image) projection in 3D views.
