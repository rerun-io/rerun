...
* An [`archetypes.Ellipsoids3D`](/docs/reference/types/archetypes/ellipsoids3d) will draw three axis-aligned ellipses that are cross-sections
  of each ellipsoid, each of which displays two out of three of the sizes of the ellipsoid.
* For [`archetypes.Boxes3D`](/docs/reference/types/archetypes/boxes3d), it is the edges of the box, identical to [`components.FillMode#DenseWireframe`](/docs/reference/types/components/fill_mode).
...
* An [`archetypes.Ellipsoids3D`](/docs/reference/types/archetypes/ellipsoids3d) will draw a wireframe triangle mesh that approximates each
  ellipsoid.
* For [`archetypes.Boxes3D`](/docs/reference/types/archetypes/boxes3d), it is the edges of the box, identical to [`components.FillMode#MajorWireframe`](/docs/reference/types/components/fill_mode).
