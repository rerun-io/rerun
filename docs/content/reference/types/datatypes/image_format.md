...
If specified, this takes precedence over both [`datatypes.ColorModel`](/docs/reference/types/datatypes/color_model) and [`datatypes.ChannelDatatype`](/docs/reference/types/datatypes/channel_datatype) (which are ignored).
...
Also requires a [`datatypes.ChannelDatatype`](/docs/reference/types/datatypes/channel_datatype) to fully specify the pixel format.
...
Also requires a [`datatypes.ColorModel`](/docs/reference/types/datatypes/color_model) to fully specify the pixel format.
