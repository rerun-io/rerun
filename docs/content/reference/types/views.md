...
* [`TextDocumentView`](views/text_document_view.md): A view of a single text document, for use with [`archetypes.TextDocument`](/docs/reference/types/archetypes/text_document).
* [`TextLogView`](views/text_log_view.md): A view of a text log, for use with [`archetypes.TextLog`](/docs/reference/types/archetypes/text_log).
* [`TimeSeriesView`](views/time_series_view.md): A time series view for scalars over time, for use with [`archetypes.Scalars`](/docs/reference/types/archetypes/scalars).
