...
Entities shown in the blueprint panel refer to their _data blueprints_—the entity plus its associated blueprint settings. Changes made here apply only to the specific view where the entity appears.
