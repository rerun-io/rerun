...
* The Native Viewer may be extended through its [Rust API](../cookbook/visualization/extend-ui.md)
* The Web Viewer can be [embedded in web applications](../cookbook/integrations/embed-web.md), and used in [Jupyter Notebooks](../cookbook/integrations/embed-notebooks.md)
