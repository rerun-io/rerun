...
To compensate for that, the Rerun viewer has a [garbage collection mechanism](../viewing/howto/limit-ram.md) that will drop the oldest data from the store when memory becomes scarce.
