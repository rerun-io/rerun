...
Before logging data, you can use `rr.set_time` to update the SDK's time context with timestamps for custom timelines.
...
Alternatively, chunks can be created from an existing Arrow [`RecordBatch`](https://arrow.apache.org/docs/python/generated/pyarrow.RecordBatch.html) using [`Chunk.from_record_batch`](https://ref.rerun.io/docs/python/stable/chunk#rerun.chunk.Chunk.from_record_batch):

snippet: concepts/build_chunk_from_record_batch[body]

`send_chunks` also accepts iterables of chunks, as well as instances of [`LazyChunkStream`](https://ref.rerun.io/docs/python/stable/chunk#rerun.chunk.LazyChunkStream), [`ChunkStore`](https://ref.rerun.io/docs/python/stable/chunk#rerun.chunk.ChunkStore), and [`LazyStore`](https://ref.rerun.io/docs/python/stable/chunk#rerun.chunk.LazyStore).
...
Reference:
* [🐍 Python `Chunk`](https://ref.rerun.io/docs/python/stable/chunk#rerun.chunk.Chunk)
* [🐍 Python `Chunk.from_columns`](https://ref.rerun.io/docs/python/stable/chunk#rerun.chunk.Chunk.from_columns)
* [🐍 Python `Chunk.from_record_batch`](https://ref.rerun.io/docs/python/stable/chunk#rerun.chunk.Chunk.from_record_batch)
...
[`rr.send_dataframe`](https://ref.rerun.io/docs/python/stable/common/columnar_api/#rerun.send_dataframe) and the related [`Chunk.from_dataframe`](https://ref.rerun.io/docs/python/stable/chunk#rerun.chunk.Chunk.from_dataframe) extend the single record batch equivalent and accept a full PyArrow [`Table`](https://arrow.apache.org/docs/python/generated/pyarrow.Table.html) (or a [`RecordBatchReader`](https://arrow.apache.org/docs/python/generated/pyarrow.RecordBatchReader.html), or any Arrow-C-stream object such as a `datafusion.DataFrame`) carrying any number of entities, and yields the chunks of each record batch in turn.
...
Reference:
* [🐍 Python `Chunk.from_dataframe`](https://ref.rerun.io/docs/python/stable/chunk#rerun.chunk.Chunk.from_dataframe)
