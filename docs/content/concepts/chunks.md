...
The `log` API is generally [what we show in the getting-started guides](/docs/getting-started/quick-start/python#logging-your-own-data) since it's the easiest to use:
