...
* The Native Viewer may be extended through its [Rust API](https://rerun.io/docs/howto/visualization/extend-ui)
* The Web Viewer can be [embedded in web applications](https://rerun.io/docs/howto/integrations/embed-web), and used in [Jupyter Notebooks](https://rerun.io/docs/howto/integrations/embed-notebooks)
