...
See [Configure the Viewer](../getting-started/configure-the-viewer.md#programmatic-blueprints) for detailed examples and our guide on how to [build a blueprint programmatically](../cookbook/build-a-blueprint-programmatically.md).
