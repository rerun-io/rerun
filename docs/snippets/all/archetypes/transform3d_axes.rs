...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    rec.log(
        "base",
        &[
            &rerun::Transform3D::clear_fields() as &dyn AsComponents,
    ...
    for deg in 0..360 {
        ...
        rec.log(
            "base/rotated",
            &[
                &rerun::Transform3D::clear_fields().with_rotation(rerun::RotationAxisAngle::new(
                    [1.0, 1.0, 1.0],
        ...
        rec.log(
            ...
            &[
                &rerun::Transform3D::clear_fields().with_translation([2.0, 0.0, 0.0])
                    as &dyn AsComponents,
                &rerun::TransformArrows3D::new(0.5),
            ],
        )?;
