...
def log_segmentation_image(
    ...
    * class_descriptions: obj_path for a class_descriptions object logged with `log_class_descriptions`
    ...
    if image.dtype == "uint8":
        rerun_sdk.log_tensor_u8(obj_path, image, None, None, class_descriptions, timeless)
    elif image.dtype == "uint16":
        rerun_sdk.log_tensor_u16(obj_path, image, None, None, class_descriptions, timeless)
    else:
