...
LineStrip2DType = ComponentTypeFactory("LineStrip2DType", LineStrip2DArray, REGISTERED_COMPONENT_NAMES["rerun.linestrip2d"])
...
LineStrip3DType = ComponentTypeFactory("LineStrip3DType", LineStrip3DArray, REGISTERED_COMPONENT_NAMES["rerun.linestrip3d"])
