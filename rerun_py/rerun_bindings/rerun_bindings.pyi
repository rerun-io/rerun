...
class SchemaInternal:
    ...
    def columns_for(
        ...
        When all parameters are None, returns all component columns.
        ...
        -------
        list[ComponentColumnDescriptor]
            List of column descriptors matching all provided criteria.
        ...
        ```python
        columns = schema.columns_for(entity_path="/world/points")
        ```

        Get columns for a specific archetype:

        ```python
        columns = schema.columns_for(archetype="rerun.archetypes.Points3D")
        ```

        Get columns matching multiple criteria:
