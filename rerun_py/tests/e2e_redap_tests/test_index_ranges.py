...
│ │ ---                              ┆ ---                  ┆ ---                  ┆ ---                        ┆ ---                        ┆ ---                           ┆ ---                           ┆ ---                  ┆ ---                  ┆ ---                  ┆ ---                  │ │
│ │ type: non-null Utf8              ┆ type: Int64          ┆ type: Int64          ┆ type: Timestamp(ns)        ┆ type: Timestamp(ns)        ┆ type: Timestamp(ns)           ┆ type: Timestamp(ns)           ┆ type: Duration(ns)   ┆ type: Duration(ns)   ┆ type: Int64          ┆ type: Int64          │ │
