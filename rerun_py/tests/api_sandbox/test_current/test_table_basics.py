...
def test_create_table_and_append(tmp_path: Path) -> None:
...
def test_write_table_with_record_batches(tmp_path: Path) -> None:
...
│ id          ┆ enabled       ┆ score         │
│ ---         ┆ ---           ┆ ---           │
│ type: Int32 ┆ type: Boolean ┆ type: Float64 │
╞═════════════╪═══════════════╪═══════════════╡
│ 1           ┆ true          ┆ 95.5          │
├╌╌╌╌╌╌╌╌╌╌╌╌╌┼╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌┼╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌┤
│ 2           ┆ false         ┆ 87.3          │
...
def test_table_overwrite_mode(tmp_path: Path) -> None:
