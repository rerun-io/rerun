...
│ │ ---                ┆ ---                          ┆ ---                               ┆ ---                                      │ │
│ │ type: Utf8         ┆ type: nullable Timestamp(ns) ┆ type: nullable List[nullable u32] ┆ type: nullable List[nullable             │ │
│ │                    ┆ index_name: timeline         ┆ archetype: Points2D               ┆ FixedSizeList[f32; 2]]                   │ │
│ │                    ┆ kind: index                  ┆ component: Points2D:colors        ┆ archetype: Points2D                      │ │
│ │                    ┆                              ┆ component_type: Color             ┆ component: Points2D:positions            │ │
│ │                    ┆                              ┆ entity_path: /points              ┆ component_type: Position2D               │ │
│ │                    ┆                              ┆ kind: data                        ┆ entity_path: /points                     │ │
│ │                    ┆                              ┆                                   ┆ kind: data                               │ │
│ ╞════════════════════╪══════════════════════════════╪═══════════════════════════════════╪══════════════════════════════════════════╡ │
