...
@define(init=False)
class MultiEnum:
    def __init__(self: Any, value1: encodings.EnumTestLike, *, value2: encodings.ValuedEnumLike | None = None) -> None:
        """
        Create a new instance of the MultiEnum encoding.
    ...
    value1: encodings.EnumTest = field()
    # The first value.
    #
    # (Docstring intentionally commented out to hide this field from the docs)

    value2: encodings.ValuedEnum | None = field(default=None)
    # The second value.
    #
    # (Docstring intentionally commented out to hide this field from the docs)
