...
def _mixed_fields__almost_flattened_scalar__special_field_converter_override(
    x: encodings.FlattenedScalarLike,
) -> encodings.FlattenedScalar:
    if isinstance(x, encodings.FlattenedScalar):
        return x
    else:
        return encodings.FlattenedScalar(x)
...
class MixedFields:
    def __init__(
        ...
        *,
        ...
        almost_flattened_scalar: encodings.FlattenedScalarLike,
        ...
        """Create a new instance of the MixedFields encoding."""
    ...
    almost_flattened_scalar: encodings.FlattenedScalar = field(
