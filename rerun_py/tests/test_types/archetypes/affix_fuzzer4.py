...
class AffixFuzzer4(Archetype):
    ...
    def __init__(
        self: Any,
        *,
        fuzz2101: datatypes.MixedFieldsArrayLike | None = None,
        fuzz2102: datatypes.MixedFieldsArrayLike | None = None,
        fuzz2103: datatypes.MixedFieldsArrayLike | None = None,
        fuzz2104: datatypes.MixedFieldsArrayLike | None = None,
        fuzz2105: datatypes.MixedFieldsArrayLike | None = None,
        fuzz2106: datatypes.MixedFieldsArrayLike | None = None,
        ...
        fuzz2114: datatypes.ScalarUnionArrayLike | None = None,
        fuzz2115: datatypes.ScalarUnionArrayLike | None = None,
