...
class AffixFuzzer4(Archetype):
    ...
    def __init__(
        self: Any,
        *,
        fuzz2101: encodings.MixedFieldsArrayLike | None = None,
        fuzz2102: encodings.MixedFieldsArrayLike | None = None,
        fuzz2103: encodings.MixedFieldsArrayLike | None = None,
        fuzz2104: encodings.MixedFieldsArrayLike | None = None,
        fuzz2105: encodings.MixedFieldsArrayLike | None = None,
        fuzz2106: encodings.MixedFieldsArrayLike | None = None,
        ...
        fuzz2114: encodings.ScalarUnionArrayLike | None = None,
        fuzz2115: encodings.ScalarUnionArrayLike | None = None,
