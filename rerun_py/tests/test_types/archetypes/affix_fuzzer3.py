...
class AffixFuzzer3(Archetype):
    ...
    def __init__(
        self: Any,
        *,
        fuzz2001: datatypes.MixedFieldsLike | None = None,
        fuzz2002: datatypes.MixedFieldsLike | None = None,
        fuzz2003: datatypes.MixedFieldsLike | None = None,
        fuzz2004: datatypes.MixedFieldsLike | None = None,
        fuzz2005: datatypes.MixedFieldsLike | None = None,
        fuzz2006: datatypes.MixedFieldsLike | None = None,
        ...
        fuzz2014: datatypes.ScalarUnionLike | None = None,
        fuzz2015: datatypes.ScalarUnionLike | None = None,
    ...
    def columns(
        cls,
        *,
        fuzz2001: datatypes.MixedFieldsArrayLike | None = None,
        fuzz2002: datatypes.MixedFieldsArrayLike | None = None,
        fuzz2003: datatypes.MixedFieldsArrayLike | None = None,
        fuzz2004: datatypes.MixedFieldsArrayLike | None = None,
        fuzz2005: datatypes.MixedFieldsArrayLike | None = None,
        fuzz2006: datatypes.MixedFieldsArrayLike | None = None,
        ...
        fuzz2014: datatypes.ScalarUnionArrayLike | None = None,
        fuzz2015: datatypes.ScalarUnionArrayLike | None = None,
