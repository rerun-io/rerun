...
class AffixFuzzer3(Archetype):
    ...
    def __init__(
        self: Any,
        *,
        fuzz2001: encodings.MixedFieldsLike | None = None,
        fuzz2002: encodings.MixedFieldsLike | None = None,
        fuzz2003: encodings.MixedFieldsLike | None = None,
        fuzz2004: encodings.MixedFieldsLike | None = None,
        fuzz2005: encodings.MixedFieldsLike | None = None,
        fuzz2006: encodings.MixedFieldsLike | None = None,
        ...
        fuzz2014: encodings.ScalarUnionLike | None = None,
        fuzz2015: encodings.ScalarUnionLike | None = None,
    ...
    def columns(
        cls,
        *,
        fuzz2001: encodings.MixedFieldsArrayLike | None = None,
        fuzz2002: encodings.MixedFieldsArrayLike | None = None,
        fuzz2003: encodings.MixedFieldsArrayLike | None = None,
        fuzz2004: encodings.MixedFieldsArrayLike | None = None,
        fuzz2005: encodings.MixedFieldsArrayLike | None = None,
        fuzz2006: encodings.MixedFieldsArrayLike | None = None,
        ...
        fuzz2014: encodings.ScalarUnionArrayLike | None = None,
        fuzz2015: encodings.ScalarUnionArrayLike | None = None,
