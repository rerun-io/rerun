...
class AffixFuzzer18(ComponentMixin):
    ...
    def __init__(self: Any, *, many_optional_unions: encodings.NestedUnionArrayLike | None = None) -> None:
    ...
    many_optional_unions: list[encodings.NestedUnion] | None = field(default=None)
