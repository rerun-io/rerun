...
class AffixFuzzer18(ComponentMixin):
    ...
    def __init__(self: Any, *, many_optional_unions: datatypes.NestedUnionArrayLike | None = None) -> None:
    ...
    many_optional_unions: list[datatypes.NestedUnion] | None = field(default=None)
