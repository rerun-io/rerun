...
from ._overrides import override_disconnected_space_native_to_pa_array_override  # noqa: F401
...
class DisconnectedSpaceArray(BaseExtensionArray[DisconnectedSpaceArrayLike]):
    ...
    def _native_to_pa_array(data: DisconnectedSpaceArrayLike, data_type: pa.DataType) -> pa.Array:
        return override_disconnected_space_native_to_pa_array_override(data, data_type)
