...
from ._overrides import depth_image_data__field_converter_override  # noqa: F401
...
class DepthImage(Archetype):
    ...
    data: components.TensorDataArray = field(
        metadata={"component": "primary"}, converter=depth_image_data__field_converter_override
    )
    """
