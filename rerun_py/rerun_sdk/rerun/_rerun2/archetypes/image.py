...
from ._overrides import override_image_data_converter  # noqa: F401
...
class Image(Archetype):
    ...
    data: components.TensorDataArray = field(metadata={"component": "primary"}, converter=override_image_data_converter)
    """
