...
# To address that:
# 1) rewrite everything in the form of `xxx___native_to_pa_array_override()`
# 2) higher level `xxx___native_to_pa_array_override()` should call into lower level `xxx::from_similar()`
...
def override_transform3d___native_to_pa_array_override(data: Transform3DArrayLike, data_type: pa.DataType) -> pa.Array:
