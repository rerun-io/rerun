...
class Scale3DType(BaseExtensionType):
    def __init__(self) -> None:
        pa.ExtensionType.__init__(
            self, pa.dense_union([pa.field("_null_markers", pa.null(), True, {}), pa.field("ThreeD", pa.list_(pa.field("item", pa.float32(), False, {}), 3), False, {}), pa.field("Uniform", pa.float32(), False, {})]), "rerun.datatypes.Scale3D"
        )
