...
from ._overrides import mat4x4_coeffs__field_converter_override  # noqa: F401
...
class Mat4x4:
    ...
    coeffs: npt.NDArray[np.float32] = field(converter=mat4x4_coeffs__field_converter_override)
