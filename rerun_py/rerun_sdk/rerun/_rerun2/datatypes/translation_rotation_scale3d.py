...
def _translationrotationscale3d_scale_converter(x: datatypes.Scale3DLike | None) -> datatypes.Scale3D | None:
    ...
    __init__ = translationrotationscale3d_init
