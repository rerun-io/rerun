...
from ._overrides import override_rotation_axis_angle_angle_converter  # noqa: F401
...
class RotationAxisAngle:
    ...
    angle: datatypes.Angle = field(converter=override_rotation_axis_angle_angle_converter)
    """
