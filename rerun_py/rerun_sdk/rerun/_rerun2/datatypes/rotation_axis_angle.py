...
class RotationAxisAngleType(BaseExtensionType):
    def __init__(self) -> None:
        pa.ExtensionType.__init__(
            self, pa.struct([pa.field("axis", pa.list_(pa.field("item", pa.float32(), False, {}), 3), False, {}), pa.field("angle", pa.dense_union([pa.field("Radians", pa.float32(), False, {}), pa.field("Degrees", pa.float32(), False, {})]), False, {})]), "rerun.datatypes.RotationAxisAngle"
        )
