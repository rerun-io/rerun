...
class PrimitiveComponent:
    ...
    def __array__(self, dtype: npt.DTypeLike = None) -> npt.NDArray[Any]:
        # You can replace `np.asarray` here with your own code by defining a function named "override_primitive_component__as_array_override"
...
class PrimitiveComponentArray(BaseExtensionArray[PrimitiveComponentArrayLike]):
    ...
    def _native_to_pa_array(data: PrimitiveComponentArrayLike, data_type: pa.DataType) -> pa.Array:
        raise NotImplementedError  # You need to implement "override_primitive_component__native_to_pa_array_override" in rerun_py/rerun_sdk/rerun/_rerun2/datatypes/_overrides/primitive_component.py
