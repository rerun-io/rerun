...
class Rotation3DType(BaseExtensionType):
    def __init__(self) -> None:
        pa.ExtensionType.__init__(
            self, pa.dense_union([pa.field("Quaternion", pa.list_(pa.field("item", pa.float32(), False, {}), 4), False, {}), pa.field("AxisAngle", pa.struct([pa.field("axis", pa.list_(pa.field("item", pa.float32(), False, {}), 3), False, {}), pa.field("angle", pa.dense_union([pa.field("Radians", pa.float32(), False, {}), pa.field("Degrees", pa.float32(), False, {})]), False, {})]), False, {})]), "rerun.datatypes.Rotation3D"
        )
