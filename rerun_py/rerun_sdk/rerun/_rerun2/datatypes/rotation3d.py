...
from ._overrides import override_rotation3d__inner_converter_override  # noqa: F401
...
class Rotation3D:
    ...
    inner: datatypes.Quaternion | datatypes.RotationAxisAngle = field(
        converter=override_rotation3d__inner_converter_override
    )
    """
...
class Rotation3DArray(BaseExtensionArray[Rotation3DArrayLike]):
    ...
    def _native_to_pa_array(data: Rotation3DArrayLike, data_type: pa.DataType) -> pa.Array:
        raise NotImplementedError  # You need to implement "override_rotation3d__native_to_pa_array_override" in rerun_py/rerun_sdk/rerun/_rerun2/datatypes/_overrides/rotation3d.py
