...
from ._overrides import override_rotation3d_inner_converter  # noqa: F401
...
class Rotation3D:
    ...
    inner: datatypes.Quaternion | datatypes.RotationAxisAngle = field(converter=override_rotation3d_inner_converter)
    """
