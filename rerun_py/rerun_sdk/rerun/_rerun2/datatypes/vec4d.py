...
Vec4DLike = Union[
    Vec4D,
    npt.NDArray[Any], Sequence[float]
]

Vec4DArrayLike = Union[
    Vec4D,
    Sequence[Vec4DLike],
    npt.NDArray[Any], Sequence[Sequence[float]], Sequence[float]
]
...
class Vec4DType(BaseExtensionType):
    def __init__(self) -> None:
        pa.ExtensionType.__init__(
            self, pa.list_(pa.field("item", pa.float32(), False, {}), 4), "rerun.datatypes.Vec4D"
        )
