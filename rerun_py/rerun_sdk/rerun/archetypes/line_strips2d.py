...
class LineStrips2D(Archetype, VisualizableArchetype):
    """
    **Archetype**: 2D line strips with positions and optional colors, radii, labels, etc.
    ...
    NAME: ClassVar[str] = "rerun.archetypes.LineStrips2D"
    ...
    def descriptor_strips() -> ComponentDescriptor:
        return ComponentDescriptor(
            "LineStrips2D:strips",
            archetype=LineStrips2D.NAME,
            component_type=components.LineStrip2DBatch._COMPONENT_TYPE,
        )
    ...
    def visualizer(self, *, mappings: list[VisualizerComponentMappingLike] | None = None) -> Visualizer:
        ...
        """
        return Visualizer("Lines2D", overrides=self.as_component_batches(), mappings=mappings)
