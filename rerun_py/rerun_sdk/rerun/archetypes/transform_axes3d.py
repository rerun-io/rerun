...
# Based on "crates/build/re_type_definitions/rerun/archetypes/transform_axes3d.def.rs".
...
class TransformAxes3D(Archetype, VisualizableArchetype):
    ...
    **Archetype**: A visual representation of a [`archetypes.Transform3D`][rerun.archetypes.Transform3D].
    ...
    def visualizer(self, *, mappings: list[VisualizerComponentMappingLike] | None = None) -> Visualizer:
        ...
        """
        return Visualizer("TransformAxes3D", overrides=self.as_component_batches(), mappings=mappings)
