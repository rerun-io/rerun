...
# Based on "crates/build/re_type_definitions/rerun/archetypes/capsules3d.def.rs".
    ...
    **Archetype**: 3D capsules; cylinders with hemispherical caps.
    ...
    def from_fields(
        ...
        *,
        ...
        lengths: encodings.Float32ArrayLike | None = None,
    ...
    def visualizer(self, *, mappings: list[VisualizerComponentMappingLike] | None = None) -> Visualizer:
        ...
        """
        return Visualizer("Capsules3D", overrides=self.as_component_batches(), mappings=mappings)
