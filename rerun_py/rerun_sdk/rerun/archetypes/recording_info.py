...
# Based on "crates/build/re_type_definitions/rerun/archetypes/recording_info.def.rs".
...
class RecordingInfo(Archetype):
    ...
    def __init__(
        self: Any, *, start_time: encodings.TimeIntLike | None = None, name: encodings.Utf8Like | None = None
    ) -> None:
        """
    ...
    def from_fields(
        ...
        *,
        ...
        start_time: encodings.TimeIntLike | None = None,
    ...
    def columns(
        cls,
        *,
        start_time: encodings.TimeIntArrayLike | None = None,
        name: encodings.Utf8ArrayLike | None = None,
    ) -> ComponentColumnList:
        """
