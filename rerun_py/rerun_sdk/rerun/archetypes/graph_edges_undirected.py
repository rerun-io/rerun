...
# You can extend this class by creating a "GraphEdgesUndirectedExt" class in "graph_edges_undirected_ext.py".
...
class GraphEdgesUndirected(Archetype):
    ...
    def __init__(
        ...
        *,
        ...
        """
        Create a new instance of the GraphEdgesUndirected archetype.
        ...
        # You can define your own __init__ function as a member of GraphEdgesUndirectedExt in graph_edges_undirected_ext.py
    ...
    @classmethod
    def _clear(cls) -> GraphEdgesUndirected:
        """Produce an empty GraphEdgesUndirected, bypassing `__init__`."""
