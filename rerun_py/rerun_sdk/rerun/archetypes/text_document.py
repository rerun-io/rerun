...
class TextDocument(Archetype, VisualizableArchetype):
    ...
    **Archetype**: A text element intended to be displayed in its own text box.
    ...
    NAME: ClassVar[str] = "rerun.archetypes.TextDocument"

    def __init__(self: Any, text: encodings.Utf8Like, *, media_type: encodings.Utf8Like | None = None) -> None:
        """
    ...
    def visualizer(self, *, mappings: list[VisualizerComponentMappingLike] | None = None) -> Visualizer:
        ...
        """
        return Visualizer("TextDocument", overrides=self.as_component_batches(), mappings=mappings)
