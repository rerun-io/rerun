    ...
    **Archetype**: An N-dimensional array of numbers.
    ...
    def from_fields(
        ...
        *,
        ...
        data: encodings.TensorDataLike | None = None,
    ...
    def columns(
        cls,
        *,
        data: encodings.TensorDataArrayLike | None = None,
    ...
    def visualizer(self, *, mappings: list[VisualizerComponentMappingLike] | None = None) -> Visualizer:
        ...
        """
        return Visualizer("Tensor", overrides=self.as_component_batches(), mappings=mappings)
