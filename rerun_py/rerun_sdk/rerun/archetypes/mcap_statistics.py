...
# Based on "crates/build/re_type_definitions/rerun/archetypes/mcap_statistics.def.rs".
...
class McapStatistics(Archetype):
    ...
    **Archetype**: Recording-level statistics about an MCAP file.
    ...
    def __init__(
        self: Any,
        *,
        message_count: encodings.UInt64Like,
        schema_count: encodings.UInt64Like,
        channel_count: encodings.UInt64Like,
        attachment_count: encodings.UInt64Like,
        metadata_count: encodings.UInt64Like,
        chunk_count: encodings.UInt64Like,
        message_start_time: encodings.TimeIntLike,
        message_end_time: encodings.TimeIntLike,
    ...
    def from_fields(
        ...
        *,
        ...
        message_count: encodings.UInt64Like | None = None,
        schema_count: encodings.UInt64Like | None = None,
        channel_count: encodings.UInt64Like | None = None,
        attachment_count: encodings.UInt64Like | None = None,
        metadata_count: encodings.UInt64Like | None = None,
        chunk_count: encodings.UInt64Like | None = None,
        message_start_time: encodings.TimeIntLike | None = None,
        message_end_time: encodings.TimeIntLike | None = None,
        channel_message_counts: components.ChannelMessageCountsLike | None = None,
    ) -> McapStatistics:
        """
    ...
    def columns(
        cls,
        *,
        message_count: encodings.UInt64ArrayLike | None = None,
        schema_count: encodings.UInt64ArrayLike | None = None,
        channel_count: encodings.UInt64ArrayLike | None = None,
        attachment_count: encodings.UInt64ArrayLike | None = None,
        metadata_count: encodings.UInt64ArrayLike | None = None,
        chunk_count: encodings.UInt64ArrayLike | None = None,
        message_start_time: encodings.TimeIntArrayLike | None = None,
        message_end_time: encodings.TimeIntArrayLike | None = None,
