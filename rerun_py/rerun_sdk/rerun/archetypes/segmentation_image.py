    ...
    **Archetype**: An image made up of integer [`components.ClassId`][rerun.components.ClassId]s.
    ...
    def descriptor_buffer() -> ComponentDescriptor:
        return ComponentDescriptor(
            "SegmentationImage:buffer",
            archetype=SegmentationImage.NAME,
    ...
    def visualizer(self, *, mappings: list[VisualizerComponentMappingLike] | None = None) -> Visualizer:
        ...
        """
        return Visualizer("SegmentationImage", overrides=self.as_component_batches(), mappings=mappings)
