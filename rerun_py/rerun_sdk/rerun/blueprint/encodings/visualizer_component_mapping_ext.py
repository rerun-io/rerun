...
class VisualizerComponentMappingExt:
    """Extension for [VisualizerComponentMapping][rerun.blueprint.encodings.VisualizerComponentMapping]."""

    @staticmethod
    def native_to_pa_array_override(data: VisualizerComponentMappingArrayLike, data_type: pa.DataType) -> pa.Array:
        from rerun.blueprint.encodings import ComponentSourceKindBatch
        from rerun.encodings import Utf8Batch
