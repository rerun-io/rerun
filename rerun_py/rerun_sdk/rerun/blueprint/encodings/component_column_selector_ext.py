...
class ComponentColumnSelectorExt:
    """Extension for [ComponentColumnSelector][rerun.blueprint.encodings.ComponentColumnSelector]."""

    def __init__(
        self: Any,
        spec: str | None = None,
        *,
        entity_path: encodings.EntityPathLike | None = None,
        component: encodings.Utf8Like | None = None,
    ) -> None:
        """
...
def _parse_spec(spec: str) -> tuple[encodings.EntityPath, encodings.Utf8]:
    """
    ...
    return encodings.EntityPath(entity_path), encodings.Utf8(component)
