...
class FilterIsNotNullExt:
    """Extension for [FilterIsNotNull][rerun.blueprint.encodings.FilterIsNotNull]."""

    @staticmethod
    def native_to_pa_array_override(input_data: FilterIsNotNullArrayLike, data_type: pa.DataType) -> pa.Array:
        from ...blueprint.encodings import ComponentColumnSelectorBatch
        from ...encodings import BoolBatch
