...
def _filter_is_not_null__active__special_field_converter_override(x: encodings.BoolLike) -> encodings.Bool:
...
class FilterIsNotNull(FilterIsNotNullExt):
    ...
    **Encoding**: Configuration for the filter is not null feature of the dataframe view.
    ...
    def __init__(
        self: Any, active: encodings.BoolLike, column: blueprint_encodings.ComponentColumnSelectorLike
    ) -> None:
        """
        Create a new instance of the FilterIsNotNull encoding.
    ...
    active: encodings.Bool = field(converter=_filter_is_not_null__active__special_field_converter_override)
    # Whether the filter by event feature is active.
    #
    # (Docstring intentionally commented out to hide this field from the docs)

    column: blueprint_encodings.ComponentColumnSelector = field()
    # The column used when the filter by event feature is used.
    #
    # (Docstring intentionally commented out to hide this field from the docs)
...
if TYPE_CHECKING:
    ...
    FilterIsNotNullLike = FilterIsNotNull | blueprint_encodings.ComponentColumnSelectorLike
