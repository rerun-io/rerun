...
class TextLogColumnExt:
    """Extension for [TextLogColumn][rerun.blueprint.encodings.TextLogColumn]."""

    def __init__(self: Any, kind: TextLogColumnKindLike, *, visible: encodings.BoolLike = True) -> None:
        """
