...
# Based on "crates/build/re_type_definitions/rerun/blueprint/components/lock_range_during_zoom.def.rs".
...
class LockRangeDuringZoom(encodings.Bool, ComponentMixin):
    """
    **Component**: Indicate whether the range should be locked when zooming in on the data.
    ...
    # Note: there are no fields here because LockRangeDuringZoom delegates to encodings.Bool


class LockRangeDuringZoomBatch(encodings.BoolBatch, ComponentBatchMixin):
