...
class TimelineName(encodings.Utf8, ComponentMixin):
    """
    **Component**: A timeline identified by its name.
    ...
    # Note: there are no fields here because TimelineName delegates to encodings.Utf8


class TimelineNameBatch(encodings.Utf8Batch, ComponentBatchMixin):
