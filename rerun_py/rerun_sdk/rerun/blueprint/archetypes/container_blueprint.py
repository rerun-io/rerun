...
# Based on "crates/build/re_type_definitions/rerun/blueprint/archetypes/container_blueprint.def.rs".
    ...
    **Archetype**: The description of a container.
    ...
    def __init__(
        ...
        *,
        ...
        contents: encodings.EntityPathArrayLike | None = None,
        col_shares: encodings.Float32ArrayLike | None = None,
        row_shares: encodings.Float32ArrayLike | None = None,
        active_tab: encodings.EntityPathLike | None = None,
        visible: encodings.BoolLike | None = None,
        grid_columns: encodings.UInt32Like | None = None,
    ) -> None:
        """
