...
class ForceManyBody(Archetype):
    def __init__(self: Any, force: blueprint_datatypes.ForceManyBodyLike):
    ...
    force: blueprint_components.ForceManyBodyBatch = field(
        metadata={"component": "required"},
        converter=blueprint_components.ForceManyBodyBatch._required,  # type: ignore[misc]
    )
