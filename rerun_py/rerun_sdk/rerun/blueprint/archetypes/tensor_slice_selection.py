...
# Based on "crates/build/re_type_definitions/rerun/blueprint/archetypes/tensor_slice_selection.def.rs".
...
class TensorSliceSelection(Archetype):
    ...
    **Archetype**: Specifies a 2D slice of a tensor.
    ...
    def __init__(
        self: Any,
        *,
        width: encodings.TensorDimensionSelectionLike | None = None,
        height: encodings.TensorDimensionSelectionLike | None = None,
        indices: encodings.TensorDimensionIndexSelectionArrayLike | None = None,
        slider: blueprint_encodings.TensorDimensionIndexSliderArrayLike | None = None,
    ) -> None:
        """
