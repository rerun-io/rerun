    ...
    **Archetype**: The query for the dataframe view.
    ...
    def from_fields(
        ...
        *,
        ...
        filter_by_range: blueprint_encodings.FilterByRangeLike | None = None,
        filter_is_not_null: blueprint_encodings.FilterIsNotNullLike | None = None,
        apply_latest_at: encodings.BoolLike | None = None,
        select: blueprint_encodings.SelectedColumnsLike | None = None,
        entity_order: blueprint_components.ColumnOrderLike | None = None,
        auto_scroll: encodings.BoolLike | None = None,
    ) -> DataframeQuery:
        """
