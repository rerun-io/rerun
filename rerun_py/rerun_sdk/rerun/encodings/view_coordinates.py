...
def _view_coordinates__coordinates__special_field_converter_override(x: ViewCoordinatesLike) -> list[encodings.ViewDir]:
    from operator import index
    from typing import SupportsIndex

    from .. import encodings

    if isinstance(x, encodings.ViewCoordinates):
        return x.coordinates

    def convert_value(value: object) -> encodings.ViewDir:
        if isinstance(value, (encodings.ViewDir, str)):
            return encodings.ViewDir.auto(value)
        if isinstance(value, SupportsIndex):
            return encodings.ViewDir.auto(index(value))
...
class ViewCoordinates:
    ...
    **Encoding**: An orientation convention for three-dimensional coordinates.
    ...
    def __init__(self: Any, coordinates: ViewCoordinatesLike) -> None:
        """
        Create a new instance of the ViewCoordinates encoding.
    ...
    coordinates: list[encodings.ViewDir] = field(
...
if TYPE_CHECKING:
    ...
    ViewCoordinatesLike = ViewCoordinates | Sequence[encodings.ViewDirLike] | npt.ArrayLike
