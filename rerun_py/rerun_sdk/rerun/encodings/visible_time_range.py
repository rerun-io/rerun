...
def _visible_time_range__timeline__special_field_converter_override(x: encodings.Utf8Like) -> encodings.Utf8:
...
class VisibleTimeRange(VisibleTimeRangeExt):
    ...
    **Encoding**: Visible time range bounds for a specific timeline.
    ...
    timeline: encodings.Utf8 = field(converter=_visible_time_range__timeline__special_field_converter_override)
    # Name of the timeline this applies to.
    #
    # (Docstring intentionally commented out to hide this field from the docs)

    range: encodings.TimeRange = field()
...
class VisibleTimeRangeBatch(BaseBatch[VisibleTimeRangeArrayLike]):
    ...
    def _native_to_pa_array(data: VisibleTimeRangeArrayLike, data_type: pa.DataType) -> pa.Array:
        from rerun.encodings import TimeRangeBatch, Utf8Batch
