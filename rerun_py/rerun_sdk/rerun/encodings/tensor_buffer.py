...
class TensorBuffer(TensorBufferExt):
    """
    **Encoding**: The underlying storage for [`archetypes.Tensor`][rerun.archetypes.Tensor].
...
class TensorBufferBatch(BaseBatch[TensorBufferArrayLike]):
    ...
    def _native_to_pa_array(data: TensorBufferArrayLike, data_type: pa.DataType) -> pa.Array:
        raise NotImplementedError(
            "Arrow serialization of TensorBuffer not implemented: We lack codegen for arrow-serialization of unions containing lists. Can't handle type rerun.encodings.TensorBuffer#U8"
