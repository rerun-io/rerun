...
class Mat3x3(Mat3x3Ext):
    ...
    **Encoding**: A 3x3 Matrix.
    ...
    np.testing.assert_array_equal(
        rr.encodings.Mat3x3([1, 2, 3, 4, 5, 6, 7, 8, 9]).flat_columns, np.array([1, 4, 7, 2, 5, 8, 3, 6, 9], dtype=np.float32)
    )
    np.testing.assert_array_equal(
        rr.encodings.Mat3x3([[1, 2, 3], [4, 5, 6], [7, 8, 9]]).flat_columns,
    ...
    ```python
    np.testing.assert_array_equal(
        rr.encodings.Mat3x3(columns=[1, 2, 3, 4, 5, 6, 7, 8, 9]).flat_columns,
