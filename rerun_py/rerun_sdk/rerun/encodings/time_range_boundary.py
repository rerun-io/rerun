...
class TimeRangeBoundary(TimeRangeBoundaryExt):
    ...
    * CursorRelative (encodings.TimeInt):
        Boundary is a value relative to the time cursor.

    * Absolute (encodings.TimeInt):
...
if TYPE_CHECKING:
    ...
    TimeRangeBoundaryLike = TimeRangeBoundary | None | encodings.TimeInt
    """A type alias for any TimeRangeBoundary-like object."""

    TimeRangeBoundaryArrayLike = TimeRangeBoundary | None | encodings.TimeInt | Sequence[TimeRangeBoundaryLike]
...
class TimeRangeBoundaryBatch(BaseBatch[TimeRangeBoundaryArrayLike]):
    ...
    def _native_to_pa_array(data: TimeRangeBoundaryArrayLike, data_type: pa.DataType) -> pa.Array:
        ...
        if not hasattr(data, "__iter__") or isinstance(data, (type(None), TimeRangeBoundary, encodings.TimeInt)):  # type: ignore[arg-type]
        ...
        num_nulls = 0
        variant_cursor_relative: list[encodings.TimeInt] = []
        variant_absolute: list[encodings.TimeInt] = []
