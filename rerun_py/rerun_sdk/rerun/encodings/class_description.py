...
class ClassDescription(ClassDescriptionExt):
    ...
    **Encoding**: The description of a semantic Class.
    ...
    the attached [`encodings.AnnotationInfo`][rerun.encodings.AnnotationInfo] to derive labels and colors.
    ...
    [`encodings.AnnotationInfo`][rerun.encodings.AnnotationInfo] specifically associated with the Keypoint.
    ...
    colored as described by the class's [`encodings.AnnotationInfo`][rerun.encodings.AnnotationInfo].
    ...
    info: encodings.AnnotationInfo = field(
        converter=ClassDescriptionExt.info__field_converter_override,  # type: ignore[misc]
    )
    # The [`encodings.AnnotationInfo`][rerun.encodings.AnnotationInfo] for the class.
    #
    # (Docstring intentionally commented out to hide this field from the docs)

    keypoint_annotations: list[encodings.AnnotationInfo] = field(
        converter=ClassDescriptionExt.keypoint_annotations__field_converter_override,  # type: ignore[misc]
    )
    # The [`encodings.AnnotationInfo`][rerun.encodings.AnnotationInfo] for all of the keypoints.
    #
    # (Docstring intentionally commented out to hide this field from the docs)

    keypoint_connections: list[encodings.KeypointPair] = field(
...
if TYPE_CHECKING:
    ...
    ClassDescriptionLike = ClassDescription | encodings.AnnotationInfoLike
