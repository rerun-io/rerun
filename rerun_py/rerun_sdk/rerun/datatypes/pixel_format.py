...
# Based on "crates/build/re_type_definitions/rerun/datatypes/pixel_format.def.rs".
...
class PixelFormatBatch(BaseBatch[PixelFormatArrayLike]):
    ...
    def _native_to_pa_array(data: PixelFormatArrayLike, data_type: pa.DataType) -> pa.Array:
        ...
        pa_data = [PixelFormat.auto(v).value if v is not None else None for v in data]  # type: ignore[redundant-expr]  # ty: ignore[not-iterable]
