...
class ChannelCountPairBatch(BaseBatch[ChannelCountPairArrayLike]):
    ...
    def _native_to_pa_array(data: ChannelCountPairArrayLike, data_type: pa.DataType) -> pa.Array:
        ...
        return pa.StructArray.from_arrays(
            [
                UInt16Batch([x.channel_id for x in data]).as_arrow_array(),  # type: ignore[misc, arg-type]
                UInt64Batch([x.message_count for x in data]).as_arrow_array(),  # type: ignore[misc, arg-type]
            ],
