...
class AnnotationContext(AnnotationContextExt, ComponentMixin):
    ...
    **Component**: The annotation context provides additional information on how to display entities.
    ...
    Entities can use [`encodings.ClassId`][rerun.encodings.ClassId]s and [`encodings.KeypointId`][rerun.encodings.KeypointId]s to provide annotations, and
    ...
    class_map: list[encodings.ClassDescriptionMapElem] = field(
...
if TYPE_CHECKING:
    ...
    AnnotationContextLike = (
        AnnotationContext | encodings.ClassDescriptionArrayLike | Sequence[encodings.ClassDescriptionMapElemLike]
    )
