...
class DrawOrder(encodings.Float32, ComponentMixin):
    """
    **Component**: Draw order of 2D elements. Higher values are drawn on top of lower values.
    ...
    # Note: there are no fields here because DrawOrder delegates to encodings.Float32


class DrawOrderBatch(encodings.Float32Batch, ComponentBatchMixin):
