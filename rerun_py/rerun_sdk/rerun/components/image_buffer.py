...
class ImageBuffer(encodings.Blob, ComponentMixin):
    """
    **Component**: A buffer that is known to store image data.
    ...
    # Note: there are no fields here because ImageBuffer delegates to encodings.Blob


class ImageBufferBatch(encodings.BlobBatch, ComponentBatchMixin):
