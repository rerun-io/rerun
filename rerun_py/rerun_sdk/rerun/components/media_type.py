...
class MediaType(MediaTypeExt, encodings.Utf8, ComponentMixin):
    """
    **Component**: A standardized media type (RFC2046, formerly known as MIME types), encoded as a string.
    ...
    # Note: there are no fields here because MediaType delegates to encodings.Utf8


class MediaTypeBatch(encodings.Utf8Batch, ComponentBatchMixin):
