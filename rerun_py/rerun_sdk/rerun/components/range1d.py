...
class Range1D(encodings.Range1D, ComponentMixin):
    ...
    # Note: there are no fields here because Range1D delegates to encodings.Range1D


class Range1DBatch(encodings.Range1DBatch, ComponentBatchMixin):
