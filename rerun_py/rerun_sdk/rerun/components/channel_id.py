...
class ChannelId(encodings.UInt16, ComponentMixin):
    """
    **Component**: A 16-bit ID representing an MCAP channel.
    ...
    # Note: there are no fields here because ChannelId delegates to encodings.UInt16


class ChannelIdBatch(encodings.UInt16Batch, ComponentBatchMixin):
