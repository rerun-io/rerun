...
class ClearIsRecursive(ClearIsRecursiveExt, encodings.Bool, ComponentMixin):
    ...
    # Note: there are no fields here because ClearIsRecursive delegates to encodings.Bool


class ClearIsRecursiveBatch(encodings.BoolBatch, ComponentBatchMixin):
