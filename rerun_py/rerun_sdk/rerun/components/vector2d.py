...
class Vector2D(encodings.Vec2D, ComponentMixin):
    """**Component**: A vector in 2D space."""

    _BATCH_TYPE = None
    # You can define your own __init__ function as a member of Vector2DExt in vector2d_ext.py

    # Note: there are no fields here because Vector2D delegates to encodings.Vec2D


class Vector2DBatch(encodings.Vec2DBatch, ComponentBatchMixin):
