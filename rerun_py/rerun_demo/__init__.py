...
print(f"DEV ENVIRONMENT DETECTED! Re-importing rerun_demo from: {real_path}", file=sys.stderr)

sys.path.insert(0, str(real_path))

del sys.modules["rerun_demo"]
sys.modules["rerun_demo"] = __import__("rerun_demo")
