...
for i in range(100):
    ...
    rr.set_index("temporal_100us_span", timedelta=i / 1000000)

    rr.set_index("temporal_100day_span_date_offset", timedelta=date_offset + i * 24 * 3600)
    rr.set_index("temporal_100s_span_date_offset", timedelta=date_offset + i)
    rr.set_index("temporal_100ms_span_date_offset", timedelta=date_offset + i / 1000)
    rr.set_index("temporal_100us_span_date_offset", timedelta=date_offset + i / 1000000)

    rr.set_index("temporal_100day_span_zero_centered", timedelta=(i - 50) * 24 * 3600)
    rr.set_index("temporal_100s_zero_centered", timedelta=i - 50)
