...
pub fn edit_or_view_vec2d(
    ...
    ui: &mut egui::Ui,
    value: &mut MaybeMutRef<'_, impl std::ops::DerefMut<Target = encodings::Vec2D>>,
) -> egui::Response {
    let mut value: MaybeMutRef<'_, encodings::Vec2D> = match value {
...
pub fn edit_or_view_vec3d(
    _ctx: &re_viewer_context::AppContext<'_>,
    ui: &mut egui::Ui,
    value: &mut MaybeMutRef<'_, impl std::ops::DerefMut<Target = encodings::Vec3D>>,
) -> egui::Response {
    let mut value: MaybeMutRef<'_, encodings::Vec3D> = match value {
        MaybeMutRef::Ref(value) => MaybeMutRef::Ref(value),
        MaybeMutRef::MutRef(value) => MaybeMutRef::MutRef(value),
    };
...
pub fn edit_or_view_vec2d_raw(
    ui: &mut egui::Ui,
    value: &mut MaybeMutRef<'_, encodings::Vec2D>,
) -> egui::Response {
    let x = value.0[0];
    let y = value.0[1];
    ...
    if let Some(value) = value.as_mut() {
        ...
        if response.changed() {
            *value = encodings::Vec2D([x_edit, y_edit]);
        }
...
pub fn edit_or_view_vec3d_raw(
    ui: &mut egui::Ui,
    value: &mut MaybeMutRef<'_, encodings::Vec3D>,
    ...
    if let Some(value) = value.as_mut() {
        ...
        if response.changed() {
            *value = encodings::Vec3D([x_edit, y_edit, z_edit]);
        }
