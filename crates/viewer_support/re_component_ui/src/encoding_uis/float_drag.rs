...
/// Generic editor for a [`re_sdk_types::encodings::Float32`] value from zero to max float.
pub fn edit_f32_zero_to_max(
    ctx: &re_viewer_context::AppContext<'_>,
    ui: &mut egui::Ui,
    value: &mut MaybeMutRef<'_, impl std::ops::DerefMut<Target = encodings::Float32>>,
) -> egui::Response {
    edit_f32_zero_to_max_with_suffix(ctx, ui, value, "")
}

/// Generic editor for a [`re_sdk_types::encodings::Float32`] value from zero to max float with a suffix.
...
/// Generic editor for a [`re_sdk_types::encodings::Float32`] value representing a ui points value.
...
/// Generic editor for a [`re_sdk_types::encodings::Float32`] value from min to max float.
...
/// Generic editor for a [`re_sdk_types::encodings::Float32`] value from zero to one float.
...
/// Generic editor for a [`re_sdk_types::encodings::Float64`] value from zero to max float.
pub fn edit_f64_zero_to_max(
    _ctx: &re_viewer_context::AppContext<'_>,
    ui: &mut egui::Ui,
    value: &mut MaybeMutRef<'_, impl std::ops::DerefMut<Target = encodings::Float64>>,
) -> egui::Response {
...
/// Generic editor for a [`re_sdk_types::encodings::Float64`] value from min to max float.
