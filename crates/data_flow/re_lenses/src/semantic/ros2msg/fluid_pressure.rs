...
/// Creates a lens for `sensor_msgs/msg/FluidPressure` messages.
pub fn fluid_pressure() -> Result<Lens, LensBuilderError> {
    Lens::derive("sensor_msgs.msg.FluidPressure:message")
        .to_component(
        ...
        .to_component(
            ...
            Selector::parse(".")?.pipe(constant_string("Pa")),
        )
        .build()
}
