use re_log_types::{AbsoluteTimeRange, EntityPathHash, TimePoint};
...
pub struct EntityStats {
    ...
    pub time_range: re_log_types::AbsoluteTimeRange,
...
impl Default for EntityStats {
    fn default() -> Self {
        Self {
            num_rows: 0,
            size_bytes: 0,
            time_range: re_log_types::AbsoluteTimeRange::EMPTY,
            num_static_cells: 0,
            static_size_bytes: 0,
        }
    }
