...
pub struct Tensor {
    ...
    pub data: crate::datatypes::TensorData,
}
        ...
        Ok({
            ...
            StructArray::new(
                (if let Some(ext) = extension_wrapper {
                    DataType::Extension(
                        ext.to_owned(),
                        Box::new(<crate::datatypes::Tensor>::to_arrow_datatype()),
                        None,
                    )
                } else {
                    <crate::datatypes::Tensor>::to_arrow_datatype()
                })
                .to_logical_type()
                .clone(),
                vec![
                    ...
                    },
                    {
                        ...
                        };
                        {
                            _ = data_bitmap;
                            _ = extension_wrapper;
                            crate::datatypes::TensorData::try_to_arrow_opt(data, None::<&str>)?
                        }
                    },
                ],
                bitmap,
                                ...
                                crate::DeserializationError::missing_struct_field(
                                    DataType::Struct(
                                        vec![
                                            ...
                                            : false, metadata : [].into(), }, Field { name : "data"
                                            .to_owned(), data_type : < crate ::datatypes::TensorData >
...
impl crate::Datatype for Tensor {}
