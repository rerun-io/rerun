...
impl<'s> From<Vec2D> for ::std::borrow::Cow<'s, Vec2D> {
    #[inline]
...
impl<'s> From<&'s Vec2D> for ::std::borrow::Cow<'s, Vec2D> {
    #[inline]
    fn from(value: &'s Vec2D) -> Self {
        std::borrow::Cow::Borrowed(value)
    }
}

impl<'s> crate::Loggable<'s> for Vec2D {
...
impl<'s> crate::Datatype<'s> for Vec2D {}
