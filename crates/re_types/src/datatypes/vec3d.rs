...
impl<'s> From<Vec3D> for ::std::borrow::Cow<'s, Vec3D> {
    #[inline]
...
impl<'s> From<&'s Vec3D> for ::std::borrow::Cow<'s, Vec3D> {
    #[inline]
    fn from(value: &'s Vec3D) -> Self {
        std::borrow::Cow::Borrowed(value)
    }
}

impl<'s> crate::Loggable<'s> for Vec3D {
...
impl<'s> crate::Datatype<'s> for Vec3D {}
