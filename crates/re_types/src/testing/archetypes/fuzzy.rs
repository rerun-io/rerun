...
impl AffixFuzzer1 {
    ...
    pub const fn marker_component() -> AffixFuzzer1Marker {
        AffixFuzzer1Marker
    }
}
...
impl crate::Archetype for AffixFuzzer1 {
    ...
    > {
        ...
        <AffixFuzzer1Marker>::try_to_arrow([Self::marker_component()], None);
        Ok([
            {
                Some({
...
pub struct AffixFuzzer1Marker;

impl<'a> From<AffixFuzzer1Marker> for ::std::borrow::Cow<'a, AffixFuzzer1Marker> {
    #[inline]
    fn from(value: AffixFuzzer1Marker) -> Self {
        std::borrow::Cow::Owned(value)
    }
}

impl<'a> From<&'a AffixFuzzer1Marker> for ::std::borrow::Cow<'a, AffixFuzzer1Marker> {
    #[inline]
    fn from(value: &'a AffixFuzzer1Marker) -> Self {
        std::borrow::Cow::Borrowed(value)
    }
}

impl crate::Loggable for AffixFuzzer1Marker {
        ...
        Self: Sized,
    {
        ...
        Ok(vec![
            ...
            data.as_any()
                ...
                .with_context("rerun.testing.archetypes.AffixFuzzer1Marker")?
                .null_count()
        ])
    }
...
impl crate::Component for AffixFuzzer1Marker {}
