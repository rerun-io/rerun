        ...
        Ok({
            let data = data
                ...
                .ok_or_else(|| crate::DeserializationError::DatatypeMismatch {
                    expected: DataType::Struct(vec![Field {
                        name: "value".to_owned(),
                        data_type: DataType::Float32,
                        is_nullable: false,
                        metadata: [].into(),
            ...
            if data.is_empty() {
                ...
                let value = {
                    ...
                    data.as_any()
                        ...
                        .map_err(|err| crate::DeserializationError::Context {
                            location: "rerun.testing.datatypes.FlattenedScalar#value".into(),
                            source: Box::new(err),
                        })?
                        .into_iter()
                        .map(|v| v.copied())
            ...
            if data.is_empty() {
                ...
                let single_float_optional = {
                    ...
                    data.as_any()
                        ...
                        .map_err(|err| crate::DeserializationError::Context {
                            location: "rerun.testing.datatypes.AffixFuzzer1#single_float_optional"
                                .into(),
                            source: Box::new(err),
                        })?
                        .into_iter()
                    ...
                    let data = &**arrays_by_name["many_floats_optional"];
                    {
                        ...
                        if data.is_empty() {
                            ...
                            let data = data
                                ...
                                .map_err(|err| crate::DeserializationError::Context {
                                    location: "rerun.testing.datatypes.AffixFuzzer1#many_floats_optional"
                                        .into(),
                                    source: Box::new(err),
                                })?
                                .into_iter()
                        ...
                        if data.is_empty() {
                            ...
                            let data = {
                                let downcast = data
                                    ...
                                    .map_err(|err| crate::DeserializationError::Context {
                                        location: "rerun.testing.datatypes.AffixFuzzer1#many_strings_optional"
                                            .into(),
                                        source: Box::new(err),
                                    })?;
                                let offsets = downcast.offsets();
                ...
                let from_parent = {
                    ...
                    data.as_any()
                        ...
                        .map_err(|err| crate::DeserializationError::Context {
                            location: "rerun.testing.datatypes.AffixFuzzer1#from_parent".into(),
                            source: Box::new(err),
                        })?
                        .into_iter()
                };
            ...
            if data.is_empty() {
                ...
                let degrees = {
                    ...
                    data.as_any()
                        ...
                        .map_err(|err| crate::DeserializationError::Context {
                            location: "rerun.testing.datatypes.AffixFuzzer3#degrees".into(),
                            source: Box::new(err),
                        })?
                        .into_iter()
                        .map(|v| v.copied())
                ...
                let radians = {
                    ...
                    data.as_any()
                        ...
                        .map_err(|err| crate::DeserializationError::Context {
                            location: "rerun.testing.datatypes.AffixFuzzer3#radians".into(),
                            source: Box::new(err),
                        })?
                        .into_iter()
                        .map(|v| v.copied())
