...
impl Points3D {
    ...
    pub const fn marker_component() -> Points3DMarker {
        Points3DMarker
    }
}
...
impl crate::Archetype for Points3D {
    ...
    > {
        ...
        <Points3DMarker>::try_to_arrow([Self::marker_component()], None);
        Ok([
            {
                Some({
                    let array =
...
pub struct Points3DMarker;

impl<'a> From<Points3DMarker> for ::std::borrow::Cow<'a, Points3DMarker> {
    #[inline]
    fn from(value: Points3DMarker) -> Self {
        std::borrow::Cow::Owned(value)
    }
}

impl<'a> From<&'a Points3DMarker> for ::std::borrow::Cow<'a, Points3DMarker> {
    #[inline]
    fn from(value: &'a Points3DMarker) -> Self {
        std::borrow::Cow::Borrowed(value)
    }
}

impl crate::Loggable for Points3DMarker {
        ...
        Self: Sized,
    {
        ...
        Ok(vec![
            ...
            data.as_any()
                ...
                .with_context("rerun.components.Points3DMarker")?
                .null_count()
        ])
    }
...
impl crate::Component for Points3DMarker {}
