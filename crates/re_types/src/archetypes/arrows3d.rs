...
impl Arrows3D {
    ...
    pub const fn marker_component() -> Arrows3DMarker {
        Arrows3DMarker
    }
}
...
impl crate::Archetype for Arrows3D {
    ...
    > {
        ...
        <Arrows3DMarker>::try_to_arrow([Self::marker_component()], None);
        Ok([
            {
                Some({
                    let array =
...
pub struct Arrows3DMarker;

impl<'a> From<Arrows3DMarker> for ::std::borrow::Cow<'a, Arrows3DMarker> {
    #[inline]
    fn from(value: Arrows3DMarker) -> Self {
        std::borrow::Cow::Owned(value)
    }
}

impl<'a> From<&'a Arrows3DMarker> for ::std::borrow::Cow<'a, Arrows3DMarker> {
    #[inline]
    fn from(value: &'a Arrows3DMarker) -> Self {
        std::borrow::Cow::Borrowed(value)
    }
}

impl crate::Loggable for Arrows3DMarker {
        ...
        Self: Sized,
    {
        ...
        Ok(vec![
            ...
            data.as_any()
                ...
                .with_context("rerun.components.Arrows3DMarker")?
                .null_count()
        ])
    }
...
impl crate::Component for Arrows3DMarker {}
