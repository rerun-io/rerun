use crate::{
    result::_Backtrace, ComponentList, ComponentName, DeserializationResult, ResultExt as _,
    SerializationResult,
};
...
pub trait Archetype {
    ...
    /// Reinterprets the archetype's contents as a set of [`ComponentList`]s.
    ///
    /// This is the main mechanism for easily extending builtin archetypes or writing your own.
