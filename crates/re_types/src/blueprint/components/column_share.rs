...
impl From<ColumnShare> for f32 {
    #[inline]
    fn from(value: ColumnShare) -> Self {
        value.0
    }
}
...
impl ::re_types_core::Loggable for ColumnShare {
        ...
        Self: Sized,
    {
        ...
        Ok(arrow_data
            ...
            .with_context("rerun.blueprint.components.ColumnShare#share")?
            .into_iter()
            .map(|opt| opt.copied())
            ...
            .with_context("rerun.blueprint.components.ColumnShare#share")
            .with_context("rerun.blueprint.components.ColumnShare")?)
    }
