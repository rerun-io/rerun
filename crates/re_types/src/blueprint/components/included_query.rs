...
#[repr(transparent)]
pub struct IncludedQuery(pub crate::datatypes::Uuid);

impl ::re_types_core::SizeBytes for IncludedQuery {
    #[inline]
...
impl<T: Into<crate::datatypes::Uuid>> From<T> for IncludedQuery {
    fn from(v: T) -> Self {
        Self(v.into())
    }
}

impl std::borrow::Borrow<crate::datatypes::Uuid> for IncludedQuery {
    #[inline]
...
impl std::ops::Deref for IncludedQuery {
...
::re_types_core::macros::impl_into_cow!(IncludedQuery);

impl ::re_types_core::Loggable for IncludedQuery {
        ...
        Self: Sized,
    {
        ...
        Ok({
            let arrow_data = arrow_data
                ...
                .with_context("rerun.blueprint.components.IncludedQuery#query_id")?;
        ...
        .collect::<DeserializationResult<Vec<Option<_>>>>()
        .with_context("rerun.blueprint.components.IncludedQuery#query_id")
        .with_context("rerun.blueprint.components.IncludedQuery")?)
    }
