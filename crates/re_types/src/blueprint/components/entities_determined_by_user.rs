...
impl From<EntitiesDeterminedByUser> for bool {
    #[inline]
    fn from(value: EntitiesDeterminedByUser) -> Self {
        value.0
    }
}
...
impl ::re_types_core::Loggable for EntitiesDeterminedByUser {
        ...
        Self: Sized,
    {
        ...
        Ok(arrow_data
            ...
            .with_context("rerun.blueprint.components.EntitiesDeterminedByUser#value")?
            .into_iter()
            .map(|v| v.ok_or_else(DeserializationError::missing_data))
            .map(|res| res.map(|v| Some(Self(v))))
            .collect::<DeserializationResult<Vec<Option<_>>>>()
            .with_context("rerun.blueprint.components.EntitiesDeterminedByUser#value")
            .with_context("rerun.blueprint.components.EntitiesDeterminedByUser")?)
    }
}
