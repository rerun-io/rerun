...
impl ::re_types_core::Loggable for IncludedQueries {
        ...
        Self: Sized,
    {
                ...
                let arrow_data_inner = {
                    let arrow_data_inner = &**arrow_data.values();
                    {
                        ...
                        if arrow_data_inner.is_empty() {
                            ...
                            let offsets = (0..)
                                .step_by(16usize)
                                .zip((16usize..).step_by(16usize).take(arrow_data_inner.len()));
                            let arrow_data_inner_inner = {
                                ...
                                arrow_data_inner_inner
                                    ...
                                    .with_context(
                                        "rerun.blueprint.components.IncludedQueries#query_ids",
                                    )?
                                    .into_iter()
                                    .map(|opt| opt.copied())
                                    .collect::<Vec<_>>()
        ...
        .collect::<DeserializationResult<Vec<Option<_>>>>()
        .with_context("rerun.blueprint.components.IncludedQueries#query_ids")
        .with_context("rerun.blueprint.components.IncludedQueries")?)
    }
}
