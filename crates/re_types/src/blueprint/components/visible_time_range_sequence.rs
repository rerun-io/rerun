...
::re_types_core::macros::impl_into_cow!(VisibleTimeRangeSequence);

impl ::re_types_core::Loggable for VisibleTimeRangeSequence {
        ...
        Self: Sized,
    {
        ...
        Ok(
            crate::datatypes::VisibleTimeRange::from_arrow_opt(arrow_data)
                ...
                .with_context("rerun.blueprint.components.VisibleTimeRangeSequence#value")
                .with_context("rerun.blueprint.components.VisibleTimeRangeSequence")?,
        )
    }
}
