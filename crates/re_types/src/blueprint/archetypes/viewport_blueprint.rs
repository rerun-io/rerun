...
pub struct ViewportBlueprint {
    ...
    pub space_views: Vec<crate::blueprint::components::SpaceViewId>,
...
static REQUIRED_COMPONENTS: once_cell::sync::Lazy<[ComponentName; 2usize]> =
    once_cell::sync::Lazy::new(|| {
        [
            "rerun.blueprint.components.SpaceViewId".into(),
    ...
    fn from_arrow(
        ...
        let space_views = {
            let array = arrays_by_name
                .get("rerun.blueprint.components.SpaceViewId")
                .ok_or_else(DeserializationError::missing_data)
                .with_context("rerun.blueprint.archetypes.ViewportBlueprint#space_views")?;
            <crate::blueprint::components::SpaceViewId>::from_arrow_opt(&**array)
                .with_context("rerun.blueprint.archetypes.ViewportBlueprint#space_views")?
                .into_iter()
...
impl ViewportBlueprint {
    pub fn new(
        space_views: impl IntoIterator<Item = impl Into<crate::blueprint::components::SpaceViewId>>,
