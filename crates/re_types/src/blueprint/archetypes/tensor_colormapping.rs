...
impl ::re_types_core::SizeBytes for TensorColormapping {
    #[inline]
...
static RECOMMENDED_COMPONENTS: once_cell::sync::Lazy<[ComponentName; 1usize]> =
    once_cell::sync::Lazy::new(
        || ["rerun.blueprint.components.TensorColormappingIndicator".into()],
    );
...
impl TensorColormapping {
    /// The total number of components in the archetype: 0 required, 1 recommended, 2 optional
    pub const NUM_COMPONENTS: usize = 3usize;
}

/// Indicator component for the [`TensorColormapping`] [`::re_types_core::Archetype`]
pub type TensorColormappingIndicator =
    ::re_types_core::GenericIndicatorComponent<TensorColormapping>;

impl ::re_types_core::Archetype for TensorColormapping {
    type Indicator = TensorColormappingIndicator;

    #[inline]
    fn name() -> ::re_types_core::ArchetypeName {
        "rerun.blueprint.archetypes.TensorColormapping".into()
    }
    ...
    fn indicator() -> MaybeOwnedComponentBatch<'static> {
        static INDICATOR: TensorColormappingIndicator = TensorColormappingIndicator::DEFAULT;
    ...
    fn from_arrow_components(
        ...
        let colormap = if let Some(array) = arrays_by_name.get("rerun.components.Colormap") {
            <crate::components::Colormap>::from_arrow_opt(&**array)
                .with_context("rerun.blueprint.archetypes.TensorColormapping#colormap")?
                .into_iter()
                .next()
                .flatten()
        } else {
        ...
        let gamma = if let Some(array) = arrays_by_name.get("rerun.components.GammaCorrection") {
            <crate::components::GammaCorrection>::from_arrow_opt(&**array)
                .with_context("rerun.blueprint.archetypes.TensorColormapping#gamma")?
                .into_iter()
                .next()
                .flatten()
        } else {
...
impl ::re_types_core::AsComponents for TensorColormapping {
...
impl TensorColormapping {
    /// Create a new `TensorColormapping`.
    #[inline]
    pub fn new() -> Self {
        Self {
            colormap: None,
