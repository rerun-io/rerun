...
impl std::borrow::Borrow<crate::datatypes::Vec2D> for Origin2D {
    #[inline]
...
impl std::ops::Deref for Origin2D {
...
impl<'a> From<Origin2D> for ::std::borrow::Cow<'a, Origin2D> {
    #[inline]
    fn from(value: Origin2D) -> Self {
        std::borrow::Cow::Owned(value)
    }
}

impl<'a> From<&'a Origin2D> for ::std::borrow::Cow<'a, Origin2D> {
    #[inline]
    fn from(value: &'a Origin2D) -> Self {
        std::borrow::Cow::Borrowed(value)
    }
}

impl crate::Loggable for Origin2D {
        ...
        Self: Sized,
    {
        ...
        .collect::<crate::DeserializationResult<Vec<Option<_>>>>()
        .with_context("rerun.components.Origin2D#origin")
        .with_context("rerun.components.Origin2D")?)
    }
