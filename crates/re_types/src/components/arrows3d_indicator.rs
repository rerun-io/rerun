...
/// in some cases.
#[derive(Clone, Debug)]
pub struct Arrows3DIndicator;

impl<'a> From<Arrows3DIndicator> for ::std::borrow::Cow<'a, Arrows3DIndicator> {
    #[inline]
    fn from(value: Arrows3DIndicator) -> Self {
        std::borrow::Cow::Owned(value)
    }
}

impl<'a> From<&'a Arrows3DIndicator> for ::std::borrow::Cow<'a, Arrows3DIndicator> {
    #[inline]
    fn from(value: &'a Arrows3DIndicator) -> Self {
        std::borrow::Cow::Borrowed(value)
    }
}

impl crate::Loggable for Arrows3DIndicator {
        ...
        Ok(std::iter::repeat(Ok(Some(Self)))
            .take(
                arrow_data
                    ...
                    .with_context("rerun.components.Arrows3DIndicator")?
                    .null_count(),
            )
