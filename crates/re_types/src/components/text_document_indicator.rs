...
/// in some cases.
#[derive(Clone, Debug)]
pub struct TextDocumentIndicator;

impl<'a> From<TextDocumentIndicator> for ::std::borrow::Cow<'a, TextDocumentIndicator> {
    #[inline]
    fn from(value: TextDocumentIndicator) -> Self {
        std::borrow::Cow::Owned(value)
    }
}

impl<'a> From<&'a TextDocumentIndicator> for ::std::borrow::Cow<'a, TextDocumentIndicator> {
    #[inline]
    fn from(value: &'a TextDocumentIndicator) -> Self {
        std::borrow::Cow::Borrowed(value)
    }
}

impl crate::Loggable for TextDocumentIndicator {
        ...
        Ok(std::iter::repeat(Ok(Some(Self)))
            .take(
                arrow_data
                    ...
                    .with_context("rerun.components.TextDocumentIndicator")?
                    .null_count(),
            )
