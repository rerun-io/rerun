...
impl ::re_types_core::SizeBytes for TimeSeriesAggregator {
    #[inline]
...
::re_types_core::macros::impl_into_cow!(TimeSeriesAggregator);

impl ::re_types_core::Loggable for TimeSeriesAggregator {
        ...
        Self: Sized,
    {
        ...
        Ok({
            let arrow_data = arrow_data
                ...
                .with_context("rerun.components.TimeSeriesAggregator")?;
