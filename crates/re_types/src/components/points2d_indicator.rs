...
/// in some cases.
#[derive(Clone, Debug)]
pub struct Points2DIndicator;

impl<'a> From<Points2DIndicator> for ::std::borrow::Cow<'a, Points2DIndicator> {
    #[inline]
    fn from(value: Points2DIndicator) -> Self {
        std::borrow::Cow::Owned(value)
    }
}

impl<'a> From<&'a Points2DIndicator> for ::std::borrow::Cow<'a, Points2DIndicator> {
    #[inline]
    fn from(value: &'a Points2DIndicator) -> Self {
        std::borrow::Cow::Borrowed(value)
    }
}

impl crate::Loggable for Points2DIndicator {
        ...
        Ok(std::iter::repeat(Ok(Some(Self)))
            .take(
                arrow_data
                    ...
                    .with_context("rerun.components.Points2DIndicator")?
                    .null_count(),
            )
