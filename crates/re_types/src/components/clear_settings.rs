...
impl<'a> From<&'a ClearSettings> for ::std::borrow::Cow<'a, ClearSettings> {
    #[inline]
    fn from(value: &'a ClearSettings) -> Self {
        std::borrow::Cow::Borrowed(value)
    }
}

impl crate::Loggable for ClearSettings {
        ...
        Self: Sized,
    {
        ...
        Ok(arrow_data
            ...
            .with_context("rerun.components.ClearSettings#recursive")?
            .into_iter()
            .map(|v| v.ok_or_else(crate::DeserializationError::missing_data))
            .map(|res| res.map(|v| Some(Self(v))))
            .collect::<crate::DeserializationResult<Vec<Option<_>>>>()
            .with_context("rerun.components.ClearSettings#recursive")
            .with_context("rerun.components.ClearSettings")?)
    }
}
