...
#[repr(transparent)]
pub struct UVector3D(pub crate::datatypes::UVec3D);

impl ::re_types_core::SizeBytes for UVector3D {
    #[inline]
...
impl<T: Into<crate::datatypes::UVec3D>> From<T> for UVector3D {
    fn from(v: T) -> Self {
        Self(v.into())
    }
}

impl std::borrow::Borrow<crate::datatypes::UVec3D> for UVector3D {
    #[inline]
...
impl std::ops::Deref for UVector3D {
...
::re_types_core::macros::impl_into_cow!(UVector3D);

impl ::re_types_core::Loggable for UVector3D {
        ...
        Self: Sized,
    {
        ...
        Ok({
            let arrow_data = arrow_data
                ...
                .with_context("rerun.components.UVector3D#vector")?;
        ...
        .collect::<DeserializationResult<Vec<Option<_>>>>()
        .with_context("rerun.components.UVector3D#vector")
        .with_context("rerun.components.UVector3D")?)
    }
