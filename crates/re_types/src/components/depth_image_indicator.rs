...
/// in some cases.
#[derive(Clone, Debug)]
pub struct DepthImageIndicator;

impl<'a> From<DepthImageIndicator> for ::std::borrow::Cow<'a, DepthImageIndicator> {
    #[inline]
    fn from(value: DepthImageIndicator) -> Self {
        std::borrow::Cow::Owned(value)
    }
}

impl<'a> From<&'a DepthImageIndicator> for ::std::borrow::Cow<'a, DepthImageIndicator> {
    #[inline]
    fn from(value: &'a DepthImageIndicator) -> Self {
        std::borrow::Cow::Borrowed(value)
    }
}

impl crate::Loggable for DepthImageIndicator {
        ...
        Ok(std::iter::repeat(Ok(Some(Self)))
            .take(
                arrow_data
                    ...
                    .with_context("rerun.components.DepthImageIndicator")?
                    .null_count(),
            )
