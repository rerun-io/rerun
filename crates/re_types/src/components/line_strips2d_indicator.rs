...
/// in some cases.
#[derive(Clone, Debug)]
pub struct LineStrips2DIndicator;

impl<'a> From<LineStrips2DIndicator> for ::std::borrow::Cow<'a, LineStrips2DIndicator> {
    #[inline]
    fn from(value: LineStrips2DIndicator) -> Self {
        std::borrow::Cow::Owned(value)
    }
}

impl<'a> From<&'a LineStrips2DIndicator> for ::std::borrow::Cow<'a, LineStrips2DIndicator> {
    #[inline]
    fn from(value: &'a LineStrips2DIndicator) -> Self {
        std::borrow::Cow::Borrowed(value)
    }
}

impl crate::Loggable for LineStrips2DIndicator {
        ...
        Ok(std::iter::repeat(Ok(Some(Self)))
            .take(
                arrow_data
                    ...
                    .with_context("rerun.components.LineStrips2DIndicator")?
                    .null_count(),
            )
