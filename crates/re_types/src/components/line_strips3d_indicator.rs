...
/// in some cases.
#[derive(Clone, Debug)]
pub struct LineStrips3DIndicator;

impl<'a> From<LineStrips3DIndicator> for ::std::borrow::Cow<'a, LineStrips3DIndicator> {
    #[inline]
    fn from(value: LineStrips3DIndicator) -> Self {
        std::borrow::Cow::Owned(value)
    }
}

impl<'a> From<&'a LineStrips3DIndicator> for ::std::borrow::Cow<'a, LineStrips3DIndicator> {
    #[inline]
    fn from(value: &'a LineStrips3DIndicator) -> Self {
        std::borrow::Cow::Borrowed(value)
    }
}

impl crate::Loggable for LineStrips3DIndicator {
        ...
        Ok(std::iter::repeat(Ok(Some(Self)))
            .take(
                arrow_data
                    ...
                    .with_context("rerun.components.LineStrips3DIndicator")?
                    .null_count(),
            )
