...
impl ::re_types_core::SizeBytes for ImageScalingMode {
    #[inline]
...
impl std::fmt::Display for ImageScalingMode {
...
::re_types_core::macros::impl_into_cow!(ImageScalingMode);

impl ::re_types_core::Loggable for ImageScalingMode {
        ...
        Self: Sized,
    {
        ...
        Ok({
            let arrow_data = arrow_data
                ...
                .with_context("rerun.components.ImageScalingMode")?;
