...
/// in some cases.
#[derive(Clone, Debug)]
pub struct Points3DIndicator;

impl<'a> From<Points3DIndicator> for ::std::borrow::Cow<'a, Points3DIndicator> {
    #[inline]
    fn from(value: Points3DIndicator) -> Self {
        std::borrow::Cow::Owned(value)
    }
}

impl<'a> From<&'a Points3DIndicator> for ::std::borrow::Cow<'a, Points3DIndicator> {
    #[inline]
    fn from(value: &'a Points3DIndicator) -> Self {
        std::borrow::Cow::Borrowed(value)
    }
}

impl crate::Loggable for Points3DIndicator {
        ...
        Ok(std::iter::repeat(Ok(Some(Self)))
            .take(
                arrow_data
                    ...
                    .with_context("rerun.components.Points3DIndicator")?
                    .null_count(),
            )
