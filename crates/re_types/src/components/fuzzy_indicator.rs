...
/// in some cases.
#[derive(Clone, Debug)]
pub struct AffixFuzzer1Indicator;

impl<'a> From<AffixFuzzer1Indicator> for ::std::borrow::Cow<'a, AffixFuzzer1Indicator> {
    #[inline]
    fn from(value: AffixFuzzer1Indicator) -> Self {
        std::borrow::Cow::Owned(value)
    }
}

impl<'a> From<&'a AffixFuzzer1Indicator> for ::std::borrow::Cow<'a, AffixFuzzer1Indicator> {
    #[inline]
    fn from(value: &'a AffixFuzzer1Indicator) -> Self {
        std::borrow::Cow::Borrowed(value)
    }
}

impl crate::Loggable for AffixFuzzer1Indicator {
    type Name = crate::ComponentName;

    #[inline]
    fn name() -> Self::Name {
        "rerun.components.AffixFuzzer1Indicator".into()
    }
        ...
        Ok(std::iter::repeat(Ok(Some(Self)))
            .take(
                arrow_data
                    ...
                    .with_context("rerun.components.AffixFuzzer1Indicator")?
                    .null_count(),
            )
