...
/// in some cases.
#[derive(Clone, Debug)]
pub struct Transform3DIndicator;

impl<'a> From<Transform3DIndicator> for ::std::borrow::Cow<'a, Transform3DIndicator> {
    #[inline]
    fn from(value: Transform3DIndicator) -> Self {
        std::borrow::Cow::Owned(value)
    }
}

impl<'a> From<&'a Transform3DIndicator> for ::std::borrow::Cow<'a, Transform3DIndicator> {
    #[inline]
    fn from(value: &'a Transform3DIndicator) -> Self {
        std::borrow::Cow::Borrowed(value)
    }
}

impl crate::Loggable for Transform3DIndicator {
        ...
        Ok(std::iter::repeat(Ok(Some(Self)))
            .take(
                arrow_data
                    ...
                    .with_context("rerun.components.Transform3DIndicator")?
                    .null_count(),
            )
