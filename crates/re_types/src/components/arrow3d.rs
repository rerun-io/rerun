...
pub struct Arrow3D(pub crate::datatypes::Arrow3D);

impl From<crate::datatypes::Arrow3D> for Arrow3D {
    fn from(v: crate::datatypes::Arrow3D) -> Self {
        Self(v)
    }
}
...
impl crate::Loggable for Arrow3D {
        ...
        Self: Clone + 'a,
    {
        ...
        Ok({
            ...
            };
            {
                _ = data0_bitmap;
                _ = extension_wrapper;
                crate::datatypes::Arrow3D::try_to_arrow_opt(
                    data0,
                    Some("rerun.components.Arrow3D"),
                )?
            }
        })
    }
        ...
        Self: Sized,
    {
        use crate::Loggable as _;
        use ::arrow2::{array::*, datatypes::*};
        Ok(crate::datatypes::Arrow3D::try_from_arrow_opt(data)
            .map_err(|err| crate::DeserializationError::Context {
                location: "rerun.components.Arrow3D#arrow".into(),
                source: Box::new(err),
            })?
            .into_iter()
            .map(|v| {
...
impl crate::Component for Arrow3D {}
