...
// ---
//
//  TODO: err handling still a mess in this one

// TODO: external example of implementing this mess too

/// A builtin [`DataLoader`]
//
// TODO: Archetype file loader
...
impl DataLoader for ArchetypeLoader {
    ...
    fn load_from_file_contents(
        ...
        let entity_path = EntityPath::from_file_path(&filepath); // TODO: eeeh

        let timepoint = TimePoint::timeless();
        // TODO: logging time here breaks heuristics (??!)
        ...
        if crate::SUPPORTED_POINT_CLOUD_EXTENSIONS.contains(&extension.as_str()) {
...
// TODO: issue -> support for mesh ply files
fn load_point_cloud(
    timepoint: TimePoint,
