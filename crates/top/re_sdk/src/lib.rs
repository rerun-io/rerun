...
pub mod sink {
    ...
    pub use crate::{
        binary_stream_sink::{BinaryStreamSink, BinaryStreamStorage},
        log_sink::{
            BufferedSink, CallbackSink, GrpcSink, GrpcSinkConnectionFailure,
            GrpcSinkConnectionState, IntoMultiSink, LogSink, MemorySink, MemorySinkStorage,
...
pub mod external {
    ...
    pub use re_log::{self, external::*};
    pub use re_log_encoding;
    pub use re_log_types::{self, external::*};
    pub use re_uri;
}
