...
impl<'a> From<ViewportLayout> for ::std::borrow::Cow<'a, ViewportLayout> {
    #[inline]
...
impl<'a> From<&'a ViewportLayout> for ::std::borrow::Cow<'a, ViewportLayout> {
    #[inline]
    fn from(value: &'a ViewportLayout) -> Self {
...
impl ::re_types_core::Loggable for ViewportLayout {
    ...
    #[inline]
    fn name() -> Self::Name {
        "rerun.blueprint.ViewportLayout".into()
    }
        ...
        Self: Sized,
    {
        ...
        Ok({
            let arrow_data = arrow_data
                ...
                .with_context("rerun.blueprint.ViewportLayout")?;
