...
impl<'s> SceneQuery<'s> {
    ...
    ///
    /// An `ObjStore` is considered relevant if it contains one of the types we are looking for,
    /// and is currently visible according to the state of the blueprint.
