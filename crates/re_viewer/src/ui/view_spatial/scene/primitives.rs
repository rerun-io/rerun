...
use re_renderer::{
    renderer::MeshInstance, LineStripSeriesBuilder, PointCloudBuilder, RenderContext,
};
...
impl SceneSpatialPrimitives {
    pub fn new(re_ctx: &mut RenderContext) -> Self {
        SceneSpatialPrimitives {
            ...
            points: PointCloudBuilder::new(re_ctx, 1000000, 1000), // TODO:
