...
// TODO: gotta bring back all these tests to life, without comparisons :'(
...
fn query_and_compare(
    ...
    expected_all_points: &[((TimeInt, RowId), Vec<MyPoint>)],
    expected_all_colors: &[((TimeInt, RowId), Vec<MyColor>)],
) {
