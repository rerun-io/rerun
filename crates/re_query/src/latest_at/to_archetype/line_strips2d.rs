...
impl crate::ToArchetype<re_types::archetypes::LineStrips2D> for LatestAtResults {
    #[inline]
    fn to_archetype(
        &self,
        resolver: &PromiseResolver,
    ) -> PromiseResult<crate::Result<re_types::archetypes::LineStrips2D>> {
        ...
        let strips = match strips.to_dense::<LineStrip2D>(resolver) {
