...
use re_chunk::Chunk;
use re_data_store2::{DataStore2, LatestAtQuery, StoreSubscriber2};
use re_log_types::{entity_path, EntityPath, RowId, TimeInt, TimeType, Timeline};
...
fn insert_chunks<'a>(msgs: impl Iterator<Item = &'a Arc<Chunk>>) -> (Caches, DataStore2) {
