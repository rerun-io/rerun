...
fn main() -> anyhow::Result<()> {
    ...
    let colors: &CachedLatestAtComponentResults = results.get_optional(MyColor::name());
    let labels: &CachedLatestAtComponentResults = results.get_optional(MyLabel::name());
