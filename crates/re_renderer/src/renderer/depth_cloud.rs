...
fn create_and_upload_texture<T: bytemuck::Pod>(
    ...
    if bytes_per_row_aligned == bytes_per_row_unaligned {
        ...
        let num_padding_bytes = (bytes_per_row_aligned - bytes_per_row_unaligned) as usize;
