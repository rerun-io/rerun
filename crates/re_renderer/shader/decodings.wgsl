...
fn decode_nv12(texture: texture_2d<u32>, coords: IVec2) -> Vec4 {
    ...
    // Reference for conversion coefficients: https://en.wikipedia.org/wiki/YCbCr
    // BT.601 (aka. SDTV, aka. Rec.601). WIKI section: ITU-R BT.601 conversion
    // let r = clamp(y + 1.402 * v, 0.0, 1.0);
    // let g = clamp(y  - (0.344 * u + 0.714 * v), 0.0, 1.0);
    // let b = clamp(y + 1.772 * u, 0.0, 1.0);
    // BT.709 (aka. HDTV, aka. Rec.709). WIKI section: ITU-R BT.709 conversion
