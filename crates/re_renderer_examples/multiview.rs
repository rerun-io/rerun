...
use re_renderer::{
    ...
    Color32, GpuReadbackIdentifier, Hsva, LineBatchesBuilder, PointCloudBuilder, RenderContext,
...
fn build_lines(re_ctx: &RenderContext, seconds_since_startup: f32) -> LineDrawData {
    ...
    let mut builder = LineBatchesBuilder::new(re_ctx, 3, lorenz_points.len() as u32 + 4 + 1000);
    {
