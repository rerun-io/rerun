...
pub fn generate_visualizers_file(reporter: &Reporter, objects: &Objects) -> String {
    ...
    code.push_indented(0, "from ... import components, datatypes", 2); // NOLINT: these dots are part of a Python relative import in generated code and must not be changed
