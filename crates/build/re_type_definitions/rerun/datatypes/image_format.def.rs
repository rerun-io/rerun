...
pub struct ImageFormat {
    ...
    ///
    /// If specified, this takes precedence over both [`rerun::datatypes::ColorModel`] and [`rerun::datatypes::ChannelDatatype`] (which are ignored).
    pub pixel_format: Option<rerun::datatypes::PixelFormat>,

    /// L, RGB, RGBA, …
    ///
    /// Also requires a [`rerun::datatypes::ChannelDatatype`] to fully specify the pixel format.
    ...
    ///
    /// Also requires a [`rerun::datatypes::ColorModel`] to fully specify the pixel format.
