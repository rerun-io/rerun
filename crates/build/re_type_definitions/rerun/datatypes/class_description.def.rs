...
/// the attached [`rerun::datatypes::AnnotationInfo`] to derive labels and colors.
///
...
/// [`rerun::datatypes::AnnotationInfo`] specifically associated with the Keypoint.
///
...
/// colored as described by the class's [`rerun::datatypes::AnnotationInfo`].
///
...
pub struct ClassDescription {
    /// The [`rerun::datatypes::AnnotationInfo`] for the class.
    pub info: rerun::datatypes::AnnotationInfo,

    /// The [`rerun::datatypes::AnnotationInfo`] for all of the keypoints.
