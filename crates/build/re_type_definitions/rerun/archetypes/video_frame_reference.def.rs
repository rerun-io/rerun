...
///
/// Used to display individual video frames from an [`rerun::archetypes::AssetVideo`] or [`rerun::archetypes::VideoStream`].
/// To show an entire video, a video frame reference for each frame of the video should be logged.
/// References to a [`rerun::archetypes::VideoStream`] use the active Viewer timeline.
///
...
pub struct VideoFrameReference {
    ...
    /// Optional reference to an entity with an [`rerun::archetypes::AssetVideo`] or [`rerun::archetypes::VideoStream`].
    ///
