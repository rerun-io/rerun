...
pub enum FillMode {
    ...
    ///
    /// * An [`rerun::archetypes::Ellipsoids3D`] will draw three axis-aligned ellipses that are cross-sections
    ///   of each ellipsoid, each of which displays two out of three of the sizes of the ellipsoid.
    /// * For [`rerun::archetypes::Boxes3D`], it is the edges of the box, identical to [`rerun::components::FillMode::DenseWireframe`].
    MajorWireframe = 1,
    ...
    /// Examples of what this means:
    ///
    /// * An [`rerun::archetypes::Ellipsoids3D`] will draw a wireframe triangle mesh that approximates each
    ///   ellipsoid.
    /// * For [`rerun::archetypes::Boxes3D`], it is the edges of the box, identical to [`rerun::components::FillMode::MajorWireframe`].
    DenseWireframe = 2,
