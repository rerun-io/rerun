...
/// Whether a [`rerun::components::VideoSample`] contains a keyframe (also known as a sync sample or IDR).
///
...
/// See [`rerun::components::VideoCodec`] for the codec-specific definition of a keyframe.
#[rerun::rerun_type]
#[python(aliases = "bool")]
