...
pub struct MixedFields {
    ...
    pub almost_flattened_scalar: rerun::testing::encodings::FlattenedScalar,
...
pub enum NestedUnion {
    single_required(rerun::testing::encodings::ScalarUnion) = 1,

    many_required(Vec<rerun::testing::encodings::ScalarUnion>) = 2,
    //many_optional(Option<Vec<rerun::testing::encodings::ScalarUnion>>) = 3, // Nullable fields on unions are not supported.
}
...
pub struct OptionalUnionTable {
    pub single_optional_union: Option<rerun::testing::encodings::NestedUnion>,
}
...
pub struct PrimitiveAndString {
    pub p: rerun::testing::encodings::PrimitiveComponent,

    pub s: rerun::testing::encodings::StringComponent,
}
...
pub enum ScalarUnion {
    ...
    craziness(Vec<rerun::testing::encodings::MixedFields>) = 2,
