...
use re_viewer_context::{ArchetypeDefinition, SpaceViewHighlights, ViewerContext, ViewQuery, ViewPartSystem};

use crate::{contexts::SpatialViewContext, SpatialSpaceView};
...
impl ViewPartSystem<SpatialSpaceView> for Transform3DArrowsPart {
