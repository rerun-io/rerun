...
use re_types::{
    blueprint::components::{Corner2D, Visible, VisualBounds2D},
    components::{
...
pub fn register_editors(registry: &mut re_viewer_context::ComponentUiRegistry) {
    ...
    register_editor::<VisualBounds2D>(
        registry,
        visual_bounds_2d::default_visual_bounds_2d,
        visual_bounds_2d::edit_visual_bounds_2d,
    );
}
