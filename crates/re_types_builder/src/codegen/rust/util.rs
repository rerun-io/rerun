...
/// Returns the module name of an object, accounting for overrides.
pub fn module_name(obj: &Object) -> String {
    obj.try_get_attr::<String>(crate::ATTR_RUST_OVERRIDE_MODULE)
        .unwrap_or_else(|| obj.kind.plural_snake_case().to_owned())
}
