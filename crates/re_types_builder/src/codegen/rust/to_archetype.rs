//! Generates code in `re_query_cache2` so that cached results can easily be converted to
...
fn generate_mod(
    ...
    let generated_path =
        Utf8PathBuf::from("crates/re_query_cache2/src/latest_at/to_archetype/mod.rs");
...
fn generate_impls(
    ...
    let generated_path = Utf8PathBuf::from("crates/re_query_cache2/src/latest_at/to_archetype");
