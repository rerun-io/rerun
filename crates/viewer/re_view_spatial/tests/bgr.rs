...
const LENA: &[u8] = include_bytes!("../../../../tests/assets/images/Lena_512.png");
...
pub fn test_bgr() {
    ...
    let lena_bytes = std::fs::read(workspace_dir.join("tests/assets/images/Lena_512.png")).unwrap();

    {
        use ndarray::{s, Array, ShapeBuilder};

        // Large gray background
        test_context.log_entity("rgb_u8".into(), |builder| {
