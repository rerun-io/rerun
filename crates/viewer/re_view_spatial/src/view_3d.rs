...
use re_viewer_context::{
    IdentifiedViewSystem as _, IndicatedEntities, PerVisualizer, PerVisualizerInView, QueryContext,
...
impl ViewClass for SpatialView3D {
    ...
    fn choose_default_visualizers(
        ...
        if !enabled_visualizers.contains(&arrows_viz) && visualizable.contains(&arrows_viz) {
            ...
            if visualizable.contains(&axis_detector) || enabled_visualizers.contains(&camera_viz) {
