    ...
    fn execute(
        ...
        process_archetype::<Self, Boxes2D, _>(
            ...
            |ctx, spatial_ctx, results| {
                ...
                let all_centers = results.iter_as(timeline, Boxes2D::descriptor_centers().component);
                ...
                let all_class_ids = results.iter_as(timeline, Boxes2D::descriptor_class_ids().component);
                let all_show_labels = results.iter_as(timeline, Boxes2D::descriptor_show_labels().component);
...
impl TypedComponentFallbackProvider<ShowLabels> for Boxes2DVisualizer {
    fn fallback_for(&self, ctx: &QueryContext<'_>) -> ShowLabels {
        super::utilities::show_labels_fallback(
            ctx,
            Boxes2D::descriptor_half_sizes().component,
            Boxes2D::descriptor_labels().component,
        )
    }
}
