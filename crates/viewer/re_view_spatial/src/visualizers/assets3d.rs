    ...
    fn execute(
        ...
        process_archetype::<Self, Asset3D, _>(
            ...
            |ctx, spatial_ctx, results| {
                ...
                let Some(all_blob_chunks) = results.get_required_chunks(Asset3D::descriptor_blob().component)
                else {
                    return Ok(());
                };
                ...
                let all_media_types = results.iter_as(timeline, Asset3D::descriptor_media_type().component);
