    ...
    fn execute(
        ...
        process_archetype::<Self, Arrows3D, _>(
            ...
            |ctx, spatial_ctx, results| {
                ...
                let all_origins = results.iter_as(timeline, Arrows3D::descriptor_origins().component);
                ...
                let all_class_ids = results.iter_as(timeline, Arrows3D::descriptor_class_ids().component);
                let all_show_labels = results.iter_as(timeline, Arrows3D::descriptor_show_labels().component);
