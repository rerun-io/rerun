...
use re_viewer_context::{
    ...
    PerVisualizerInView, SystemCommand, SystemCommandSender as _, TensorStatsCache, ViewClass,
...
Set the displayed dimensions in a selection panel.",
    ...
    fn choose_default_visualizers(
        ...
        visualizable_entities_per_visualizer: &PerVisualizerInView<VisualizableEntities>,
