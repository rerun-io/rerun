...
pub fn video_asset_result_ui(
    ...
    match video_result {
        Ok(video) => {
            ...
            // TODO: halp.
            //ui.list_item_collapsible_noninteractive_label("Video Asset", default_open, |ui| {
            re_ui::list_item::list_item_scope(ui, "Video Asset", |ui| {
...
pub fn video_stream_result_ui(
    ...
    match video_result {
        Ok(video) => {
            let default_open = true;
            //ui.list_item_collapsible_noninteractive_label("Video Stream", default_open, |ui| {
            re_ui::list_item::list_item_scope(ui, "Video Stream", |ui| {
