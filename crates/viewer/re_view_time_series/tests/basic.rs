        ...
        match i {
            ...
            _ => {
                let data = if two_series_per_entity {
                    ...
                    re_types::archetypes::Scalars::new([(i as f64 / 5.0).sin()])
                };
...
fn scalars_for_properties_test(
    ...
    if multiple_scalars {
        ...
        (
            re_types::archetypes::Scalars::new([(step as f64 / 5.0).sin()]),
            re_types::archetypes::Scalars::new([(step as f64 / 5.0).cos()]),
        )
    }
}
