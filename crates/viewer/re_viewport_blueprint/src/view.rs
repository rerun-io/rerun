...
mod tests {
    ...
    use re_viewer_context::{
        IndicatedEntities, OverridePath, PerVisualizer, PerVisualizerInView, ViewClassPlaceholder,
    ...
    fn test_component_overrides() {
        ...
        let visualizable_entities = PerVisualizerInView::<VisualizableEntities> {
    ...
    fn update_overrides(
        ...
        view: &ViewBlueprint,
        visualizable_entities: &PerVisualizerInView<VisualizableEntities>,
