...
use re_viewer_context::{
    ...
    IndicatedEntities, OverridePath, PerVisualizer, PerVisualizerInView, PropertyOverrides,
...
impl ViewContents {
    ...
    pub fn execute_query(
        ...
        visualizable_entities_for_visualizer_systems: &PerVisualizerInView<VisualizableEntities>,
    ) -> DataQueryResult {
...
pub struct DataQueryPropertyResolver<'a> {
    ...
    visualizable_entities_per_visualizer: &'a PerVisualizerInView<VisualizableEntities>,
...
mod tests {
    ...
    fn test_query_results() {
        ...
        let mut visualizable_entities_for_visualizer_systems =
            PerVisualizerInView::<VisualizableEntities>::empty(view_class_identifier);
