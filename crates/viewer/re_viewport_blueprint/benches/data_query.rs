...
use re_viewer_context::{
    Caches, PerVisualizerInView, StoreContext, ViewClassRegistry, VisualizableEntities,
    blueprint_timeline,
};
...
fn build_entity_tree(
...
) -> (EntityDb, PerVisualizerInView<VisualizableEntities>) {
    ...
    let mut visualizable_entities =
        PerVisualizerInView::<VisualizableEntities>::empty(view_class_id);
