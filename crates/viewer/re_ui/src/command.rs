...
pub enum UICommand {
    ...
    ToggleSelectionPanel(Option<bool>),
    ToggleTimePanel,
...
impl UICommand {
    ...
    pub fn text_and_tooltip(self) -> (&'static str, &'static str) {
        match self {
            ...
            Self::ToggleSelectionPanel(_) => ("Toggle selection panel", "Toggle the right panel"),
    ...
    pub fn kb_shortcuts(self, os: OperatingSystem) -> SmallVec<[KeyboardShortcut; 2]> {
        ...
        match self {
            ...
            Self::ToggleSelectionPanel(_) => smallvec![ctrl_shift(Key::S)],
