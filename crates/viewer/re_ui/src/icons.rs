...
pub const VIEW_2D: Icon = icon_from_path!("../data/icons/spaceview_2d.png");
pub const VIEW_3D: Icon = icon_from_path!("../data/icons/spaceview_3d.png");
pub const VIEW_DATAFRAME: Icon = icon_from_path!("../data/icons/spaceview_dataframe.png");
pub const VIEW_GRAPH: Icon = icon_from_path!("../data/icons/spaceview_graph.png");
pub const VIEW_GENERIC: Icon = icon_from_path!("../data/icons/spaceview_generic.png");
pub const VIEW_HISTOGRAM: Icon = icon_from_path!("../data/icons/spaceview_histogram.png");
pub const VIEW_LOG: Icon = icon_from_path!("../data/icons/spaceview_log.png");
pub const VIEW_MAP: Icon = icon_from_path!("../data/icons/spaceview_map.png");
pub const VIEW_TENSOR: Icon = icon_from_path!("../data/icons/spaceview_tensor.png");
pub const VIEW_TEXT: Icon = icon_from_path!("../data/icons/spaceview_text.png");
pub const VIEW_TIMESERIES: Icon = icon_from_path!("../data/icons/spaceview_timeseries.png");
pub const VIEW_UNKNOWN: Icon = icon_from_path!("../data/icons/spaceview_unknown.png");
