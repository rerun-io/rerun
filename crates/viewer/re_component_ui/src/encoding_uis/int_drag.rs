...
use re_types_core::encodings;
use re_ui::syntax_highlighting::{SyntaxHighlightedBuilder, SyntaxHighlighting};
use re_viewer_context::{MaybeMutRef, UiLayout};

/// Generic editor for a [`re_sdk_types::encodings::UInt32`] values within a given range.
pub fn edit_u32_range(
    _ctx: &re_viewer_context::AppContext<'_>,
    ui: &mut egui::Ui,
    value: &mut MaybeMutRef<'_, impl std::ops::DerefMut<Target = encodings::UInt32>>,
...
/// Generic editor for a [`re_sdk_types::encodings::UInt64`] values within a given range.
pub fn edit_u64_range(
    _ctx: &re_viewer_context::AppContext<'_>,
    ui: &mut egui::Ui,
    value: &mut MaybeMutRef<'_, impl std::ops::DerefMut<Target = encodings::UInt64>>,
