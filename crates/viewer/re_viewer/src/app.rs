...
impl App {
    ...
    fn receive_messages(&mut self, store_hub: &mut StoreHub, egui_ctx: &egui::Context) {
        ...
        while let Some((channel_source, msg)) = self.rx.try_recv() {
            ...
            // TODO: we have to keep grabbing and releasing entity_db because everything references
            // everything and some of it is mutable and some not... it's really not nice, but it
