...
pub use re_types::blueprint::components::TextLogColumnList;
pub use re_types::blueprint::components::TextLogLevelList;
...
pub fn is_valid_blueprint(blueprint: &EntityDb) -> bool {
    validate_component::<AbsoluteTimeRange>(blueprint)
        ...
        && validate_component::<TextLogColumnList>(blueprint)
        && validate_component::<TextLogLevelList>(blueprint)
