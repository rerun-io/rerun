...
use re_data_store2::{StoreDiffKind2, StoreEvent2, StoreSubscriber2};
...
pub trait VisualizerAdditionalApplicabilityFilter: Send + Sync {
    ...
    fn update_applicability(&mut self, _event: &StoreEvent2) -> bool;
}
...
impl StoreSubscriber2 for VisualizerEntitySubscriber {
    #[inline]
    fn name(&self) -> String {
