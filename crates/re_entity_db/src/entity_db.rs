...
impl EntityDb {
    ...
    #[inline]
    pub fn query_latest_component<C: re_types_core::Component>(
        &self,
        entity_path: &EntityPath,
        query: &re_data_store::LatestAtQuery,
    ) -> Option<re_query_cache2::CachedLatestAtMonoResult<C>> {
        self.query_caches2().query_latest_component::<C>(
            self.store(),
            self.resolver(),
            entity_path,
            query,
    ...
    #[inline]
    pub fn query_latest_component_quiet<C: re_types_core::Component>(
        &self,
        entity_path: &EntityPath,
        query: &re_data_store::LatestAtQuery,
    ) -> Option<re_query_cache2::CachedLatestAtMonoResult<C>> {
        self.query_caches2().query_latest_component_quiet::<C>(
            self.store(),
            self.resolver(),
            entity_path,
            query,
