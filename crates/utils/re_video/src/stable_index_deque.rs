...
/// This is useful to use indices for addressing in a list that can only grow right-hand sided and shrink only left hand sided
/// without having to resort to a map datastructure.
...
impl<T> StableIndexDeque<T> {
    ...
    #[inline]
    pub fn iter_truncated_index_range(
        &self,
