...
mod tests {
    ...
    fn full() -> Result<(), MsgSenderError> {
        let labels = vec![
            re_types::components::Text("label1".into()),
            re_types::components::Text("label2".into()),
        ];
...

        {
            ...
            let idx = standard
                .find_cell(&re_types::components::Text::name())
                .unwrap();
    ...
    fn timepoint_timeless() -> Result<(), MsgSenderError> {
        ...
        let sender = MsgSender::new("some/path")
            .with_timeless(true)
            .with_component([re_types::components::Text("label1".into())].as_slice())?
            .with_time(my_timeline, 2);
            ...
            MsgSender::new("some/path")
                .with_component(
                    [
                        re_types::components::Text("label1".into()),
                        re_types::components::Text("label2".into()),
                        re_types::components::Text("label3".into()),
                    ]
                    .as_slice(),
                )?
                .with_component([components::Color::from_rgb(1, 1, 1)].as_slice())?;
