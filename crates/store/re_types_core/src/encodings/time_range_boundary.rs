...
pub enum TimeRangeBoundary {
    ...
    CursorRelative(crate::encodings::TimeInt),

    /// Boundary is an absolute value.
    Absolute(crate::encodings::TimeInt),
...
impl crate::ToArrowOpt for TimeRangeBoundary {
    fn to_arrow_opt<'a>(
            ...
            let children = vec![
                as_array_ref(NullArray::new(data.iter().filter(|v| v.is_none()).count())),
                {
                    let cursor_relative: Vec<_> = data
                        ...
                        .collect();
                    let cursor_relative_validity = None;
...
crate::macros::impl_to_arrow_via_to_arrow_opt!(TimeRangeBoundary);

impl crate::FromArrowOpt for TimeRangeBoundary {
    fn from_arrow_opt(
                            ...
                            Ok(Some(match typ {
                                1i8 => Self::CursorRelative({
                                    if offset as usize >= cursor_relative.len() {
                                        ...
                                        .with_context(
                                            "rerun.encodings.TimeRangeBoundary#CursorRelative",
                                        );
                                    }
                                ...
                                2i8 => Self::Absolute({
                                    if offset as usize >= absolute.len() {
                                        ...
                                        .with_context(
                                            "rerun.encodings.TimeRangeBoundary#Absolute",
                                        );
                                    }
...
crate::macros::impl_from_arrow_via_from_arrow_opt!(TimeRangeBoundary);
