...
pub struct TransformInfo {
    ...
    /// The transform from this frame to the target frame.
    ///
...
impl TransformForest {
    ...
    pub fn new(
        ...
        tree.entity_tree_gather_transorms_recursive(
            entity_tree,
            time_query,
...
impl TransformForest {
    ...
    fn entity_tree_gather_transorms_recursive(
        &mut self,
        subtree: &EntityTree,
        query: &LatestAtQuery,
        ...
        for child_tree in subtree.children.values() {
            ...
            self.entity_tree_gather_transorms_recursive(
                child_tree,
                query,
