...
#[inline]
pub fn pose_translation_3d_to_daffine3(v: components::PoseTranslation3D) -> DAffine3 {
    DAffine3 {
        matrix3: DMat3::IDENTITY,
        translation: vec3d_to_dvec3(v.0),
    }
...
#[inline]
pub fn pose_rotation_axis_angle_to_daffine3(
...
#[inline]
pub fn pose_scale_3d_to_daffine3(v: components::PoseScale3D) -> DAffine3 {
    DAffine3 {
        matrix3: DMat3::from_diagonal(vec3d_to_dvec3(v.0)),
        translation: DVec3::ZERO,
    }
