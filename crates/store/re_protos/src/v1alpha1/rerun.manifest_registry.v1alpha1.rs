...
pub struct CreatePartitionManifestsResponse {
    /// The Arrow schema of this dataframe can be fetched using \[`CreatePartitionManifestsResponse::schema`\].
    #[prost(message, optional, tag = "1")]
    pub data: ::core::option::Option<super::super::common::v1alpha1::DataframePart>,
}
...
pub struct FetchPartitionManifestResponse {
    /// Partition manifest as arrow RecordBatches
    /// TODO: indicate where to find the schema
    #[prost(message, optional, tag = "1")]
    pub data: ::core::option::Option<super::super::common::v1alpha1::DataframePart>,
}
