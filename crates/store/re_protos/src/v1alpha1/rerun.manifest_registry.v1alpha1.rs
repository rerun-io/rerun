...
pub struct CleanupDatasetsRequest {
    /// manifests that are not currently orphaned and should be kept
    #[prost(message, repeated, tag = "1")]
    pub entries_to_keep: ::prost::alloc::vec::Vec<super::super::common::v1alpha1::DatasetHandle>,
}
...
pub mod manifest_registry_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        /// Cleanup manifests for orphaned datasets from their backing storage.
