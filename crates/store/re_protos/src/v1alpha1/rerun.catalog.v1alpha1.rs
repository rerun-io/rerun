...
pub struct CatalogFlightRequest {
    #[prost(oneof = "catalog_flight_request::RequestType", tags = "1")]
    pub request_type: ::core::option::Option<catalog_flight_request::RequestType>,
}
/// Nested message and enum types in `CatalogFlightRequest`.
pub mod catalog_flight_request {
    #[derive(Clone, PartialEq, ::prost::Oneof)]
    pub enum RequestType {
        #[prost(message, tag = "1")]
        FindEntries(super::FindEntriesRequest),
    }
}
impl ::prost::Name for CatalogFlightRequest {
    const NAME: &'static str = "CatalogFlightRequest";
    const PACKAGE: &'static str = "rerun.catalog.v1alpha1";
    fn full_name() -> ::prost::alloc::string::String {
        "rerun.catalog.v1alpha1.CatalogFlightRequest".into()
    }
