...
impl ::prost::Name for RegisterTableRequest {
    ...
    const PACKAGE: &'static str = "rerun.catalog.v1alpha1";
    fn full_name() -> ::prost::alloc::string::String {
        "rerun.catalog.v1alpha1.RegisterTableRequest".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/rerun.catalog.v1alpha1.RegisterTableRequest".into()
    }
...
impl ::prost::Name for RegisterTableResponse {
    ...
    const PACKAGE: &'static str = "rerun.catalog.v1alpha1";
    fn full_name() -> ::prost::alloc::string::String {
        "rerun.catalog.v1alpha1.RegisterTableResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/rerun.catalog.v1alpha1.RegisterTableResponse".into()
    }
...
impl ::prost::Name for CleanupDatasetsRequest {
    ...
    const PACKAGE: &'static str = "rerun.catalog.v1alpha1";
    fn full_name() -> ::prost::alloc::string::String {
        "rerun.catalog.v1alpha1.CleanupDatasetsRequest".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/rerun.catalog.v1alpha1.CleanupDatasetsRequest".into()
    }
...
impl ::prost::Name for CleanupDatasetsResponse {
    ...
    const PACKAGE: &'static str = "rerun.catalog.v1alpha1";
    fn full_name() -> ::prost::alloc::string::String {
        "rerun.catalog.v1alpha1.CleanupDatasetsResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/rerun.catalog.v1alpha1.CleanupDatasetsResponse".into()
    }
...
pub mod catalog_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        ) -> std::result::Result<tonic::Response<super::RegisterTableResponse>, tonic::Status>
        {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/rerun.catalog.v1alpha1.CatalogService/RegisterTable",
            );
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new(
                "rerun.catalog.v1alpha1.CatalogService",
        ...
        ) -> std::result::Result<tonic::Response<super::CleanupDatasetsResponse>, tonic::Status>
        {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/rerun.catalog.v1alpha1.CatalogService/CleanupDatasets",
            );
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new(
                "rerun.catalog.v1alpha1.CatalogService",
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/rerun.catalog.v1alpha1.CatalogService/RegisterTable" => {
                    ...
                    impl<T: CatalogService> tonic::server::UnaryService<super::RegisterTableRequest>
                ...
                "/rerun.catalog.v1alpha1.CatalogService/CleanupDatasets" => {
                    #[allow(non_camel_case_types)]
                    struct CleanupDatasetsSvc<T: CatalogService>(pub Arc<T>);
                    impl<T: CatalogService>
                        ...
                        for CleanupDatasetsSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as CatalogService>::cleanup_datasets(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
