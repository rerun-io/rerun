...
pub mod frontend_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn cleanup_datasets(
            ...
            tonic::Response<
                super::super::super::manifest_registry::v1alpha1::CleanupDatasetsResponse,
            >,
            tonic::Status,
        > {
            self.inner.ready().await.map_err(|e| {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/rerun.frontend.v1alpha1.FrontendService/CleanupDatasets" => {
                    ...
                    {
                        type Response = super::super::super::manifest_registry::v1alpha1::CleanupDatasetsResponse;
                        type Future = BoxFuture<tonic::Response<Self::Response>, tonic::Status>;
                        fn call(
                            &mut self,
                            request: tonic::Request<super::CleanupDatasetsRequest>,
