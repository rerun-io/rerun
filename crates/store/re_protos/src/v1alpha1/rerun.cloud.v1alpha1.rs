...
/// Request for `Version`. Empty: the whole version report is always returned.
...
pub struct VersionResponse {
    /// Detailed build information for the server binary.
...
/// Request for `WhoAmI`. Empty: the caller is identified by their credentials.
#[derive(Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
...
/// One chunk of the payload yielded by `DoBandwidthTest`.
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
...
pub struct EventKind {
    /// Which category of events this selects.
...
/// One event yielded by `WatchEvents`.
#[derive(Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
...
/// Request for `RegisterWithDataset`.
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct RegisterWithDatasetRequest {
    /// The data sources to register as segments of the dataset.
    #[prost(message, repeated, tag = "2")]
    pub data_sources: ::prost::alloc::vec::Vec<DataSource>,
    /// What to do about a data source that is already registered with this dataset.
    #[prost(
...
/// Response for `RegisterWithDataset`.
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct RegisterWithDatasetResponse {
    /// One row per registered `(segment, layer)` pair, with the non-null `Utf8` columns
    /// `rerun_segment_id`, `rerun_segment_layer`, `rerun_segment_type`, `rerun_storage_url`, and
    /// `rerun_task_id`, in that order (pinned by
    /// [`RegisterWithDatasetDataframe`](crate::cloud::v1alpha1::ext::RegisterWithDatasetDataframe)).
    ///
    /// Several rows can share a `rerun_task_id`: one registration task covers a whole batch. Data
    /// sources that resolve to the same segment ID collapse into a single row, so the row count
    /// is not necessarily `len(data_sources)`, and it is zero if every data source was skipped
    /// (`IF_DUPLICATE_BEHAVIOR_SKIP`). Servers that register synchronously report a sentinel task
    /// ID that is always "successful".
    #[prost(message, optional, tag = "1")]
...
/// Response for `UnregisterFromDataset`.
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
...
/// Response for `GetSegmentTableSchema`.
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
...
/// Narrows a manifest scan down to, or away from, a set of segments.
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct SegmentIdFilter {
    /// Whether the listed segments are the ones to keep or the ones to drop.
...
/// One batch of the segment table.
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct ScanSegmentTableResponse {
    /// Segments metadata as Arrow RecordBatch, with the columns pinned by
...
/// Request for `GetDatasetManifestSchema`.
///
/// Empty: the dataset is identified by the standard dataset headers (see the `Headers` section at the top of this file).
#[derive(Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
...
/// Response for `GetDatasetManifestSchema`.
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
...
/// Request for `ScanDatasetManifest`.
///
/// The dataset is identified by the standard dataset headers (see the `Headers` section at the top of this file).
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
...
/// One batch of the dataset manifest.
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
...
/// Response for `GetDatasetSchema`.
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct GetDatasetSchemaResponse {
    /// The union of the schemas of every layer of every segment in the dataset (a field-wise
    /// Arrow schema merge).
    ///
    /// Servers are allowed to return a superset: some maintain this schema incrementally and only
    /// ever widen it, so fields from unregistered or replaced segments can linger until
    /// `RematerializeDatasetSchema` recomputes it. A dataset with no registered segments yields
...
/// Request for `GetRrdManifest`.
///
/// The dataset is identified by the standard dataset headers (see the `Headers` section at the top of this file).
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct GetRrdManifestRequest {
    /// Which segment of the dataset to fetch the RRD manifest of.
    #[prost(message, optional, tag = "1")]
...
/// One part of an RRD manifest, yielded by `GetRrdManifest`.
///
...
/// One part of the asset listing, yielded by `GetAssetsForSegment`.
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub struct QueryDatasetRequest {
    ...
    /// The Rerun-native query to run. Leave unset to match on the other filters alone: an unset
    /// `query` applies no temporal narrowing.
...
/// A Rerun-native query over a dataset's chunks.
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct Query {
...
pub struct IndexValueList {
    /// The index values, in the units of the queried index column.
...
/// One batch of chunks yielded by `FetchChunks`.
#[derive(Clone, PartialEq, ::prost::Message)]
...
/// One batch of the table's contents, yielded by `ScanTable`.
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct ScanTableResponse {
    /// A consecutive run of the table's rows: the batches of one stream partition the rows, and
    /// concatenating them in arrival order yields the full scan result. The row order itself is
    /// only meaningful when the scan asked for one.
    #[prost(message, optional, tag = "1")]
...
/// One batch of rows pushed by `WriteTable`.
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct WriteTableRequest {
    /// The rows to write.
    #[prost(message, optional, tag = "1")]
    pub dataframe_part: ::core::option::Option<super::super::common::v1alpha1::DataframePart>,
    /// How to fold these rows into the existing table.
...
/// Response for `WriteTable`. Empty: an error is reported as a gRPC status instead.
#[derive(Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
...
/// Request for `DoMaintenance`.
///
/// Each field turns on one operation; no operation is on by default, so a request with every
/// field unset performs no maintenance and returns an empty report. (It may still do trivial
/// internal bookkeeping, such as creating the dataset's revision row on first contact.)
///
/// `DoGlobalMaintenance` does not reuse these defaults: it constructs an explicit request per
/// dataset (index optimization, fragment compaction, and an age-bounded cleanup).
#[derive(Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
...
/// Response for `DoMaintenance`.
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct DoMaintenanceResponse {
    /// Human-readable report of what the requested operations did.
    #[prost(string, tag = "1")]
...
/// Response for `DoGlobalMaintenance`. Empty: an error is reported as a gRPC status instead.
#[derive(Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
...
pub struct QueryTasksResponse {
    /// One row per queried task, describing its status, with the columns pinned by
    /// [`QueryTasksDataframe`](crate::cloud::v1alpha1::ext::QueryTasksDataframe).
    #[prost(message, optional, tag = "1")]
    pub data: ::core::option::Option<super::super::common::v1alpha1::DataframePart>,
}
...
/// Request for `FindEntries`.
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct FindEntriesRequest {
    /// Which entries to return. Send an empty `EntryFilter` (not an unset one) to get the
    /// server's default set of entry kinds: some servers reject an unset `filter` with
    /// `INVALID_ARGUMENT`, others treat it as an empty filter.
    #[prost(message, optional, tag = "1")]
...
/// Response for `FindEntries`.
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct FindEntriesResponse {
    /// The matching entries, in no particular order. The order is not even stable across two
    /// identical calls.
    #[prost(message, repeated, tag = "1")]
...
/// DeleteDatasetEntry
///
/// The entry is identified by the `x-rerun-entry-id` header or the deprecated body `id`.
#[derive(Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
...
/// Response for `DeleteEntry`. Empty: an error is reported as a gRPC status instead.
#[derive(Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
...
/// Request for `CreateDatasetEntry`.
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct CreateDatasetEntryRequest {
    ...
    ///
    /// Entry names ending with `__manifest` are reserved, though this is not currently enforced.
    #[prost(string, optional, tag = "1")]
...
/// Response for `CreateDatasetEntry`.
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct CreateDatasetEntryResponse {
    /// The dataset entry that was created.
    #[prost(message, optional, tag = "1")]
...
/// Response for `CreateTableEntry`.
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct CreateTableEntryResponse {
    /// The table entry that was created.
    #[prost(message, optional, tag = "1")]
...
/// Response for `ReadDatasetEntry`.
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct ReadDatasetEntryResponse {
    /// The dataset entry that was read.
    #[prost(message, optional, tag = "1")]
    pub dataset: ::core::option::Option<DatasetEntry>,
}
...
/// Response for `UpdateDatasetEntry`.
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
...
/// ReadTableEntry
///
/// The table is identified by the `x-rerun-entry-id` header or the deprecated body `id`.
#[derive(Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
...
/// Response for `ReadTableEntry`.
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct ReadTableEntryResponse {
    /// The table entry that was read.
    #[prost(message, optional, tag = "1")]
    pub table: ::core::option::Option<TableEntry>,
}
...
/// Request for `UpdateTableEntry`.
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct UpdateTableEntryRequest {
    /// The table to modify.
    ///
    /// Deprecated: use the x-rerun-entry-id header instead. This field is only a fallback for
    /// clients that predate header-based addressing on this endpoint.
    #[prost(message, optional, tag = "1")]
    pub id: ::core::option::Option<super::super::common::v1alpha1::EntryId>,
    /// The new values.
    #[prost(message, optional, tag = "2")]
...
/// Narrows `FindEntries` down to a subset of the catalog. Every set field must match (logical
/// AND).
///
/// A filter with no field set is *not* match-everything: it falls back to the default kind set
/// described on `entry_kinds`. A malformed `id` or `name` matches nothing rather than erroring.
/// `name` matching is exact and case-sensitive.
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct EntryFilter {
    /// Only match the entry with this ID.
    #[prost(message, optional, tag = "1")]
    pub id: ::core::option::Option<super::super::common::v1alpha1::EntryId>,
    /// Only match the entry with this exact name.
...
pub struct EntryDetails {
    ...
    /// When this entry was last modified. See `TouchDatasetEntry` on the internal Catalog API.
    #[prost(message, optional, tag = "5")]
...
/// The dataset-specific part of a `DatasetEntry`. Updatable with `UpdateDatasetEntry`.
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct DatasetDetails {
    ...
    ///
    /// Client-owned, unlike \[`DatasetDetails::asset_dataset`\]: leaving this unset in
    /// `UpdateDatasetEntry` clears the reference, and the dataset keeps working without a blueprint.
    #[prost(message, optional, tag = "3")]
    ...
    ///
    /// Server-managed, unlike \[`DatasetDetails::blueprint_dataset`\], because a recording dataset is
    /// never meant to be without an asset dataset. Leaving this unset in `UpdateDatasetEntry` keeps
    /// the stored reference, and the server re-attaches or re-creates the asset dataset if that
    /// reference is missing or dangling (recordings created before asset datasets existed have
    /// none). Set it to move the entry to a different asset dataset. Blueprint and asset datasets
    /// are not recordings, so none of this applies to them: there, unsetting clears the field like
    /// any other.
...
pub struct DatasetEntry {
    /// The kind-agnostic part, shared with every other entry kind.
    #[prost(message, optional, tag = "1")]
...
/// The table-specific part of a `TableEntry`. Updatable with `UpdateTableEntry`.
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
...
/// A built-in table maintained by the server rather than registered by a user.
#[derive(Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
pub struct SystemTable {
    /// Which built-in table this is.
...
/// What format the data behind a `DataSource` is stored in.
#[derive(Clone, Copy, Debug, PartialEq, Eq, Hash, PartialOrd, Ord, ::prost::Enumeration)]
#[repr(i32)]
...
/// How `WriteTable` folds new rows into an existing table.
#[derive(Clone, Copy, Debug, PartialEq, Eq, Hash, PartialOrd, Ord, ::prost::Enumeration)]
#[repr(i32)]
...
pub enum EntryKind {
    ...
    ///
    /// Reserved: no server currently creates entries of this kind. Filtering for it is legal and
    /// returns no entries.
    DatasetView = 2,
    /// A table.
    Table = 3,
    ...
    /// returns no entries.
    TableView = 4,
    /// A dataset holding the blueprints of another entry.
    BlueprintDataset = 5,
    /// A dataset holding the static assets shared by another dataset's segments.
    AssetDataset = 6,
}
impl EntryKind {
    /// String value of the enum field names used in the ProtoBuf definition.
...
/// Which built-in table a `SystemTable` refers to.
#[derive(Clone, Copy, Debug, PartialEq, Eq, Hash, PartialOrd, Ord, ::prost::Enumeration)]
#[repr(i32)]
...
pub mod rerun_cloud_service_client {
    ...
    /// binary encoded).
    ///
    /// Some entry-addressed endpoints also accept the entry id in a deprecated body field. Every server
    /// resolves those the same way: the `x-rerun-entry-id` header wins, the body field is a fallback for
    /// old clients, and both unset fails with `INVALID_ARGUMENT` (a gRPC status code). If both are set
    /// but disagree, the call fails with `INVALID_ARGUMENT` naming the two ids, rather than silently
    /// picking one. `x-rerun-entry-name-bin` is never resolved on these endpoints.
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        /// Returns version and build information about the server.
        ///
        /// Also reports the optional features this server supports, so clients can stay safe against
        /// rolling deployments where the server is older than the client
        /// (see `ConnectionClient::supports_feature`).
        ...
        /// Subscribe to catalog events as they happen.
        ///
        /// The stream yields one response per event and stays open until the client drops it.
        /// Events are emitted for entry creation (datasets and tables) and entry deletion. Renames
        /// produce no event, and neither do implicitly created blueprint or asset datasets.
        ///
        /// Servers may not support this at all: a server without event support returns
        /// `UNIMPLEMENTED`, and clients must treat that as permanent rather than retrying.
        /// Rerun Hub currently returns `UNIMPLEMENTED` (RR-4859).
        ...
        /// List the entries of the catalog that match the given filter.
        ...
        /// Mark an entry as deleted, making it unavailable for future use.
        ///
        /// Deleting a dataset or table also deletes the blueprint and asset datasets it owns, and
        /// frees its name for immediate reuse. Whether the underlying data is removed right away is
        /// server-defined: Rerun Hub soft-deletes and reclaims storage in a later
        /// garbage-collection pass, while the OSS server deletes synchronously.
        ///
        /// The entry is identified by the `x-rerun-entry-id` header, falling back to the deprecated
        /// body `id` field (see the `Headers` section at the top of this file).
        ...
        /// Update the kind-agnostic details of an entry, i.e. its name.
        ///
        /// Fails with `ALREADY_EXISTS` if the new name is taken. A rename to the current name is a
        /// no-op.
        ///
        /// The entry is identified by the `x-rerun-entry-id` header, falling back to the deprecated
        /// body `id` field (see the `Headers` section at the top of this file).
        ...
        /// Create a new dataset entry, with no segments.
        ///
        /// A blueprint dataset and an asset dataset are created alongside it and referenced from the
        /// returned `dataset_details`; both are owned by the entry and cascade on delete. The request
        /// may carry a caller-chosen `id`; otherwise the server allocates one.
        ///
        /// Fails with `ALREADY_EXISTS` if an entry with the same name (or the same id) already
        /// exists.
        ...
        /// Create a new table entry with the given schema.
        ///
        /// Backed by a fresh Lance table at a server-chosen URL. Naming your own storage URL via
        /// `provider_details` is not supported on Rerun Hub (`UNIMPLEMENTED`); the OSS
        /// server honors it. Fails with `FAILED_PRECONDITION` if the server has no table storage
        /// configured, and with `ALREADY_EXISTS` if an entry with the same name already exists.
        ///
        /// Use `RegisterTable` instead to adopt a table that already exists.
        ...
        /// Overwrite the dataset-specific details of a dataset entry, e.g. its associated blueprint dataset.
        ///
        /// This is a full replace, not a merge: any field left unset in `dataset_details` is cleared.
        /// [`blueprint_dataset`] and [`asset_dataset`] deliberately differ on that point; see their
        /// own docs.
        ///
        /// [`blueprint_dataset`]: crate::cloud::v1alpha1::DatasetDetails::blueprint_dataset
        /// [`asset_dataset`]: crate::cloud::v1alpha1::DatasetDetails::asset_dataset
        ///
        /// The dataset is identified by the `x-rerun-entry-id` header, falling back to the deprecated
        /// body `id` field (see the `Headers` section at the top of this file).
        ...
        /// Fetch metadata about a specific table.
        ///
        /// The table is identified by the `x-rerun-entry-id` header, falling back to the deprecated
        /// body `id` field (see the `Headers` section at the top of this file).
        /// Fails with the gRPC status code `NOT_FOUND` for unknown or soft-deleted entries.
        ...
        /// Overwrite the table-specific details of a table entry, e.g. its associated blueprint dataset.
        ///
        /// This is a full replace, not a merge: any field left unset in `table_details` is cleared,
        /// except `blueprint_dataset`, which cannot be cleared: the server makes sure the table keeps
        /// a blueprint dataset.
        ///
        /// The table is identified by the `x-rerun-entry-id` header, falling back to the deprecated
        /// body `id` field (see the `Headers` section at the top of this file).
        ...
        /// Returns the schema of a table entry.
        ///
        /// The table is identified by the `x-rerun-entry-id` header, falling back to the deprecated
        /// body `table_id` field (see the `Headers` section at the top of this file).
        ...
        /// Inspect the contents of a table entry.
        ///
        /// The data follows the schema returned by `GetTableSchema`, assuming no concurrent write
        /// changed the table in between.
        ///
        /// The table is identified by the `x-rerun-entry-id` header, falling back to the deprecated
        /// body `table_id` field (see the `Headers` section at the top of this file).
