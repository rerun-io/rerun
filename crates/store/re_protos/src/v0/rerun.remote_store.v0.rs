...
pub struct RegistrationError {
    /// error code
    #[prost(enumeration = "super::super::common::v0::ErrorCode", tag = "1")]
    pub code: i32,
...
pub struct TimeMetadata {
    #[prost(message, optional, tag = "1")]
    pub timeline: ::core::option::Option<super::super::common::v0::Timeline>,
    #[prost(message, optional, tag = "2")]
                    ...
                    for UpdateRecordingMetadataSvc<T> {
                        ...
                        fn call(
                            ...
                            request: tonic::Request<
                                super::UpdateRecordingMetadataRequest,
                            >,
                        ) -> Self::Future {
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as StorageNode>::update_recording_metadata(
                                        &inner,
                                        request,
                                    )
                                    .await
