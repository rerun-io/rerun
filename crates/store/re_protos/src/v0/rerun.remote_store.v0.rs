...
/// Message containing data as arrow RecordBatch
...
/// Message containing Rerun Chunk (which is still a RecordBatch
/// but with lots of Rerun specific constraints
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct RerunChunkData {
    /// encoder version used to encode the data
    #[prost(enumeration = "EncoderVersion", tag = "1")]
    pub encoder_version: i32,
    /// Data payload is Arrow IPC encoded RecordBatch
    /// that can be converted to an internal Rerun Chunk directly
    #[prost(bytes = "vec", tag = "2")]
    pub payload: ::prost::alloc::vec::Vec<u8>,
}
...
pub struct RegisterRecordingRequest {
    ...
    pub additional_metadata: ::core::option::Option<RerunData>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct UpdateCatalogRequest {
    ...
    #[prost(message, optional, tag = "2")]
    pub metadata: ::core::option::Option<RerunData>,
}
#[derive(Clone, Copy, PartialEq, ::prost::Message)]
...
pub mod storage_node_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn query(
            ...
            tonic::Response<tonic::codec::Streaming<super::RerunData>>,
            tonic::Status,
        > {
        ...
        pub async fn fetch_recording(
            ...
            tonic::Response<tonic::codec::Streaming<super::RerunChunkData>>,
            tonic::Status,
        > {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::unknown(format!("Service was not ready: {}", e.into()))
        ...
        ) -> std::result::Result<tonic::Response<super::RerunData>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::unknown(format!("Service was not ready: {}", e.into()))
            })?;
            let codec = tonic::codec::ProstCodec::default();
...
pub mod storage_node_server {
    ...
    pub trait StorageNode: std::marker::Send + std::marker::Sync + 'static {
        ...
        type QueryStream: tonic::codegen::tokio_stream::Stream<
                Item = std::result::Result<super::RerunData, tonic::Status>,
            > + std::marker::Send
            + 'static;
        /// data API calls
        async fn query(
        ...
        type FetchRecordingStream: tonic::codegen::tokio_stream::Stream<
                Item = std::result::Result<super::RerunChunkData, tonic::Status>,
            > + std::marker::Send
            + 'static;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/rerun.remote_store.v0.StorageNode/FetchRecording" => {
                    ...
                    {
                        type Response = super::RerunChunkData;
