...
pub struct QueryManifestLatestAtRelevantChunks {
    ...
    #[prost(int64, tag = "2")]
    pub at: i64,
    /// Which components are we interested in? This must be non-empty in order to get any results.
    ///
    /// This will perform a basic fuzzy match on the available columns. The fuzzy logic is a
    /// simple case-sensitive `contains()` query.
    ...
    pub fuzzy_components: ::prost::alloc::vec::Vec<::prost::alloc::string::String>,
}
