...
impl LatestAtCache {
    ...
    fn latest_at(
        ...
        // TODO: this is what makes the tests fail but... how? we're not even GCing things, wtf.
        if results.is_partial() {
            // TODO: contrary to range results, latest-at results cannot ever be partially correct,
            // so we must give up entirely.
