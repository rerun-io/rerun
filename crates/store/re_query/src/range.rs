...
impl RangeCache {
    ...
    fn range(
        ...
        // We can safely ignore whether these results are partial or not, since that has no impact
        // on the fact that the chunks we did find can already be cached.
