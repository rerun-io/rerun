...
impl ::re_types_core::SizeBytes for GraphEdgesUndirected {
    #[inline]
...
static RECOMMENDED_COMPONENTS: once_cell::sync::Lazy<[ComponentName; 2usize]> =
    once_cell::sync::Lazy::new(|| {
        [
            ...
            "rerun.components.GraphEdgesUndirectedIndicator".into(),
        ]
    });
...
impl GraphEdgesUndirected {
    /// The total number of components in the archetype: 1 required, 2 recommended, 3 optional
    pub const NUM_COMPONENTS: usize = 6usize;
}

/// Indicator component for the [`GraphEdgesUndirected`] [`::re_types_core::Archetype`]
pub type GraphEdgesUndirectedIndicator =
    ::re_types_core::GenericIndicatorComponent<GraphEdgesUndirected>;

impl ::re_types_core::Archetype for GraphEdgesUndirected {
    type Indicator = GraphEdgesUndirectedIndicator;

    #[inline]
    fn name() -> ::re_types_core::ArchetypeName {
        "rerun.archetypes.GraphEdgesUndirected".into()
    }
    ...
    fn indicator() -> MaybeOwnedComponentBatch<'static> {
        static INDICATOR: GraphEdgesUndirectedIndicator = GraphEdgesUndirectedIndicator::DEFAULT;
    ...
    fn from_arrow_components(
        ...
        let edges = {
            let array = arrays_by_name
                ...
                .with_context("rerun.archetypes.GraphEdgesUndirected#edges")?;
        ...
        let colors = if let Some(array) = arrays_by_name.get("rerun.components.Color") {
            Some({
                <crate::components::Color>::from_arrow_opt(&**array)
                    .with_context("rerun.archetypes.GraphEdgesUndirected#colors")?
                    .into_iter()
                    .map(|v| v.ok_or_else(DeserializationError::missing_data))
                    .collect::<DeserializationResult<Vec<_>>>()
                    .with_context("rerun.archetypes.GraphEdgesUndirected#colors")?
        ...
        let labels = if let Some(array) = arrays_by_name.get("rerun.components.Text") {
            Some({
                <crate::components::Text>::from_arrow_opt(&**array)
                    .with_context("rerun.archetypes.GraphEdgesUndirected#labels")?
                    .into_iter()
                    .map(|v| v.ok_or_else(DeserializationError::missing_data))
                    .collect::<DeserializationResult<Vec<_>>>()
                    .with_context("rerun.archetypes.GraphEdgesUndirected#labels")?
        ...
        let show_labels = if let Some(array) = arrays_by_name.get("rerun.components.ShowLabels") {
            <crate::components::ShowLabels>::from_arrow_opt(&**array)
                .with_context("rerun.archetypes.GraphEdgesUndirected#show_labels")?
                .into_iter()
                .next()
                .flatten()
        } else {
        ...
        let class_ids = if let Some(array) = arrays_by_name.get("rerun.components.ClassId") {
            Some({
                <crate::components::ClassId>::from_arrow_opt(&**array)
                    .with_context("rerun.archetypes.GraphEdgesUndirected#class_ids")?
                    .into_iter()
                    .map(|v| v.ok_or_else(DeserializationError::missing_data))
                    .collect::<DeserializationResult<Vec<_>>>()
                    .with_context("rerun.archetypes.GraphEdgesUndirected#class_ids")?
...
impl ::re_types_core::AsComponents for GraphEdgesUndirected {
...
impl ::re_types_core::ArchetypeReflectionMarker for GraphEdgesUndirected {}

impl GraphEdgesUndirected {
    /// Create a new `GraphEdgesUndirected`.
    #[inline]
    pub fn new(
