...
///
/// Mirrors [`archetypes::DepthImage`][crate::archetypes::DepthImage], but stores an encoded blob instead of raw pixels while
...
impl EncodedDepthImage {
    ...
    pub fn descriptor_format() -> ComponentDescriptor {
        ComponentDescriptor {
            archetype: Some("rerun.archetypes.EncodedDepthImage".into()),
            component: "EncodedDepthImage:format".into(),
...
static REQUIRED_COMPONENTS: std::sync::LazyLock<[ComponentDescriptor; 2usize]> =
    std::sync::LazyLock::new(|| {
        [
            ...
            EncodedDepthImage::descriptor_format(),
        ]
    });
...
impl EncodedDepthImage {
    /// The total number of components in the archetype: 2 required, 2 recommended, 4 optional
...
impl EncodedDepthImage {
    ...
    #[inline]
    pub fn new(
        blob: impl Into<crate::components::Blob>,
