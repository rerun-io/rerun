...
impl ::re_types_core::SizeBytes for RangeFilter {
    #[inline]
...
::re_types_core::macros::impl_into_cow!(RangeFilter);

impl ::re_types_core::Loggable for RangeFilter {
    type Name = ::re_types_core::DatatypeName;

    #[inline]
    fn name() -> Self::Name {
        "rerun.blueprint.datatypes.RangeFilter".into()
    }
        ...
        Self: Sized,
    {
        ...
        Ok({
            let arrow_data = arrow_data
                ...
                .with_context("rerun.blueprint.datatypes.RangeFilter")?;
            if arrow_data.is_empty() {
                ...
                let start = {
                    ...
                    arrow_data
                        ...
                        .with_context("rerun.blueprint.datatypes.RangeFilter#start")?
                        .into_iter()
                        .map(|opt| opt.copied())
                ...
                let end = {
                    ...
                    arrow_data
                        ...
                        .with_context("rerun.blueprint.datatypes.RangeFilter#end")?
                        .into_iter()
                        .map(|opt| opt.copied())
                        .map(|res_or_opt| res_or_opt.map(crate::datatypes::TimeInt))
                };
