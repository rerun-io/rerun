...
#[repr(transparent)]
pub struct ComponentNames(pub Vec<::re_types_core::ArrowString>);

impl ::re_types_core::SizeBytes for ComponentNames {
    #[inline]
...
impl From<Vec<::re_types_core::ArrowString>> for ComponentNames {
    #[inline]
...
impl From<ComponentNames> for Vec<::re_types_core::ArrowString> {
    #[inline]
    fn from(value: ComponentNames) -> Self {
        value.0
    }
}

::re_types_core::macros::impl_into_cow!(ComponentNames);

impl ::re_types_core::Loggable for ComponentNames {
    type Name = ::re_types_core::DatatypeName;

    #[inline]
    fn name() -> Self::Name {
        "rerun.blueprint.datatypes.ComponentNames".into()
    }
        ...
        Self: Sized,
    {
        ...
        Ok({
            let arrow_data = arrow_data
                ...
                .with_context("rerun.blueprint.datatypes.ComponentNames#value")?;
        ...
        .collect::<DeserializationResult<Vec<Option<_>>>>()
        .with_context("rerun.blueprint.datatypes.ComponentNames#value")
        .with_context("rerun.blueprint.datatypes.ComponentNames")?)
    }
}
