...
impl ::re_types_core::SizeBytes for ForceManyBody {
    ...
    #[inline]
    fn is_pod() -> bool {
        <bool>::is_pod() && <f64>::is_pod()
    }
}

::re_types_core::macros::impl_into_cow!(ForceManyBody);

impl ::re_types_core::Loggable for ForceManyBody {
    #[inline]
        ...
        Self: Sized,
    {
        ...
        Ok({
            let arrow_data = arrow_data
                ...
                .with_context("rerun.blueprint.datatypes.ForceManyBody")?;
            if arrow_data.is_empty() {
                ...
                let strength = {
                    ...
                    arrow_data
                        ...
                        .with_context("rerun.blueprint.datatypes.ForceManyBody#strength")?
                        .into_iter()
                        .map(|opt| opt.copied())
                };
                arrow2::bitmap::utils::ZipValidity::new_with_validity(
                    ::itertools::izip!(enabled, strength),
                    arrow_data.validity(),
                )
                .map(|opt| {
                    opt.map(|(enabled, strength)| {
                        Ok(Self {
                            enabled: enabled
