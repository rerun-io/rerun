...
impl ::re_types_core::Loggable for FilterByEvent {
    ...
    #[inline]
    fn name() -> Self::Name {
        "rerun.blueprint.datatypes.FilterByEvent".into()
    }
        ...
        Self: Sized,
    {
        ...
        Ok({
            let arrow_data = arrow_data
                ...
                .with_context("rerun.blueprint.datatypes.FilterByEvent")?;
            if arrow_data.is_empty() {
                ...
                let active = {
                    ...
                    arrow_data
                        ...
                        .with_context("rerun.blueprint.datatypes.FilterByEvent#active")?
                        .into_iter()
                ...
                let column = {
                    ...
                    crate::blueprint::datatypes::ComponentColumnSelector::from_arrow_opt(arrow_data)
                        .with_context("rerun.blueprint.datatypes.FilterByEvent#column")?
                        .into_iter()
                };
