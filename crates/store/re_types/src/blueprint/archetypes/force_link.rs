...
pub struct ForceLink {
    pub force: crate::blueprint::components::ForceLink,
}
...
impl ::re_types_core::SizeBytes for ForceLink {
    ...
    #[inline]
    fn is_pod() -> bool {
        <crate::blueprint::components::ForceLink>::is_pod()
    }
}
    ...
    fn from_arrow2_components(
        ...
        let force = {
            let array = arrays_by_name
                .get("rerun.blueprint.components.ForceLink")
                .ok_or_else(DeserializationError::missing_data)
                .with_context("rerun.blueprint.archetypes.ForceLink#force")?;
            <crate::blueprint::components::ForceLink>::from_arrow2_opt(&**array)
                .with_context("rerun.blueprint.archetypes.ForceLink#force")?
                .into_iter()
                .next()
                .flatten()
...
impl ForceLink {
    ...
    #[inline]
    pub fn new(force: impl Into<crate::blueprint::components::ForceLink>) -> Self {
        Self {
            force: force.into(),
        }
    }
