...
static OPTIONAL_COMPONENTS: std::sync::LazyLock<[ComponentDescriptor; 1usize]> =
    std::sync::LazyLock::new(|| [GraphBackground::descriptor_color()]);
...
impl ::re_types_core::Archetype for GraphBackground {
    #[inline]
    fn name() -> ::re_types_core::ArchetypeName {
        "rerun.blueprint.archetypes.GraphBackground".into()
    }
...
impl ::re_types_core::AsComponents for GraphBackground {
    #[inline]
    fn as_serialized_batches(&self) -> Vec<SerializedComponentBatch> {
        use ::re_types_core::Archetype as _;
        std::iter::once(self.color.clone()).flatten().collect()
    }
}

impl ::re_types_core::ArchetypeReflectionMarker for GraphBackground {}

impl GraphBackground {
    /// Create a new `GraphBackground`.
    #[inline]
    pub fn new() -> Self {
        Self { color: None }
    }
...
impl ::re_byte_size::SizeBytes for GraphBackground {
    #[inline]
