...
pub struct ForceManyBody {
    pub force: crate::blueprint::components::ForceManyBody,
}
...
impl ::re_types_core::SizeBytes for ForceManyBody {
    ...
    #[inline]
    fn is_pod() -> bool {
        <crate::blueprint::components::ForceManyBody>::is_pod()
    }
}
    ...
    fn from_arrow2_components(
        ...
        let force = {
            let array = arrays_by_name
                .get("rerun.blueprint.components.ForceManyBody")
                .ok_or_else(DeserializationError::missing_data)
                .with_context("rerun.blueprint.archetypes.ForceManyBody#force")?;
            <crate::blueprint::components::ForceManyBody>::from_arrow2_opt(&**array)
                .with_context("rerun.blueprint.archetypes.ForceManyBody#force")?
                .into_iter()
                .next()
                .flatten()
...
impl ForceManyBody {
    ...
    #[inline]
    pub fn new(force: impl Into<crate::blueprint::components::ForceManyBody>) -> Self {
        Self {
            force: force.into(),
        }
    }
