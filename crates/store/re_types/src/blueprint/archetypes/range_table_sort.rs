...
impl ::re_types_core::SizeBytes for RangeTableSort {
    #[inline]
...
static RECOMMENDED_COMPONENTS: once_cell::sync::Lazy<[ComponentName; 1usize]> =
    once_cell::sync::Lazy::new(|| ["rerun.blueprint.components.RangeTableSortIndicator".into()]);
...
static ALL_COMPONENTS: once_cell::sync::Lazy<[ComponentName; 3usize]> =
    once_cell::sync::Lazy::new(|| {
        [
            "rerun.blueprint.components.RangeTableSortIndicator".into(),
            "rerun.blueprint.components.SortKey".into(),
            "rerun.blueprint.components.SortOrder".into(),
        ]
    });
...
/// Indicator component for the [`RangeTableSort`] [`::re_types_core::Archetype`]
pub type RangeTableSortIndicator = ::re_types_core::GenericIndicatorComponent<RangeTableSort>;

impl ::re_types_core::Archetype for RangeTableSort {
    type Indicator = RangeTableSortIndicator;

    #[inline]
    fn name() -> ::re_types_core::ArchetypeName {
        "rerun.blueprint.archetypes.RangeTableSort".into()
    }
    ...
    fn indicator() -> MaybeOwnedComponentBatch<'static> {
        static INDICATOR: RangeTableSortIndicator = RangeTableSortIndicator::DEFAULT;
    ...
    fn from_arrow_components(
        ...
        let sort_key = if let Some(array) = arrays_by_name.get("rerun.blueprint.components.SortKey")
        {
            <crate::blueprint::components::SortKey>::from_arrow_opt(&**array)
                .with_context("rerun.blueprint.archetypes.RangeTableSort#sort_key")?
                .into_iter()
                .next()
                .flatten()
        } else {
        ...
        let sort_order =
            if let Some(array) = arrays_by_name.get("rerun.blueprint.components.SortOrder") {
                <crate::blueprint::components::SortOrder>::from_arrow_opt(&**array)
                    .with_context("rerun.blueprint.archetypes.RangeTableSort#sort_order")?
                    .into_iter()
                    .next()
                    .flatten()
            } else {
...
impl ::re_types_core::AsComponents for RangeTableSort {
...
impl ::re_types_core::ArchetypeReflectionMarker for RangeTableSort {}

impl RangeTableSort {
    /// Create a new `RangeTableSort`.
    #[inline]
    pub fn new() -> Self {
        Self {
            sort_key: None,
