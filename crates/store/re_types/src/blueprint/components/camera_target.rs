...
impl ::re_types_core::SizeBytes for CameraTarget {
    #[inline]
...
impl<T: Into<crate::datatypes::Vec3D>> From<T> for CameraTarget {
    fn from(v: T) -> Self {
        Self(v.into())
    }
}

impl std::borrow::Borrow<crate::datatypes::Vec3D> for CameraTarget {
    #[inline]
...
impl std::ops::Deref for CameraTarget {
...
impl std::ops::DerefMut for CameraTarget {
    #[inline]
...
::re_types_core::macros::impl_into_cow!(CameraTarget);

impl ::re_types_core::Loggable for CameraTarget {
