...
pub struct CameraOrigin(
    ...
    pub crate::datatypes::Vec3D,
);

impl ::re_types_core::SizeBytes for CameraOrigin {
    #[inline]
...
impl<T: Into<crate::datatypes::Vec3D>> From<T> for CameraOrigin {
    fn from(v: T) -> Self {
        Self(v.into())
    }
}

impl std::borrow::Borrow<crate::datatypes::Vec3D> for CameraOrigin {
    #[inline]
...
impl std::ops::Deref for CameraOrigin {
...
impl std::ops::DerefMut for CameraOrigin {
    #[inline]
...
::re_types_core::macros::impl_into_cow!(CameraOrigin);

impl ::re_types_core::Loggable for CameraOrigin {
