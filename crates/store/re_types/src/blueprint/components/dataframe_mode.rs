...
impl ::re_types_core::reflection::Enum for DataframeMode {
    #[inline]
...
impl ::re_types_core::SizeBytes for DataframeMode {
    #[inline]
...
impl std::fmt::Display for DataframeMode {
...
::re_types_core::macros::impl_into_cow!(DataframeMode);

impl ::re_types_core::Loggable for DataframeMode {
        ...
        Self: Sized,
    {
        ...
        Ok({
            let arrow_data = arrow_data
                ...
                .with_context("rerun.blueprint.components.DataframeMode")?;
