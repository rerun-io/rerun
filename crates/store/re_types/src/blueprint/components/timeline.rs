...
impl<T: Into<crate::datatypes::Utf8>> From<T> for Timeline {
    fn from(v: T) -> Self {
        Self(v.into())
    }
}

impl std::borrow::Borrow<crate::datatypes::Utf8> for Timeline {
    #[inline]
...
impl std::ops::Deref for Timeline {
...
impl std::ops::DerefMut for Timeline {
    #[inline]
...
::re_types_core::macros::impl_into_cow!(Timeline);

impl ::re_types_core::Loggable for Timeline {
