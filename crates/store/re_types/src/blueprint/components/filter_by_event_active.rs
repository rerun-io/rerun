...
#[repr(transparent)]
pub struct FilterByEventActive(pub crate::datatypes::Bool);

impl ::re_types_core::SizeBytes for FilterByEventActive {
    #[inline]
...
impl<T: Into<crate::datatypes::Bool>> From<T> for FilterByEventActive {
    fn from(v: T) -> Self {
        Self(v.into())
    }
}

impl std::borrow::Borrow<crate::datatypes::Bool> for FilterByEventActive {
    #[inline]
...
impl std::ops::Deref for FilterByEventActive {
...
impl std::ops::DerefMut for FilterByEventActive {
    #[inline]
...
::re_types_core::macros::impl_into_cow!(FilterByEventActive);

impl ::re_types_core::Loggable for FilterByEventActive {
