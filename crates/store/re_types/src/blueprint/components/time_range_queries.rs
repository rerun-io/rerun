...
impl ::re_types_core::SizeBytes for TimeRangeQueries {
    #[inline]
    ...
    #[inline]
    fn is_pod() -> bool {
        <Vec<crate::blueprint::datatypes::TimeRangeQuery>>::is_pod()
    }
}

impl<I: Into<crate::blueprint::datatypes::TimeRangeQuery>, T: IntoIterator<Item = I>> From<T>
    for TimeRangeQueries
{
    fn from(v: T) -> Self {
...
::re_types_core::macros::impl_into_cow!(TimeRangeQueries);

impl ::re_types_core::Loggable for TimeRangeQueries {
    ...
    fn arrow_datatype() -> arrow2::datatypes::DataType {
        ...
        DataType::List(std::sync::Arc::new(Field::new(
            "item",
            <crate::blueprint::datatypes::TimeRangeQuery>::arrow_datatype(),
            false,
        )))
    }
            ...
            };
            {
                ...
                ListArray::try_new(
                    ...
                    offsets,
                    {
                        ...
                        crate::blueprint::datatypes::TimeRangeQuery::to_arrow_opt(
