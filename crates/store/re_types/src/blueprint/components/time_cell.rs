...
#[repr(transparent)]
pub struct TimeCell(pub crate::datatypes::TimeInt);

impl ::re_types_core::Component for TimeCell {
    #[inline]
    fn name() -> ComponentType {
        "rerun.blueprint.components.TimeCell".into()
    }
}

::re_types_core::macros::impl_into_cow!(TimeCell);

impl ::re_types_core::Loggable for TimeCell {
    #[inline]
...
impl<T: Into<crate::datatypes::TimeInt>> From<T> for TimeCell {
    fn from(v: T) -> Self {
        Self(v.into())
    }
}

impl std::borrow::Borrow<crate::datatypes::TimeInt> for TimeCell {
    #[inline]
...
impl std::ops::Deref for TimeCell {
...
impl std::ops::DerefMut for TimeCell {
    #[inline]
