...
impl ::re_types_core::reflection::Enum for TableGroupBy {
    #[inline]
...
impl ::re_types_core::SizeBytes for TableGroupBy {
    #[inline]
...
impl std::fmt::Display for TableGroupBy {
...
::re_types_core::macros::impl_into_cow!(TableGroupBy);

impl ::re_types_core::Loggable for TableGroupBy {
        ...
        Self: Sized,
    {
        ...
        Ok({
            let arrow_data = arrow_data
                ...
                .with_context("rerun.blueprint.components.TableGroupBy")?;
