...
impl ::re_types_core::SizeBytes for PlaneOffset {
    #[inline]
...
impl<T: Into<crate::datatypes::Float32>> From<T> for PlaneOffset {
    fn from(v: T) -> Self {
        Self(v.into())
    }
}

impl std::borrow::Borrow<crate::datatypes::Float32> for PlaneOffset {
    #[inline]
...
impl std::ops::Deref for PlaneOffset {
...
impl std::ops::DerefMut for PlaneOffset {
    #[inline]
...
::re_types_core::macros::impl_into_cow!(PlaneOffset);

impl ::re_types_core::Loggable for PlaneOffset {
    #[inline]
...
impl ::re_types_core::Component for PlaneOffset {
    #[inline]
