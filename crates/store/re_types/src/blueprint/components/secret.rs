...
#[repr(transparent)]
pub struct Secret(pub crate::datatypes::Utf8);

impl ::re_types_core::SizeBytes for Secret {
    #[inline]
...
impl<T: Into<crate::datatypes::Utf8>> From<T> for Secret {
    fn from(v: T) -> Self {
        Self(v.into())
    }
}

impl std::borrow::Borrow<crate::datatypes::Utf8> for Secret {
    #[inline]
...
::re_types_core::macros::impl_into_cow!(Secret);

impl ::re_types_core::Loggable for Secret {
