...
impl ::re_types_core::Loggable for FilterIsNotNull {
    ...
    fn arrow2_datatype() -> arrow2::datatypes::DataType {
        crate::blueprint::datatypes::FilterIsNotNull::arrow2_datatype()
    }
    ...
    where
        Self: Clone + 'a,
    {
        crate::blueprint::datatypes::FilterIsNotNull::to_arrow2_opt(data.into_iter().map(|datum| {
    ...
    where
        Self: Sized,
    {
        crate::blueprint::datatypes::FilterIsNotNull::from_arrow2_opt(arrow_data)
