...
impl ::re_types_core::SizeBytes for UiRadius {
    #[inline]
...
impl<T: Into<crate::datatypes::Float32>> From<T> for UiRadius {
    fn from(v: T) -> Self {
        Self(v.into())
    }
}

impl std::borrow::Borrow<crate::datatypes::Float32> for UiRadius {
    #[inline]
...
impl std::ops::Deref for UiRadius {
...
impl std::ops::DerefMut for UiRadius {
    #[inline]
...
::re_types_core::macros::impl_into_cow!(UiRadius);

impl ::re_types_core::Loggable for UiRadius {
    #[inline]
...
impl ::re_types_core::Component for UiRadius {
    #[inline]
