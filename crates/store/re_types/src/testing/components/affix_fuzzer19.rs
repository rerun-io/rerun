...
impl ::re_types_core::Loggable for AffixFuzzer19 {
    ...
    fn arrow2_datatype() -> arrow2::datatypes::DataType {
        crate::testing::datatypes::AffixFuzzer5::arrow2_datatype()
    }
    ...
    where
        Self: Clone + 'a,
    {
        crate::testing::datatypes::AffixFuzzer5::to_arrow2_opt(data.into_iter().map(|datum| {
    ...
    where
        Self: Sized,
    {
        crate::testing::datatypes::AffixFuzzer5::from_arrow2_opt(arrow_data)
