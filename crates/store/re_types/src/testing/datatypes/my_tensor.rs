...
// Based on "crates/store/re_types/definitions/rerun/testing/datatypes/datatype_generics.fbs".
...
pub struct MyTensor {
    ...
    /// The content/data, using datatype generics.
    pub buffer: ::arrow::array::ArrayRef,
}

::re_types_core::macros::impl_into_cow!(MyTensor);

impl ::re_types_core::Loggable for MyTensor {
    #[inline]
            ...
            as_array_ref(StructArray::new(
                ...
                vec![
                    ...
                    },
                    {
                        ...
                        todo!("Serialize list of scalars")
                    },
                ],
                validity,
            ))
        ...
        Self: Sized,
    {
        ...
        Ok({
            let arrow_data = arrow_data
                ...
                .with_context("rerun.testing.datatypes.MyTensor")?;
            if arrow_data.is_empty() {
                ...
                let shape = {
                    ...
                    let arrow_data = &**arrays_by_name["shape"];
                    {
                        let arrow_data = arrow_data
                            ...
                            .with_context("rerun.testing.datatypes.MyTensor#shape")?;
                        if arrow_data.is_empty() {
                            Vec::new()
                        } else {
                ...
                let buffer = {
                    ...
                    todo!("Deserialize list of scalars")
                };
                ...
                .map(|opt| {
                    opt.map(|(shape, buffer)| {
                        Ok(Self {
                            ...
                            buffer: buffer
                                .ok_or_else(DeserializationError::missing_data)
                                .with_context("rerun.testing.datatypes.MyTensor#buffer")?,
                        })
                    })
                    .transpose()
                })
...
impl ::re_byte_size::SizeBytes for MyTensor {
    #[inline]
    ...
    #[inline]
    fn is_pod() -> bool {
        <::arrow::buffer::ScalarBuffer<u64>>::is_pod() && <::arrow::array::ArrayRef>::is_pod()
    }
}
