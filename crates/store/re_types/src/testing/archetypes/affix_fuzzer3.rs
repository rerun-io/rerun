...
impl AffixFuzzer3 {
    ...
    pub fn descriptor_indicator() -> ComponentDescriptor {
        ComponentDescriptor {
            archetype_name: None,
            component_type: None,
            component: "rerun.testing.components.AffixFuzzer3Indicator".into(),
        }
    }
}
