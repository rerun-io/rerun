            ...
            if arrow_data.is_empty() {
                ...
                let timeline = {
                    ...
                    let arrow_data = &**arrays_by_name["timeline"];
                    {
                        let arrow_data = arrow_data
                            ...
                            .with_context("rerun.datatypes.AbsoluteTimeRange#timeline")?;
                ...
                let start = {
                    ...
                    arrow_data
                        ...
                        .with_context("rerun.datatypes.AbsoluteTimeRange#start")?
                        .into_iter()
                ...
                let end = {
                    ...
                    arrow_data
                        ...
                        .with_context("rerun.datatypes.AbsoluteTimeRange#end")?
                        .into_iter()
                        .map(|res_or_opt| res_or_opt.map(crate::datatypes::TimeInt))
                };
