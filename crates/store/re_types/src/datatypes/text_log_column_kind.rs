        ...
        Self: Sized,
    {
        ...
        Ok({
            let arrow_data = arrow_data
                ...
                .with_context("rerun.datatypes.TextLogColumnKind")?;
                ...
                let timeline = {
                    let arrow_data = arrow_data.child(1).as_ref();
                    {
                        let arrow_data = arrow_data
                            ...
                            .with_context("rerun.datatypes.TextLogColumnKind#Timeline")?;
                            ...
                            Ok(Some(match typ {
                                1i8 => Self::Timeline({
                                    if offset as usize >= timeline.len() {
                                        ...
                                        .with_context(
                                            "rerun.datatypes.TextLogColumnKind#Timeline",
                                        );
                                    }
...
impl ::re_byte_size::SizeBytes for TextLogColumnKind {
    #[inline]
