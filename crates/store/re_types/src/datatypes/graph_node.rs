...
pub struct GraphNode(pub ::re_types_core::ArrowString);
...
impl From<::re_types_core::ArrowString> for GraphNode {
    #[inline]
...
impl From<GraphNode> for ::re_types_core::ArrowString {
    #[inline]
...
impl ::re_types_core::Loggable for GraphNode {
    ...
    #[inline]
    fn name() -> Self::Name {
        "rerun.datatypes.GraphNode".into()
    }
        ...
        Self: Sized,
    {
        ...
        Ok({
            let arrow_data = arrow_data
                ...
                .with_context("rerun.datatypes.GraphNode#id")?;
        ...
        .collect::<DeserializationResult<Vec<Option<_>>>>()
        .with_context("rerun.datatypes.GraphNode#id")
        .with_context("rerun.datatypes.GraphNode")?)
    }
}
