...
pub fn blob_and_datatype_from_tensor(tensor_buffer: TensorBuffer) -> (Blob, ChannelDatatype) {
    match tensor_buffer {
        TensorBuffer::U8(buffer) => (Blob(buffer.inner().clone()), ChannelDatatype::U8),
        TensorBuffer::U16(buffer) => (Blob(buffer.inner().clone()), ChannelDatatype::U16),
        TensorBuffer::U32(buffer) => (Blob(buffer.inner().clone()), ChannelDatatype::U32),
        TensorBuffer::U64(buffer) => (Blob(buffer.inner().clone()), ChannelDatatype::U64),
        TensorBuffer::I8(buffer) => (Blob(buffer.inner().clone()), ChannelDatatype::I8),
        TensorBuffer::I16(buffer) => (Blob(buffer.inner().clone()), ChannelDatatype::I16),
        TensorBuffer::I32(buffer) => (Blob(buffer.inner().clone()), ChannelDatatype::I32),
        TensorBuffer::I64(buffer) => (Blob(buffer.inner().clone()), ChannelDatatype::I64),
        TensorBuffer::F16(buffer) => (Blob(buffer.inner().clone()), ChannelDatatype::F16),
        TensorBuffer::F32(buffer) => (Blob(buffer.inner().clone()), ChannelDatatype::F32),
        TensorBuffer::F64(buffer) => (Blob(buffer.inner().clone()), ChannelDatatype::F64),
    }
}
