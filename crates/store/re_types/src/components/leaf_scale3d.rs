...
#[repr(transparent)]
pub struct LeafScale3D(pub crate::datatypes::Vec3D);

impl ::re_types_core::SizeBytes for LeafScale3D {
    #[inline]
...
impl<T: Into<crate::datatypes::Vec3D>> From<T> for LeafScale3D {
    fn from(v: T) -> Self {
        Self(v.into())
    }
}

impl std::borrow::Borrow<crate::datatypes::Vec3D> for LeafScale3D {
    #[inline]
...
impl std::ops::Deref for LeafScale3D {
...
impl std::ops::DerefMut for LeafScale3D {
    #[inline]
...
::re_types_core::macros::impl_into_cow!(LeafScale3D);

impl ::re_types_core::Loggable for LeafScale3D {
