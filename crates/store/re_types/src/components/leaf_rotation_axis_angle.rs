...
#[repr(transparent)]
pub struct LeafRotationAxisAngle(pub crate::datatypes::RotationAxisAngle);

impl ::re_types_core::SizeBytes for LeafRotationAxisAngle {
    #[inline]
...
impl<T: Into<crate::datatypes::RotationAxisAngle>> From<T> for LeafRotationAxisAngle {
    fn from(v: T) -> Self {
        Self(v.into())
    }
}

impl std::borrow::Borrow<crate::datatypes::RotationAxisAngle> for LeafRotationAxisAngle {
    #[inline]
...
impl std::ops::Deref for LeafRotationAxisAngle {
...
impl std::ops::DerefMut for LeafRotationAxisAngle {
    #[inline]
...
::re_types_core::macros::impl_into_cow!(LeafRotationAxisAngle);

impl ::re_types_core::Loggable for LeafRotationAxisAngle {
