...
impl ::re_types_core::Component for InvalidTransform {
    #[inline]
    fn descriptor() -> ComponentDescriptor {
        ComponentDescriptor::new("rerun.components.InvalidTransform")
    }
}

::re_types_core::macros::impl_into_cow!(InvalidTransform);

impl ::re_types_core::Loggable for InvalidTransform {
    #[inline]
...
impl<T: Into<crate::datatypes::Bool>> From<T> for InvalidTransform {
    fn from(v: T) -> Self {
        Self(v.into())
    }
}

impl std::borrow::Borrow<crate::datatypes::Bool> for InvalidTransform {
    #[inline]
...
impl std::ops::Deref for InvalidTransform {
...
impl std::ops::DerefMut for InvalidTransform {
    #[inline]
...
impl ::re_types_core::SizeBytes for InvalidTransform {
    #[inline]
