...
pub struct GraphEdgeDirected(pub crate::datatypes::GraphEdge);

impl ::re_types_core::SizeBytes for GraphEdgeDirected {
    #[inline]
...
impl<T: Into<crate::datatypes::GraphEdge>> From<T> for GraphEdgeDirected {
    fn from(v: T) -> Self {
        Self(v.into())
    }
}

impl std::borrow::Borrow<crate::datatypes::GraphEdge> for GraphEdgeDirected {
    #[inline]
...
impl std::ops::Deref for GraphEdgeDirected {
...
impl std::ops::DerefMut for GraphEdgeDirected {
    #[inline]
...
::re_types_core::macros::impl_into_cow!(GraphEdgeDirected);

impl ::re_types_core::Loggable for GraphEdgeDirected {
    type Name = ::re_types_core::ComponentName;

    #[inline]
    fn name() -> Self::Name {
        "rerun.components.GraphEdgeDirected".into()
    }
