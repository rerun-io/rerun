...
#[repr(transparent)]
pub struct LeafTranslation3D(pub crate::datatypes::Vec3D);

impl ::re_types_core::SizeBytes for LeafTranslation3D {
    #[inline]
...
impl<T: Into<crate::datatypes::Vec3D>> From<T> for LeafTranslation3D {
    fn from(v: T) -> Self {
        Self(v.into())
    }
}

impl std::borrow::Borrow<crate::datatypes::Vec3D> for LeafTranslation3D {
    #[inline]
...
impl std::ops::Deref for LeafTranslation3D {
...
impl std::ops::DerefMut for LeafTranslation3D {
    #[inline]
...
::re_types_core::macros::impl_into_cow!(LeafTranslation3D);

impl ::re_types_core::Loggable for LeafTranslation3D {
