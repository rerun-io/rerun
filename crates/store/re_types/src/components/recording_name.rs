...
impl<T: Into<crate::datatypes::Utf8>> From<T> for RecordingName {
    fn from(v: T) -> Self {
        Self(v.into())
    }
}

impl std::borrow::Borrow<crate::datatypes::Utf8> for RecordingName {
    #[inline]
...
impl std::ops::Deref for RecordingName {
...
impl std::ops::DerefMut for RecordingName {
    #[inline]
...
impl ::re_byte_size::SizeBytes for RecordingName {
    #[inline]
