...
// Based on "crates/store/re_types/definitions/rerun/components/element_type.fbs".
...
impl ::re_types_core::reflection::Enum for ElementType {
    #[inline]
...
impl ::re_types_core::SizeBytes for ElementType {
    #[inline]
...
::re_types_core::macros::impl_into_cow!(ElementType);

impl ::re_types_core::Loggable for ElementType {
        ...
        Self: Sized,
    {
        ...
        Ok({
            let arrow_data = arrow_data
                ...
                .with_context("rerun.components.ElementType")?;
