...
impl ::re_types_core::Component for Uri {
    #[inline]
    fn descriptor() -> ComponentDescriptor {
        ComponentDescriptor::new("rerun.components.Uri")
    }
}

::re_types_core::macros::impl_into_cow!(Uri);

impl ::re_types_core::Loggable for Uri {
    #[inline]
...
impl<T: Into<crate::datatypes::Utf8>> From<T> for Uri {
    fn from(v: T) -> Self {
        Self(v.into())
    }
}

impl std::borrow::Borrow<crate::datatypes::Utf8> for Uri {
    #[inline]
...
impl ::re_byte_size::SizeBytes for Uri {
    #[inline]
