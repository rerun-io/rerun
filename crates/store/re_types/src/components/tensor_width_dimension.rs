...
#[doc(hidden)]
pub struct __TensorWidthDimensionMarker;

/// **Component**: Specifies which dimension to use for width.
pub type TensorWidthDimension = crate::WrapperComponent<
    crate::datatypes::TensorDimensionSelection,
    __TensorWidthDimensionMarker,
>;

#[allow(non_snake_case)]
#[inline]
pub const fn TensorWidthDimension(
    v: crate::datatypes::TensorDimensionSelection,
