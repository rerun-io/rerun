...
impl ::re_types_core::Loggable for Scalar {
    ...
    fn arrow2_datatype() -> arrow2::datatypes::DataType {
        crate::datatypes::Float64::arrow2_datatype()
    }
    ...
    where
        Self: Clone + 'a,
    {
        crate::datatypes::Float64::to_arrow2_opt(data.into_iter().map(|datum| {
    ...
    where
        Self: Sized,
    {
        crate::datatypes::Float64::from_arrow2(arrow_data).map(bytemuck::cast_vec)
    }
}
