...
impl ::re_types_core::Loggable for TriangleIndices {
    ...
    fn arrow2_datatype() -> arrow2::datatypes::DataType {
        crate::datatypes::UVec3D::arrow2_datatype()
    }
    ...
    where
        Self: Clone + 'a,
    {
        crate::datatypes::UVec3D::to_arrow2_opt(data.into_iter().map(|datum| {
    ...
    where
        Self: Sized,
    {
        crate::datatypes::UVec3D::from_arrow2_opt(arrow_data)
    ...
    where
        Self: Sized,
    {
        crate::datatypes::UVec3D::from_arrow2(arrow_data).map(bytemuck::cast_vec)
    }
}
