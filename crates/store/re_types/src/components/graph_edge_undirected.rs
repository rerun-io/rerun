...
pub struct GraphEdgeUndirected(pub crate::datatypes::GraphEdge);

impl ::re_types_core::SizeBytes for GraphEdgeUndirected {
    #[inline]
...
impl<T: Into<crate::datatypes::GraphEdge>> From<T> for GraphEdgeUndirected {
    fn from(v: T) -> Self {
        Self(v.into())
    }
}

impl std::borrow::Borrow<crate::datatypes::GraphEdge> for GraphEdgeUndirected {
    #[inline]
...
impl std::ops::Deref for GraphEdgeUndirected {
...
impl std::ops::DerefMut for GraphEdgeUndirected {
    #[inline]
...
::re_types_core::macros::impl_into_cow!(GraphEdgeUndirected);

impl ::re_types_core::Loggable for GraphEdgeUndirected {
