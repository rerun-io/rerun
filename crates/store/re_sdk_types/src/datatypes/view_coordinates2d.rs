...
impl ::re_types_core::Loggable for ViewCoordinates2D {
    #[inline]
        ...
        Self: Sized,
    {
        ...
        Ok({
            let arrow_data = arrow_data
                ...
                .with_context("rerun.datatypes.ViewCoordinates2D#coordinates")?;
        ...
        .collect::<DeserializationResult<Vec<Option<_>>>>()
        .with_context("rerun.datatypes.ViewCoordinates2D#coordinates")
        .with_context("rerun.datatypes.ViewCoordinates2D")?)
    }
...
impl From<[u8; 2usize]> for ViewCoordinates2D {
    #[inline]
    fn from(coordinates: [u8; 2usize]) -> Self {
        Self(coordinates)
    }
}

impl From<ViewCoordinates2D> for [u8; 2usize] {
    #[inline]
    fn from(value: ViewCoordinates2D) -> Self {
        value.0
    }
}
