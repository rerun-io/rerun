...
::re_types_core::macros::impl_into_cow!(SphericalHarmonics3);

impl ::re_types_core::Loggable for SphericalHarmonics3 {
    #[inline]
        ...
        Self: Sized,
    {
        ...
        Ok({
            let arrow_data = arrow_data
                ...
                .with_context("rerun.datatypes.SphericalHarmonics3#coefficients")?;
        ...
        .collect::<DeserializationResult<Vec<Option<_>>>>()
        .with_context("rerun.datatypes.SphericalHarmonics3#coefficients")
        .with_context("rerun.datatypes.SphericalHarmonics3")?)
    }
...
impl From<[[half::f16; 3usize]; 15usize]> for SphericalHarmonics3 {
    #[inline]
...
impl From<SphericalHarmonics3> for [[half::f16; 3usize]; 15usize] {
    #[inline]
    fn from(value: SphericalHarmonics3) -> Self {
        value.0
    }
}
