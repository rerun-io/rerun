...
pub struct VideoPresentationTimestampOffset(
...
impl ::re_types_core::Loggable for VideoPresentationTimestampOffset {
    #[inline]
        ...
        Self: Sized,
    {
        ...
        Ok(arrow_data
            ...
            .with_context("rerun.datatypes.VideoPresentationTimestampOffset#offset")?
            .into_iter()
            .map(|v| v.ok_or_else(DeserializationError::missing_data))
            .map(|res| res.map(|v| Some(Self(v))))
            .collect::<DeserializationResult<Vec<Option<_>>>>()
            .with_context("rerun.datatypes.VideoPresentationTimestampOffset#offset")
            .with_context("rerun.datatypes.VideoPresentationTimestampOffset")?)
    }
...
impl From<i64> for VideoPresentationTimestampOffset {
    #[inline]
...
impl From<VideoPresentationTimestampOffset> for i64 {
    #[inline]
    fn from(value: VideoPresentationTimestampOffset) -> Self {
        value.0
    }
}
