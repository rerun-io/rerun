...
// Based on "crates/build/re_type_definitions/rerun/blueprint/components/link_axis.def.rs".
...
impl ::re_types_core::ArrowDatatype for LinkAxis {
    #[inline]
...
impl ::re_types_core::ToArrow for LinkAxis {
    fn to_arrow<'a>(
...
impl ::re_types_core::FromArrow for LinkAxis {
    fn from_arrow(arrow_data: &dyn arrow::array::Array) -> DeserializationResult<Vec<Self>> {
        ...
        use arrow::{array::*, buffer::*, datatypes::*};
        err_on_nulls(arrow_data, "rerun.blueprint.components.LinkAxis")?;
        Ok(arrow_data
