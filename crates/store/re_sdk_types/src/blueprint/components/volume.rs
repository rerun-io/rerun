...
#[repr(transparent)]
pub struct Volume(pub crate::encodings::Float32);

impl ::re_types_core::WrapperComponent for Volume {
    type Encoding = crate::encodings::Float32;

    #[inline]
    fn name() -> ComponentType {
        "rerun.blueprint.components.Volume".into()
    }
...
::re_types_core::macros::impl_into_cow!(Volume);

impl<T: Into<crate::encodings::Float32>> From<T> for Volume {
    fn from(v: T) -> Self {
        Self(v.into())
    }
}

impl std::borrow::Borrow<crate::encodings::Float32> for Volume {
    #[inline]
...
impl std::ops::DerefMut for Volume {
    #[inline]
