...
impl ::re_types_core::ArrowDatatype for MapProvider {
    #[inline]
...
impl ::re_types_core::ToArrow for MapProvider {
    fn to_arrow<'a>(
...
impl ::re_types_core::FromArrow for MapProvider {
    fn from_arrow(arrow_data: &dyn arrow::array::Array) -> DeserializationResult<Vec<Self>> {
        ...
        use arrow::{array::*, buffer::*, datatypes::*};
        err_on_nulls(arrow_data, "rerun.blueprint.components.MapProvider")?;
        Ok(arrow_data
