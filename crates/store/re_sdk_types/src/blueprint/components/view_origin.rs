...
#[repr(transparent)]
pub struct ViewOrigin(pub crate::encodings::EntityPath);
...
impl<T: Into<crate::encodings::EntityPath>> From<T> for ViewOrigin {
    fn from(v: T) -> Self {
        Self(v.into())
    }
}

impl std::borrow::Borrow<crate::encodings::EntityPath> for ViewOrigin {
    #[inline]
