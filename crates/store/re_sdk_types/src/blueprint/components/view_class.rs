...
#[repr(transparent)]
pub struct ViewClass(pub crate::encodings::Utf8);
...
impl<T: Into<crate::encodings::Utf8>> From<T> for ViewClass {
    fn from(v: T) -> Self {
        Self(v.into())
    }
}

impl std::borrow::Borrow<crate::encodings::Utf8> for ViewClass {
    #[inline]
