...
impl ::re_types_core::Component for ColumnOrder {
    ...
    fn name() -> ComponentType {
        "rerun.blueprint.components.ColumnOrder".into()
    }
}

::re_types_core::macros::impl_into_cow!(ColumnOrder);

impl ::re_types_core::ArrowDatatype for ColumnOrder {
    #[inline]
...
impl ::re_types_core::ToArrow for ColumnOrder {
    fn to_arrow<'a>(
...
impl ::re_types_core::FromArrow for ColumnOrder {
    fn from_arrow(arrow_data: &dyn arrow::array::Array) -> DeserializationResult<Vec<Self>> {
        ...
        use arrow::{array::*, buffer::*, datatypes::*};
        err_on_nulls(arrow_data, "rerun.blueprint.components.ColumnOrder")?;
        Ok({
            let arrow_data = arrow_data
                .try_cast::<arrow::array::ListArray>(|| Self::arrow_datatype())
                .with_context("rerun.blueprint.components.ColumnOrder#entity_paths")?;
        ...
        .with_context("rerun.blueprint.components.ColumnOrder#entity_paths")
        .with_context("rerun.blueprint.components.ColumnOrder")?)
    }
}
