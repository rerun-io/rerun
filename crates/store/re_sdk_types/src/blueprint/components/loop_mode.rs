...
impl ::re_types_core::ArrowDatatype for LoopMode {
    #[inline]
...
impl ::re_types_core::ToArrow for LoopMode {
    fn to_arrow<'a>(
...
impl ::re_types_core::FromArrow for LoopMode {
    fn from_arrow(arrow_data: &dyn arrow::array::Array) -> DeserializationResult<Vec<Self>> {
        ...
        use arrow::{array::*, buffer::*, datatypes::*};
        err_on_nulls(arrow_data, "rerun.blueprint.components.LoopMode")?;
        Ok(arrow_data
