...
#[repr(transparent)]
pub struct ApplyLatestAt(pub crate::encodings::Bool);

impl ::re_types_core::WrapperComponent for ApplyLatestAt {
...
impl<T: Into<crate::encodings::Bool>> From<T> for ApplyLatestAt {
    fn from(v: T) -> Self {
        Self(v.into())
    }
}

impl std::borrow::Borrow<crate::encodings::Bool> for ApplyLatestAt {
    #[inline]
