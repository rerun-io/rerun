...
#[repr(transparent)]
pub struct ViewerRecommendationHash(pub crate::encodings::UInt64);
...
impl<T: Into<crate::encodings::UInt64>> From<T> for ViewerRecommendationHash {
    fn from(v: T) -> Self {
        Self(v.into())
    }
}

impl std::borrow::Borrow<crate::encodings::UInt64> for ViewerRecommendationHash {
    #[inline]
