...
// Based on "crates/build/re_type_definitions/rerun/blueprint/components/force_strength.def.rs".
...
#[repr(transparent)]
pub struct ForceStrength(pub crate::encodings::Float64);

impl ::re_types_core::WrapperComponent for ForceStrength {
...
impl<T: Into<crate::encodings::Float64>> From<T> for ForceStrength {
    fn from(v: T) -> Self {
        Self(v.into())
    }
}

impl std::borrow::Borrow<crate::encodings::Float64> for ForceStrength {
    #[inline]
