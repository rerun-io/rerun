...
mod graph_view;
mod map_view;
mod signal_heatmap_view;
mod spatial2d_view;
mod spatial3d_view;
mod state_timeline_view;
mod tensor_view;
mod text_document_view;
mod text_log_view;
mod time_series_view;

pub use self::audio_view::AudioView;
...
pub use self::signal_heatmap_view::SignalHeatmapView;
pub use self::spatial2d_view::Spatial2DView;
pub use self::spatial3d_view::Spatial3DView;
pub use self::state_timeline_view::StateTimelineView;
