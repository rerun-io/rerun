...
impl ::re_types_core::ArrowDatatype for TextLogColumnKind {
    #[inline]
...
impl ::re_types_core::ToArrowOpt for TextLogColumnKind {
    fn to_arrow_opt<'a>(
...
::re_types_core::macros::impl_to_arrow_via_to_arrow_opt!(TextLogColumnKind);

impl ::re_types_core::FromArrowOpt for TextLogColumnKind {
    fn from_arrow_opt(
        ...
        Ok(arrow_data
            ...
            .with_context("rerun.blueprint.encodings.TextLogColumnKind#enum")?
            .into_iter()
            .map(|typ| match typ {
            ...
            .with_context("rerun.blueprint.encodings.TextLogColumnKind")?)
    }
}

::re_types_core::macros::impl_from_arrow_via_from_arrow_opt!(TextLogColumnKind);
