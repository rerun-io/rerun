...
fn generate_archetype_reflection() -> ArchetypeReflectionMap {
    ...
    let array = [
        ...
        (
            ArchetypeName::new("rerun.archetypes.Cones3D"),
            ArchetypeReflection {
                display_name: "Cones 3D",
                deprecation_summary: None,
                scope: None,
                view_types: &["Spatial3DView", "Spatial2DView"],
                fields: vec![
                    ArchetypeFieldReflection {
                        ...
                        display_name: "Lengths",
                        component_type: "rerun.components.Length".into(),
                        docstring_md: "The total axial length of the cone, measured from the center of the base to the tip.",
                        flags: ArchetypeFieldFlags::REQUIRED | ArchetypeFieldFlags::UI_EDITABLE,
                    },
                    ArchetypeFieldReflection {
                        name: "radii",
                        display_name: "Radii",
                        component_type: "rerun.components.Radius".into(),
                        docstring_md: "Base radii of the cones.",
                        flags: ArchetypeFieldFlags::REQUIRED | ArchetypeFieldFlags::UI_EDITABLE,
                    },
                    ArchetypeFieldReflection {
                        name: "centers",
                    ...
                    ArchetypeFieldReflection {
                        ...
                        display_name: "Colors",
                        component_type: "rerun.components.Color".into(),
                        docstring_md: "Optional colors for the cones.\n\nAlpha channel is used for transparency for solid fill-mode.",
                        flags: ArchetypeFieldFlags::UI_EDITABLE,
                    },
                    ArchetypeFieldReflection {
                        name: "line_radii",
                        display_name: "Line radii",
                        component_type: "rerun.components.Radius".into(),
                        docstring_md: "Optional radii for the lines used when the cone is rendered as a wireframe.",
                        flags: ArchetypeFieldFlags::UI_EDITABLE,
                    },
                    ArchetypeFieldReflection {
                        name: "fill_mode",
                        display_name: "Fill mode",
                        component_type: "rerun.components.FillMode".into(),
                        docstring_md: "Optionally choose whether the cones are drawn with lines or solid.",
                        flags: ArchetypeFieldFlags::UI_EDITABLE,
                    },
                    ArchetypeFieldReflection {
                        name: "albedo_factor",
                    ...
                    ArchetypeFieldReflection {
                        ...
                        docstring_md: "Optional albedo texture format for solid cones.",
                        flags: ArchetypeFieldFlags::UI_EDITABLE,
                    },
                    ArchetypeFieldReflection {
                        name: "labels",
                        display_name: "Labels",
                        component_type: "rerun.components.Text".into(),
                        docstring_md: "Optional text labels for the cones, which will be located at their centers.",
                        flags: ArchetypeFieldFlags::UI_EDITABLE,
                    },
                    ArchetypeFieldReflection {
                        name: "show_labels",
                    ...
                    ArchetypeFieldReflection {
                        ...
                        display_name: "Class ids",
                        component_type: "rerun.components.ClassId".into(),
                        docstring_md: "Optional class ID for the cones.\n\nThe class ID provides colors and labels if not specified explicitly.",
                        flags: ArchetypeFieldFlags::UI_EDITABLE,
                    },
                ],
            },
        ...
        (
            ArchetypeName::new("rerun.archetypes.Planes3D"),
            ArchetypeReflection {
                display_name: "Planes 3D",
                deprecation_summary: None,
                scope: None,
                view_types: &["Spatial3DView", "Spatial2DView"],
                fields: vec![
                    ArchetypeFieldReflection {
                        ...
                        docstring_md: "Infinite 3D planes, represented by normal and distance.",
                        flags: ArchetypeFieldFlags::REQUIRED | ArchetypeFieldFlags::UI_EDITABLE,
                    },
                    ArchetypeFieldReflection {
                        name: "half_sizes",
                        display_name: "Half sizes",
                        component_type: "rerun.components.HalfSize2D".into(),
                        docstring_md: "Optional half-extents for the finite viewer patches used to draw the planes.\n\nIf not specified, half-size (1, 1) is used.",
                        flags: ArchetypeFieldFlags::UI_EDITABLE,
                    },
                    ArchetypeFieldReflection {
                        name: "colors",
                        display_name: "Colors",
                        component_type: "rerun.components.Color".into(),
                        docstring_md: "Optional colors for the planes.\n\nAlpha channel is used for transparency for solid fill-mode.",
                        flags: ArchetypeFieldFlags::UI_EDITABLE,
                    },
                    ArchetypeFieldReflection {
                        name: "line_radii",
                        display_name: "Line radii",
                        component_type: "rerun.components.Radius".into(),
                        docstring_md: "Optional radii for the lines used when the plane patch is rendered as a wireframe.",
                        flags: ArchetypeFieldFlags::UI_EDITABLE,
                    },
                    ArchetypeFieldReflection {
                        name: "fill_mode",
                        display_name: "Fill mode",
                        component_type: "rerun.components.FillMode".into(),
                        docstring_md: "Optionally choose whether the plane patches are drawn with lines or solid.",
                        flags: ArchetypeFieldFlags::UI_EDITABLE,
                    },
                    ArchetypeFieldReflection {
                        name: "albedo_factor",
                        display_name: "Albedo factor",
                        component_type: "rerun.components.AlbedoFactor".into(),
                        docstring_md: "A color multiplier applied to all solid plane patches.\n\nAlpha channel governs the overall solid plane transparency.",
                        flags: ArchetypeFieldFlags::UI_EDITABLE,
                    },
                    ArchetypeFieldReflection {
                        name: "albedo_texture_buffer",
                    ...
                    ArchetypeFieldReflection {
                        ...
                        display_name: "Labels",
                        component_type: "rerun.components.Text".into(),
                        docstring_md: "Optional text labels for the planes, which will be located at their patch centers.",
                        flags: ArchetypeFieldFlags::UI_EDITABLE,
                    },
                    ArchetypeFieldReflection {
                        name: "show_labels",
                    ...
                    ArchetypeFieldReflection {
                        ...
                        display_name: "Class ids",
                        component_type: "rerun.components.ClassId".into(),
                        docstring_md: "Optional class ID for the planes.\n\nThe class ID provides colors and labels if not specified explicitly.",
                        flags: ArchetypeFieldFlags::UI_EDITABLE,
                    },
                ],
            },
        ...
        (
            ArchetypeName::new("rerun.archetypes.Rays3D"),
            ArchetypeReflection {
                display_name: "Rays 3D",
                deprecation_summary: None,
                scope: None,
                view_types: &["Spatial3DView", "Spatial2DView"],
                fields: vec![
                    ArchetypeFieldReflection {
                        ...
                        display_name: "Vectors",
                        component_type: "rerun.components.Vector3D".into(),
                        docstring_md: "All the vectors for each ray in the batch.",
                        flags: ArchetypeFieldFlags::REQUIRED | ArchetypeFieldFlags::UI_EDITABLE,
                    },
                    ArchetypeFieldReflection {
                        name: "origins",
                        display_name: "Origins",
                        component_type: "rerun.components.Position3D".into(),
                        docstring_md: "All the origin positions for each ray in the batch.\n\nIf no origins are set, (0, 0, 0) is used as the origin for each ray.",
                        flags: ArchetypeFieldFlags::UI_EDITABLE,
                    },
                    ArchetypeFieldReflection {
                        name: "radii",
                        display_name: "Radii",
                        component_type: "rerun.components.Radius".into(),
                        docstring_md: "Optional radii for the rays.",
                        flags: ArchetypeFieldFlags::UI_EDITABLE,
                    },
                    ArchetypeFieldReflection {
                        name: "colors",
                        display_name: "Colors",
                        component_type: "rerun.components.Color".into(),
                        docstring_md: "Optional colors for the rays.",
                        flags: ArchetypeFieldFlags::UI_EDITABLE,
                    },
                    ArchetypeFieldReflection {
                        name: "labels",
                        display_name: "Labels",
                        component_type: "rerun.components.Text".into(),
                        docstring_md: "Optional text labels for the rays.\n\nIf there's a single label present, it will be placed at the center of the entity.\nOtherwise, each instance will have its own label.",
                        flags: ArchetypeFieldFlags::UI_EDITABLE,
                    },
                    ArchetypeFieldReflection {
                        name: "show_labels",
                    ...
                    ArchetypeFieldReflection {
                        ...
                        display_name: "Class ids",
                        component_type: "rerun.components.ClassId".into(),
                        docstring_md: "Optional class IDs for the rays.\n\nThe [`components.ClassId`](https://rerun.io/docs/reference/types/components/class_id) provides colors and labels if not specified explicitly.",
                        flags: ArchetypeFieldFlags::UI_EDITABLE,
                    },
                ],
            },
        ...
        (
            ArchetypeName::new("rerun.archetypes.Triangles3D"),
            ArchetypeReflection {
                display_name: "Triangles 3D",
                deprecation_summary: None,
                scope: None,
                view_types: &["Spatial3DView", "Spatial2DView"],
                fields: vec![
                    ArchetypeFieldReflection {
                        ...
                        display_name: "Vertex positions",
                        component_type: "rerun.components.Position3D".into(),
                        docstring_md: "Triangle vertex positions. Every consecutive triplet forms one triangle.",
                        flags: ArchetypeFieldFlags::REQUIRED,
                    },
                    ArchetypeFieldReflection {
                        name: "colors",
                        display_name: "Colors",
                        component_type: "rerun.components.Color".into(),
                        docstring_md: "Optional colors for the triangles.\n\nAlpha channel is used for transparency for solid fill-mode.",
                        flags: ArchetypeFieldFlags::UI_EDITABLE,
                    },
                    ArchetypeFieldReflection {
                        name: "vertex_texcoords",
                        display_name: "Vertex texcoords",
                        component_type: "rerun.components.Texcoord2D".into(),
                        docstring_md: "Optional UV texture coordinates for each triangle vertex.\n\nUsed with `albedo_texture_buffer`.",
                        flags: ArchetypeFieldFlags::UI_EDITABLE,
                    },
                    ArchetypeFieldReflection {
                        name: "line_radii",
                        display_name: "Line radii",
                        component_type: "rerun.components.Radius".into(),
                        docstring_md: "Optional radii for the lines used when triangles are rendered as wireframes.",
                        flags: ArchetypeFieldFlags::UI_EDITABLE,
                    },
                    ArchetypeFieldReflection {
                        name: "fill_mode",
                        display_name: "Fill mode",
                        component_type: "rerun.components.FillMode".into(),
                        docstring_md: "Optionally choose whether the triangles are drawn with lines or solid.",
                        flags: ArchetypeFieldFlags::UI_EDITABLE,
                    },
                    ArchetypeFieldReflection {
                        name: "albedo_factor",
                        display_name: "Albedo factor",
                        component_type: "rerun.components.AlbedoFactor".into(),
                        docstring_md: "A color multiplier applied to all solid triangles.\n\nAlpha channel governs the overall solid triangle transparency.",
                        flags: ArchetypeFieldFlags::UI_EDITABLE,
                    },
                    ArchetypeFieldReflection {
                        name: "albedo_texture_buffer",
                    ...
                    ArchetypeFieldReflection {
                        ...
                        display_name: "Labels",
                        component_type: "rerun.components.Text".into(),
                        docstring_md: "Optional text labels for the triangles, which will be located at triangle centroids.",
                        flags: ArchetypeFieldFlags::UI_EDITABLE,
                    },
                    ArchetypeFieldReflection {
                        name: "show_labels",
                    ...
                    ArchetypeFieldReflection {
                        ...
                        display_name: "Class ids",
                        component_type: "rerun.components.ClassId".into(),
                        docstring_md: "Optional class IDs for the triangles.\n\nThe [`components.ClassId`](https://rerun.io/docs/reference/types/components/class_id) provides colors and labels if not specified explicitly.",
                        flags: ArchetypeFieldFlags::UI_EDITABLE,
                    },
                ],
            },
