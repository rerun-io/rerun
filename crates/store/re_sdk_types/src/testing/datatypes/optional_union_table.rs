...
pub struct OptionalUnionTable {
    pub single_optional_union: Option<crate::testing::datatypes::NestedUnion>,
}

::re_types_core::macros::impl_into_cow!(OptionalUnionTable);

impl ::re_types_core::Loggable for OptionalUnionTable {
    #[inline]
            ...
            as_array_ref(StructArray::new(
                ...
                vec![{
                    ...
                    };
                    {
                        ...
                        crate::testing::datatypes::NestedUnion::to_arrow_opt(single_optional_union)?
                    }
                }],
                validity,
            ))
        ...
        Self: Sized,
    {
        ...
        Ok({
            let arrow_data = arrow_data
                ...
                .with_context("rerun.testing.datatypes.OptionalUnionTable")?;
            if arrow_data.is_empty() {
                ...
                let single_optional_union = {
                    ...
                    crate::testing::datatypes::NestedUnion::from_arrow_opt(arrow_data)
                        .with_context(
                            "rerun.testing.datatypes.OptionalUnionTable#single_optional_union",
                        )?
                        .into_iter()
                };
...
impl<T: Into<Option<crate::testing::datatypes::NestedUnion>>> From<T> for OptionalUnionTable {
    fn from(v: T) -> Self {
        Self {
...
impl std::borrow::Borrow<Option<crate::testing::datatypes::NestedUnion>> for OptionalUnionTable {
    #[inline]
    fn borrow(&self) -> &Option<crate::testing::datatypes::NestedUnion> {
        &self.single_optional_union
    }
}

impl std::ops::Deref for OptionalUnionTable {
    type Target = Option<crate::testing::datatypes::NestedUnion>;

    #[inline]
    fn deref(&self) -> &Option<crate::testing::datatypes::NestedUnion> {
        &self.single_optional_union
    }
}
...
impl std::ops::DerefMut for OptionalUnionTable {
    #[inline]
    fn deref_mut(&mut self) -> &mut Option<crate::testing::datatypes::NestedUnion> {
