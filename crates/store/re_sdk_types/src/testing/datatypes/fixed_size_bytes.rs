...
impl ::re_types_core::Loggable for FixedSizeBytes {
    #[inline]
        ...
        Self: Sized,
    {
        ...
        Ok({
            let arrow_data = arrow_data
                ...
                .with_context("rerun.testing.datatypes.FixedSizeBytes")?;
                ...
                let fixed_sized_native = {
                    ...
                    let arrow_data = &**arrays_by_name["fixed_sized_native"];
                    {
                        let arrow_data = arrow_data
                            ...
                            .with_context(
                                "rerun.testing.datatypes.FixedSizeBytes#fixed_sized_native",
                            )?;
                        if arrow_data.is_empty() {
                            Vec::new()
                        } else {
