        ...
        Self: Sized,
    {
        ...
        Ok({
            let arrow_data = arrow_data
                ...
                .with_context("rerun.testing.datatypes.Float16Fields")?;
            if arrow_data.is_empty() {
                ...
                let single_half = {
                    ...
                    arrow_data
                        ...
                        .with_context("rerun.testing.datatypes.Float16Fields#single_half")?
                        .into_iter()
                };
                let many_halves = {
                    ...
                    let arrow_data = &**arrays_by_name["many_halves"];
                    {
                        let arrow_data = arrow_data
                            ...
                            .with_context("rerun.testing.datatypes.Float16Fields#many_halves")?;
                        if arrow_data.is_empty() {
                            Vec::new()
                        } else {
                            let arrow_data_inner = {
                                ...
                                arrow_data_inner
                                    ...
                                    .with_context(
                                        "rerun.testing.datatypes.Float16Fields#many_halves",
                                    )?
                                    .values()
                            };
                    ...
                    opt.map(|(single_half, many_halves)| {
                        Ok(Self {
                            single_half: single_half
                                ...
                                .with_context(
                                    "rerun.testing.datatypes.Float16Fields#single_half",
                                )?,
