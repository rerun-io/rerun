...
pub enum ScalarUnion {
    Degrees(f32),
    Craziness(Vec<crate::testing::datatypes::MixedFields>),
        ...
        Self: Sized,
    {
        ...
        Ok({
            let arrow_data = arrow_data
                ...
                .with_context("rerun.testing.datatypes.ScalarUnion")?;
            if arrow_data.is_empty() {
                ...
                let degrees = {
                    ...
                    arrow_data
                        ...
                        .with_context("rerun.testing.datatypes.ScalarUnion#degrees")?
                        .into_iter()
                        .collect::<Vec<_>>()
                };
                let craziness = {
                    let arrow_data = arrow_data.child(2).as_ref();
                    {
                        let arrow_data = arrow_data
                            ...
                            .with_context("rerun.testing.datatypes.ScalarUnion#craziness")?;
                        if arrow_data.is_empty() {
                            Vec::new()
                        } else {
                            let arrow_data_inner = {
                                let arrow_data_inner = &**arrow_data.values();
                                crate::testing::datatypes::MixedFields::from_arrow_opt(
                                    arrow_data_inner,
                                )
                                .with_context("rerun.testing.datatypes.ScalarUnion#craziness")?
                                .into_iter()
                ...
                let fixed_size_shenanigans = {
                    let arrow_data = arrow_data.child(3).as_ref();
                    {
                        let arrow_data = arrow_data
                            ...
                            .with_context(
                                "rerun.testing.datatypes.ScalarUnion#fixed_size_shenanigans",
                            )?;
                        if arrow_data.is_empty() {
                            Vec::new()
                        } else {
                                            ...
                                            Self::Degrees({
                                                if offset as usize >= degrees.len() {
                                                    return Err(
                                                        ...
                                                        .with_context(
                                                            "rerun.testing.datatypes.ScalarUnion#degrees",
                                                        );
                                                }
                                            ...
                                            Self::Craziness({
                                                if offset as usize >= craziness.len() {
                                                    return Err(
                                                        ...
                                                        .with_context(
                                                            "rerun.testing.datatypes.ScalarUnion#craziness",
                                                        );
                                                }
