...
impl ::re_types_core::Loggable for PrimitiveAndString {
    #[inline]
        ...
        Self: Sized,
    {
        ...
        Ok({
            let arrow_data = arrow_data
                ...
                .with_context("rerun.testing.datatypes.PrimitiveAndString")?;
            if arrow_data.is_empty() {
                ...
                let p = {
                    ...
                    arrow_data
                        ...
                        .with_context("rerun.testing.datatypes.PrimitiveAndString#p")?
                        .into_iter()
                        .map(|res_or_opt| {
                ...
                let s = {
                    ...
                    let arrow_data = &**arrays_by_name["s"];
                    {
                        let arrow_data = arrow_data
                            ...
                            .with_context("rerun.testing.datatypes.PrimitiveAndString#s")?;
