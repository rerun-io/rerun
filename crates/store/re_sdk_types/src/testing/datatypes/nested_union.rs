...
pub enum NestedUnion {
    SingleRequired(crate::testing::datatypes::ScalarUnion),
    ManyRequired(Vec<crate::testing::datatypes::ScalarUnion>),
}
        ...
        DataType::Union(
            UnionFields::try_new(
                ...
                vec![
                    ...
                    Field::new(
                        "single_required",
                        <crate::testing::datatypes::ScalarUnion>::arrow_datatype(),
                        true,
                    ),
                    Field::new(
                        "many_required",
            ...
            let children = vec![
                as_array_ref(NullArray::new(data.iter().filter(|v| v.is_none()).count())),
                {
                    ...
                    let single_required_validity: Option<arrow::buffer::NullBuffer> = None;
                    {
                        ...
                        crate::testing::datatypes::ScalarUnion::to_arrow_opt(
        ...
        Self: Sized,
    {
        ...
        Ok({
            let arrow_data = arrow_data
                ...
                .with_context("rerun.testing.datatypes.NestedUnion")?;
            if arrow_data.is_empty() {
                ...
                let single_required = {
                    ...
                    crate::testing::datatypes::ScalarUnion::from_arrow_opt(arrow_data)
                        .with_context("rerun.testing.datatypes.NestedUnion#single_required")?
                        .into_iter()
                        .collect::<Vec<_>>()
                };
                let many_required = {
                    let arrow_data = arrow_data.child(2).as_ref();
                    {
                        let arrow_data = arrow_data
                            ...
                            .with_context("rerun.testing.datatypes.NestedUnion#many_required")?;
                        if arrow_data.is_empty() {
                            Vec::new()
                        } else {
                            ...
                            Ok(Some(match typ {
                                1i8 => Self::SingleRequired({
                                    if offset as usize >= single_required.len() {
                                        ...
                                        .with_context(
                                            "rerun.testing.datatypes.NestedUnion#single_required",
                                        );
                                    }
                                ...
                                2i8 => Self::ManyRequired({
                                    if offset as usize >= many_required.len() {
                                        ...
                                        .with_context(
                                            "rerun.testing.datatypes.NestedUnion#many_required",
                                        );
                                    }
