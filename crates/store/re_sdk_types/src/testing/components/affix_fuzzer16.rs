...
pub struct AffixFuzzer16(pub Vec<crate::testing::datatypes::ScalarUnion>);
        ...
        Ok({
            ...
            if arrow_data.is_empty() {
                ...
                let arrow_data_inner = {
                    ...
                    crate::testing::datatypes::ScalarUnion::from_arrow_opt(arrow_data_inner)
                        .with_context(
...
impl<I: Into<crate::testing::datatypes::ScalarUnion>, T: IntoIterator<Item = I>> From<T>
    for AffixFuzzer16
{
    fn from(v: T) -> Self {
