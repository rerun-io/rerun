...
pub struct AffixFuzzer17(pub Option<Vec<crate::testing::datatypes::ScalarUnion>>);
...
impl<I: Into<crate::testing::datatypes::ScalarUnion>, T: IntoIterator<Item = I>> From<Option<T>>
    for AffixFuzzer17
{
