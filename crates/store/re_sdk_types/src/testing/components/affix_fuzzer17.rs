...
pub struct AffixFuzzer17(pub Option<Vec<crate::testing::encodings::ScalarUnion>>);
...
impl ::re_types_core::ArrowDatatype for AffixFuzzer17 {
    #[inline]
...
impl ::re_types_core::ToArrow for AffixFuzzer17 {
    fn to_arrow<'a>(
...
impl ::re_types_core::FromArrow for AffixFuzzer17 {
...
impl<I: Into<crate::testing::encodings::ScalarUnion>, T: IntoIterator<Item = I>> From<Option<T>>
    for AffixFuzzer17
{
