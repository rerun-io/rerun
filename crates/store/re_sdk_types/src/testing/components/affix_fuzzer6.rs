...
pub struct AffixFuzzer6(pub Option<crate::testing::datatypes::MixedFields>);
...
impl<T: Into<Option<crate::testing::datatypes::MixedFields>>> From<T> for AffixFuzzer6 {
    fn from(v: T) -> Self {
        Self(v.into())
    }
}

impl std::borrow::Borrow<Option<crate::testing::datatypes::MixedFields>> for AffixFuzzer6 {
    #[inline]
