...
pub struct AffixFuzzer6(pub Option<crate::testing::encodings::MixedFields>);
...
impl ::re_types_core::ArrowDatatype for AffixFuzzer6 {
    #[inline]
...
impl ::re_types_core::ToArrow for AffixFuzzer6 {
    fn to_arrow<'a>(
...
impl ::re_types_core::FromArrow for AffixFuzzer6 {
...
impl<T: Into<Option<crate::testing::encodings::MixedFields>>> From<T> for AffixFuzzer6 {
    fn from(v: T) -> Self {
        Self(v.into())
    }
}

impl std::borrow::Borrow<Option<crate::testing::encodings::MixedFields>> for AffixFuzzer6 {
    #[inline]
