...
pub struct AffixFuzzer7(pub Option<Vec<crate::testing::datatypes::MixedFields>>);
            ...
            };
            {
                ...
                as_array_ref(ListArray::try_new(
                    ...
                    offsets,
                    {
                        ...
                        crate::testing::datatypes::MixedFields::to_arrow_opt(
        ...
        Ok({
            ...
            if arrow_data.is_empty() {
                ...
                let arrow_data_inner = {
                    ...
                    crate::testing::datatypes::MixedFields::from_arrow_opt(arrow_data_inner)
                        .with_context("rerun.testing.components.AffixFuzzer7#many_optional")?
                        .into_iter()
                        .collect::<Vec<_>>()
                };
...
impl<I: Into<crate::testing::datatypes::MixedFields>, T: IntoIterator<Item = I>> From<Option<T>>
    for AffixFuzzer7
{
