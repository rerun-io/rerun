...
pub struct AffixFuzzer3(pub crate::testing::datatypes::MixedFields);

impl ::re_types_core::WrapperComponent for AffixFuzzer3 {
...
impl<T: Into<crate::testing::datatypes::MixedFields>> From<T> for AffixFuzzer3 {
    fn from(v: T) -> Self {
        Self(v.into())
    }
}

impl std::borrow::Borrow<crate::testing::datatypes::MixedFields> for AffixFuzzer3 {
    #[inline]
