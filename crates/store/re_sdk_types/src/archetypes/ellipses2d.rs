...
pub struct Ellipses2D {
    ...
    /// Optional [`components::ClassId`][crate::components::ClassId]s for the ellipses.
    ///
...
impl Ellipses2D {
    ...
    pub fn descriptor_half_sizes() -> ComponentDescriptor {
        ComponentDescriptor {
            archetype: Some("rerun.archetypes.Ellipses2D".into()),
            component: "Ellipses2D:half_sizes".into(),
    ...
    pub fn descriptor_centers() -> ComponentDescriptor {
        ComponentDescriptor {
            archetype: Some("rerun.archetypes.Ellipses2D".into()),
            component: "Ellipses2D:centers".into(),
    ...
    pub fn descriptor_colors() -> ComponentDescriptor {
        ComponentDescriptor {
            archetype: Some("rerun.archetypes.Ellipses2D".into()),
            component: "Ellipses2D:colors".into(),
    ...
    pub fn descriptor_line_radii() -> ComponentDescriptor {
        ComponentDescriptor {
            archetype: Some("rerun.archetypes.Ellipses2D".into()),
            component: "Ellipses2D:line_radii".into(),
    ...
    pub fn descriptor_labels() -> ComponentDescriptor {
        ComponentDescriptor {
            archetype: Some("rerun.archetypes.Ellipses2D".into()),
            component: "Ellipses2D:labels".into(),
    ...
    pub fn descriptor_show_labels() -> ComponentDescriptor {
        ComponentDescriptor {
            archetype: Some("rerun.archetypes.Ellipses2D".into()),
            component: "Ellipses2D:show_labels".into(),
    ...
    pub fn descriptor_draw_order() -> ComponentDescriptor {
        ComponentDescriptor {
            archetype: Some("rerun.archetypes.Ellipses2D".into()),
            component: "Ellipses2D:draw_order".into(),
    ...
    pub fn descriptor_class_ids() -> ComponentDescriptor {
        ComponentDescriptor {
            archetype: Some("rerun.archetypes.Ellipses2D".into()),
            component: "Ellipses2D:class_ids".into(),
...
static REQUIRED_COMPONENTS: std::sync::LazyLock<[ComponentDescriptor; 1usize]> =
    std::sync::LazyLock::new(|| [Ellipses2D::descriptor_half_sizes()]);

static RECOMMENDED_COMPONENTS: std::sync::LazyLock<[ComponentDescriptor; 2usize]> =
    std::sync::LazyLock::new(|| {
        [
            Ellipses2D::descriptor_centers(),
            Ellipses2D::descriptor_colors(),
        ]
    });
...
static OPTIONAL_COMPONENTS: std::sync::LazyLock<[ComponentDescriptor; 5usize]> =
    std::sync::LazyLock::new(|| {
        [
            Ellipses2D::descriptor_line_radii(),
            Ellipses2D::descriptor_labels(),
            Ellipses2D::descriptor_show_labels(),
            Ellipses2D::descriptor_draw_order(),
            Ellipses2D::descriptor_class_ids(),
        ]
    });
...
impl ::re_types_core::Archetype for Ellipses2D {
    #[inline]
    fn name() -> ::re_types_core::ArchetypeName {
        "rerun.archetypes.Ellipses2D".into()
    }
...
impl ::re_types_core::AsComponents for Ellipses2D {
    #[inline]
...
impl ::re_types_core::ArchetypeReflectionMarker for Ellipses2D {}

impl crate::VisualizableArchetype for Ellipses2D {
    #[inline]
    fn visualizer(&self) -> crate::Visualizer {
        crate::Visualizer::new("Ellipses2D").with_overrides(self)
    }
}

impl Ellipses2D {
    /// Create a new `Ellipses2D`.
    #[inline]
    pub(crate) fn new(
...
impl ::re_byte_size::SizeBytes for Ellipses2D {
    #[inline]
