...
impl ::re_types_core::ArrowDatatype for ClassId {
    #[inline]
...
impl ::re_types_core::ToArrow for ClassId {
    fn to_arrow<'a>(
...
impl ::re_types_core::FromArrow for ClassId {
    #[inline]
    fn from_arrow(arrow_data: &dyn arrow::array::Array) -> DeserializationResult<Vec<Self>> {
        ...
        use arrow::{array::*, buffer::*, datatypes::*};
        err_on_nulls(arrow_data, "rerun.encodings.ClassId")?;
        Ok({
            let slice = arrow_data
                .try_cast::<UInt16Array>(|| DataType::UInt16)
                .with_context("rerun.encodings.ClassId#id")?
                .values()
                .as_ref();
