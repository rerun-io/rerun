...
impl ::re_types_core::ArrowDatatype for UVec3D {
    #[inline]
...
impl ::re_types_core::ToArrow for UVec3D {
    fn to_arrow<'a>(
...
impl ::re_types_core::FromArrow for UVec3D {
    #[inline]
    fn from_arrow(arrow_data: &dyn arrow::array::Array) -> DeserializationResult<Vec<Self>> {
        ...
        use arrow::{array::*, buffer::*, datatypes::*};
        err_on_nulls(arrow_data, "rerun.encodings.UVec3D")?;
        Ok({
            let slice = {
                let arrow_data = arrow_data
                    ...
                    .with_context("rerun.encodings.UVec3D#xyz")?;
                ...
                bytemuck::try_cast_slice::<_, [u32; 3usize]>(
                    arrow_data_inner
