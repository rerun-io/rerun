...
// Based on "crates/build/re_type_definitions/rerun/encodings/vec3d.def.rs".
...
impl ::re_types_core::ArrowDatatype for Vec3D {
    #[inline]
...
impl ::re_types_core::ToArrow for Vec3D {
    fn to_arrow<'a>(
...
impl ::re_types_core::FromArrow for Vec3D {
    #[inline]
    fn from_arrow(arrow_data: &dyn arrow::array::Array) -> DeserializationResult<Vec<Self>> {
        ...
        use arrow::{array::*, buffer::*, datatypes::*};
        err_on_nulls(arrow_data, "rerun.encodings.Vec3D")?;
        Ok({
            let slice = {
                let arrow_data = arrow_data
                    ...
                    .with_context("rerun.encodings.Vec3D#xyz")?;
