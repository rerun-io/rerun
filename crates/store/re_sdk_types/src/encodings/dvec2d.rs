...
// Based on "crates/build/re_type_definitions/rerun/encodings/dvec2d.def.rs".
...
impl ::re_types_core::ToArrow for DVec2D {
    fn to_arrow<'a>(
...
impl ::re_types_core::FromArrow for DVec2D {
    #[inline]
    fn from_arrow(arrow_data: &dyn arrow::array::Array) -> DeserializationResult<Vec<Self>> {
        ...
        use arrow::{array::*, buffer::*, datatypes::*};
        err_on_nulls(arrow_data, "rerun.encodings.DVec2D")?;
        Ok({
            let slice = {
                let arrow_data = arrow_data
                    ...
                    .with_context("rerun.encodings.DVec2D#xy")?;
