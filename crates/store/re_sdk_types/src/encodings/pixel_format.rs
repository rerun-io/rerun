...
// Based on "crates/build/re_type_definitions/rerun/encodings/pixel_format.def.rs".
...
///
/// Most images can be described by a [`encodings::ColorModel`][crate::encodings::ColorModel] and a [`encodings::ChannelDatatype`][crate::encodings::ChannelDatatype],
/// e.g. `RGB` and `U8` respectively.
///
/// However, some image formats has chroma downsampling and/or
/// use differing number of bits per channel, and that is what this [`encodings::PixelFormat`][crate::encodings::PixelFormat] is for.
///
...
pub enum PixelFormat {
    ...
    ///
    /// Also known as just "gray". This is virtually identical to a 8bit luminance/grayscale (see [`encodings::ColorModel`][crate::encodings::ColorModel]).
    ///
    ...
    /// If not for this range limitation/remapping, this is almost identical to 8bit luminace/grayscale (see [`encodings::ColorModel`][crate::encodings::ColorModel]).
    #[allow(clippy::upper_case_acronyms)]
    Y8_LimitedRange = 41,
