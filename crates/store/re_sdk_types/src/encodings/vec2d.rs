...
impl ::re_types_core::ArrowDatatype for Vec2D {
    #[inline]
...
impl ::re_types_core::ToArrow for Vec2D {
    fn to_arrow<'a>(
...
impl ::re_types_core::FromArrow for Vec2D {
    #[inline]
    fn from_arrow(arrow_data: &dyn arrow::array::Array) -> DeserializationResult<Vec<Self>> {
        ...
        use arrow::{array::*, buffer::*, datatypes::*};
        err_on_nulls(arrow_data, "rerun.encodings.Vec2D")?;
        Ok({
            let slice = {
                let arrow_data = arrow_data
                    ...
                    .with_context("rerun.encodings.Vec2D#xy")?;
                ...
                bytemuck::try_cast_slice::<_, [f32; 2usize]>(
                    arrow_data_inner
