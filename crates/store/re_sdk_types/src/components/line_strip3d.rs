...
pub struct LineStrip3D(pub Vec<crate::encodings::Vec3D>);
...
impl ::re_types_core::ArrowDataType for LineStrip3D {
    #[inline]
    fn arrow_data_type() -> arrow::datatypes::DataType {
        use arrow::datatypes::*;
        DataType::List(std::sync::Arc::new(Field::new(
            "item",
            <crate::encodings::Vec3D>::arrow_data_type(),
            false,
        )))
    }
}

impl ::re_types_core::ToArrow for LineStrip3D {
    fn to_arrow<'a>(
...
impl ::re_types_core::FromArrow for LineStrip3D {
    fn from_arrow(arrow_data: &dyn arrow::array::Array) -> DeserializationResult<Vec<Self>> {
        ...
        use arrow::{array::*, buffer::*, datatypes::*};
        err_on_nulls(arrow_data, "rerun.components.LineStrip3D")?;
        Ok({
...
impl<I: Into<crate::encodings::Vec3D>, T: IntoIterator<Item = I>> From<T> for LineStrip3D {
    fn from(v: T) -> Self {
