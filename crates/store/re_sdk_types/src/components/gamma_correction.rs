...
// Based on "crates/build/re_type_definitions/rerun/components/gamma_correction.def.rs".
...
#[repr(transparent)]
pub struct GammaCorrection(pub crate::encodings::Float32);
...
impl<T: Into<crate::encodings::Float32>> From<T> for GammaCorrection {
    fn from(v: T) -> Self {
        Self(v.into())
    }
}

impl std::borrow::Borrow<crate::encodings::Float32> for GammaCorrection {
    #[inline]
