...
// Based on "crates/build/re_type_definitions/rerun/components/graph_type.def.rs".
...
impl ::re_types_core::ArrowDatatype for GraphType {
    #[inline]
...
impl ::re_types_core::ToArrow for GraphType {
    fn to_arrow<'a>(
...
impl ::re_types_core::FromArrow for GraphType {
    fn from_arrow(arrow_data: &dyn arrow::array::Array) -> DeserializationResult<Vec<Self>> {
        ...
        use arrow::{array::*, buffer::*, datatypes::*};
        err_on_nulls(arrow_data, "rerun.components.GraphType")?;
        Ok(arrow_data
