...
#[repr(transparent)]
pub struct VoxelSize(pub crate::encodings::Vec3D);
...
impl<T: Into<crate::encodings::Vec3D>> From<T> for VoxelSize {
    fn from(v: T) -> Self {
        Self(v.into())
    }
}

impl std::borrow::Borrow<crate::encodings::Vec3D> for VoxelSize {
    #[inline]
