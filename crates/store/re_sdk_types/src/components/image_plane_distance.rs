...
// Based on "crates/build/re_type_definitions/rerun/components/image_plane_distance.def.rs".
...
pub struct ImagePlaneDistance(pub crate::encodings::Float32);
...
impl<T: Into<crate::encodings::Float32>> From<T> for ImagePlaneDistance {
    fn from(v: T) -> Self {
        Self(v.into())
    }
}

impl std::borrow::Borrow<crate::encodings::Float32> for ImagePlaneDistance {
    #[inline]
