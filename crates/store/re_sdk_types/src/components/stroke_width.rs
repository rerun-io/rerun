...
#[repr(transparent)]
pub struct StrokeWidth(pub crate::encodings::Float32);
...
impl<T: Into<crate::encodings::Float32>> From<T> for StrokeWidth {
    fn from(v: T) -> Self {
        Self(v.into())
    }
}

impl std::borrow::Borrow<crate::encodings::Float32> for StrokeWidth {
    #[inline]
