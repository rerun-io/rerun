...
#[repr(transparent)]
pub struct Scale3D(pub crate::encodings::Vec3D);
...
impl<T: Into<crate::encodings::Vec3D>> From<T> for Scale3D {
    fn from(v: T) -> Self {
        Self(v.into())
    }
}

impl std::borrow::Borrow<crate::encodings::Vec3D> for Scale3D {
    #[inline]
