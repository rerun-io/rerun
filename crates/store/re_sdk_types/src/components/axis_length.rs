...
#[repr(transparent)]
pub struct AxisLength(pub crate::encodings::Float32);
...
impl<T: Into<crate::encodings::Float32>> From<T> for AxisLength {
    fn from(v: T) -> Self {
        Self(v.into())
    }
}

impl std::borrow::Borrow<crate::encodings::Float32> for AxisLength {
    #[inline]
