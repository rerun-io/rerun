...
// Based on "crates/build/re_type_definitions/rerun/components/length.def.rs".
...
#[repr(transparent)]
pub struct Length(pub crate::encodings::Float32);
...
impl<T: Into<crate::encodings::Float32>> From<T> for Length {
    fn from(v: T) -> Self {
        Self(v.into())
    }
}

impl std::borrow::Borrow<crate::encodings::Float32> for Length {
    #[inline]
