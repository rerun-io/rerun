...
#[repr(transparent)]
pub struct TextLogLevel(pub crate::encodings::Utf8);
...
impl<T: Into<crate::encodings::Utf8>> From<T> for TextLogLevel {
    fn from(v: T) -> Self {
        Self(v.into())
    }
}

impl std::borrow::Borrow<crate::encodings::Utf8> for TextLogLevel {
    #[inline]
