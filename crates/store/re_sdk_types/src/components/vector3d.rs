...
// Based on "crates/build/re_type_definitions/rerun/components/vector3d.def.rs".
...
#[repr(transparent)]
pub struct Vector3D(pub crate::encodings::Vec3D);
...
impl<T: Into<crate::encodings::Vec3D>> From<T> for Vector3D {
    fn from(v: T) -> Self {
        Self(v.into())
    }
}

impl std::borrow::Borrow<crate::encodings::Vec3D> for Vector3D {
    #[inline]
