...
#[repr(transparent)]
pub struct Translation3D(pub crate::encodings::Vec3D);

impl ::re_types_core::WrapperComponent for Translation3D {
...
impl<T: Into<crate::encodings::Vec3D>> From<T> for Translation3D {
    fn from(v: T) -> Self {
        Self(v.into())
    }
}

impl std::borrow::Borrow<crate::encodings::Vec3D> for Translation3D {
    #[inline]
