...
// Based on "crates/build/re_type_definitions/rerun/components/radius.def.rs".
...
#[repr(transparent)]
pub struct Radius(pub crate::encodings::Float32);
...
impl<T: Into<crate::encodings::Float32>> From<T> for Radius {
    fn from(v: T) -> Self {
        Self(v.into())
    }
}

impl std::borrow::Borrow<crate::encodings::Float32> for Radius {
    #[inline]
