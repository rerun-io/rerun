...
// Based on "crates/build/re_type_definitions/rerun/components/scalar.def.rs".
...
#[repr(transparent)]
pub struct Scalar(pub crate::encodings::Float64);
...
impl<T: Into<crate::encodings::Float64>> From<T> for Scalar {
    fn from(v: T) -> Self {
        Self(v.into())
    }
}

impl std::borrow::Borrow<crate::encodings::Float64> for Scalar {
    #[inline]
