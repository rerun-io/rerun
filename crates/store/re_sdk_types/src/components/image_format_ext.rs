...
use crate::encodings::{self, ChannelDatatype, ColorModel, PixelFormat};
...
impl ImageFormat {
    ...
    pub fn depth([width, height]: [u32; 2], datatype: ChannelDatatype) -> Self {
        encodings::ImageFormat::depth([width, height], datatype).into()
    }
    ...
    pub fn segmentation([width, height]: [u32; 2], datatype: ChannelDatatype) -> Self {
        encodings::ImageFormat::segmentation([width, height], datatype).into()
    }
    ...
    pub fn from_color_model(
        ...
        encodings::ImageFormat::from_color_model([width, height], color_model, datatype).into()
    }
