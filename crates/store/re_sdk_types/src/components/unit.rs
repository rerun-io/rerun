...
#[repr(transparent)]
pub struct Unit(pub crate::encodings::Utf8);

impl ::re_types_core::WrapperComponent for Unit {
    type Encoding = crate::encodings::Utf8;

    #[inline]
    fn name() -> ComponentType {
        "rerun.components.Unit".into()
    }
...
::re_types_core::macros::impl_into_cow!(Unit);

impl<T: Into<crate::encodings::Utf8>> From<T> for Unit {
    fn from(v: T) -> Self {
        Self(v.into())
    }
}

impl std::borrow::Borrow<crate::encodings::Utf8> for Unit {
    #[inline]
