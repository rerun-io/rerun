...
pub enum DecoderState {
    ...
    ///
    /// The [`StreamFooter`] contains information about where the RRD manifest can be found, but we
...
// TODO: we 100% needed a roundtrip test that relies on footers exclusively
