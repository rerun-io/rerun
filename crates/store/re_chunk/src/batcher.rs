...
mod tests {
    ...
    fn simple() -> anyhow::Result<()> {
        ...
        let row1 = PendingRow::from_iter(timepoint1.clone(), components1.into_iter());
        let row2 = PendingRow::from_iter(timepoint2.clone(), components2.into_iter());
        let row3 = PendingRow::from_iter(timepoint3.clone(), components3.into_iter());
    ...
    fn simple_static() -> anyhow::Result<()> {
        ...
        let row1 = PendingRow::from_iter(static_.clone(), components1.into_iter());
        let row2 = PendingRow::from_iter(static_.clone(), components2.into_iter());
        let row3 = PendingRow::from_iter(static_.clone(), components3.into_iter());
    ...
    fn unsorted_timeline_below_threshold() -> anyhow::Result<()> {
        ...
        let row1 = PendingRow::from_iter(timepoint4.clone(), components1.into_iter());
        let row2 = PendingRow::from_iter(timepoint1.clone(), components2.into_iter());
        let row3 = PendingRow::from_iter(timepoint2.clone(), components3.into_iter());
        let row4 = PendingRow::from_iter(timepoint3.clone(), components4.into_iter());
