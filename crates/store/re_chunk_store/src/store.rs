...
pub(crate) struct ColumnIdentifier {
...
pub struct ChunkStore {
    ...
    pub(crate) per_column_metadata:
        IntMap<EntityPath, IntMap<ColumnIdentifier, (ComponentDescriptor, ColumnMetadataState)>>,
...
impl ChunkStore {
    ...
    pub fn lookup_column_metadata(
        ...
        let ColumnMetadataState {
            ...
            .and_then(|(_, metadata_state)| Some(metadata_state))?;
