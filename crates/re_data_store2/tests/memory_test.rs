...
use re_data_store2::{DataStore2, DataStoreConfig2};
...
fn scalar_memory_overhead() {
    ...
    re_log::warn!("THIS TEST HAS TO ACCOUNT FOR THE MEMORY OF ALL RUNNING THREADS -- IT MUST BE RUN ON ITS OWN, WITH NO OTHER TESTS RUNNING IN PARALLEL: `cargo t --all-features -p re_data_store2 memory_tests -- scalar_memory_overhead`");
