<!--[metadata]
title = "Depth compare"
description = "Side-by-side comparison of monocular depth estimation networks, with 3D back-projection into world space for richer inspection."
tags = ["2D", "3D", "Hugging Face", "Depth", "Pinhole camera"]
