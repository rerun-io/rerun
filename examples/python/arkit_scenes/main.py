...
[rr.Image archetype](https://www.rerun.io/docs/reference/loggable-types/archetypes/image) to the
...
[rr.DepthImage archetype](https://www.rerun.io/docs/reference/loggable-types/archetypes/depth_image) to
[world/camera_lowres/depth](recording://world/camera_lowres/depth).

### Ground-truth mesh
The mesh is logged as an [rr.Mesh3D archetype](https://www.rerun.io/docs/reference/loggable-types/archetypes/mesh3d).
...
[rr.Boxes3D archetype](https://www.rerun.io/docs/reference/loggable-types/archetypes/boxes3d). In this example, each
