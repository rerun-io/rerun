...
## Denoising loop
For each step in the denoising loop we createa a time sequence and log the model input, noise predictions, latents and image. This make is possible for us to see all denoising steps in the Rerun viewer.
```python
