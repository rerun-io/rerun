...
[rr.Image objects](https://www.rerun.io/docs/reference/loggable-types/archetypes/image) to the
...
[rr.Boxes2D archetype](https://www.rerun.io/docs/reference/loggable-types/archetypes/boxes2d) to Rerun.

The color and label of the bounding boxes is determined by their class id, relying on the same
[rr.AnnotationContext archetype](https://www.rerun.io/docs/reference/loggable-types/archetypes/annotation_context) as the
...
[rr.TextLog page](https://www.rerun.io/docs/reference/loggable-types/archetypes/text_log#textlogintegration), statements
