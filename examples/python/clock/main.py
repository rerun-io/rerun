...
def log_clock(steps: int) -> None:
    ...
    for step in range(steps):
        ...
        viewer.set_time_seconds("sim_time", t_secs)
        ...
        viewer.log_point("world/hours_pt", position=point_h, color=color_h)
        viewer.log_arrow("world/hours_hand", origin=[0.0, 0.0, 0.0], vector=point_h, color=color_h, width_scale=WIDTH_M)
