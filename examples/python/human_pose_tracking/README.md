...
[`ClassDescription`](https://www.rerun.io/docs/reference/types/encodings/class_description) is logged, that contains the information which maps keypoint ids to labels and how to connect
