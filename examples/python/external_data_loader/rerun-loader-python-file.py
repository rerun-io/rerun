...
parser.add_argument("--opened-application-id", type=str, help="currently opened application ID in the viewer, if any")
parser.add_argument("--recording-id", type=str, help="optional recommended ID for the recording")
parser.add_argument("--opened-recording-id", type=str, help="currently opened recording ID in the viewer, if any")
