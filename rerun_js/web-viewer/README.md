...
The entrypoint for this packages is the [`WebViewer`](https://ref.rerun.io/docs/js/0.25.0-alpha.6/web-viewer/classes/WebViewer.html) class.
...
- A hosted `.rrd` file, such as <https://app.rerun.io/version/0.25.0-alpha.6/examples/dna.rrd>
