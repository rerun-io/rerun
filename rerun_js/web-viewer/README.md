...
The entrypoint for this packages is the [`WebViewer`](https://ref.rerun.io/docs/js/0.29.0-alpha.5/web-viewer/classes/WebViewer.html) class.
...
- A hosted `.rrd` file, such as <https://app.rerun.io/version/0.29.0-alpha.5/examples/dna.rrd>
