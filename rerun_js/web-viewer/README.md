...
The entrypoint for this packages is the [`WebViewer`](https://ref.rerun.io/docs/js/0.27.0-rc.6/web-viewer/classes/WebViewer.html) class.
...
- A hosted `.rrd` file, such as <https://app.rerun.io/version/0.27.0-rc.6/examples/dna.rrd>
