...
The entrypoint for this packages is the [`WebViewer`](https://ref.rerun.io/docs/js/0.24.0-alpha.7/web-viewer/classes/WebViewer.html) class.
...
- A hosted `.rrd` file, such as <https://app.rerun.io/version/0.24.0-alpha.7/examples/dna.rrd>
