...
FILES_ALLOWED_TO_BE_LARGE = {
    ...
    "crates/store/re_protos/src/v1alpha1/rerun.cloud.v1alpha1.rs",  # generated
    "crates/store/re_protos/src/v1alpha1/rerun.manifest_registry.v1alpha1.rs",  # generated
