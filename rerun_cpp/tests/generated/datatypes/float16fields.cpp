...
namespace rerun {
    const std::shared_ptr<arrow::DataType>& Loggable<datatypes::Float16Fields>::arrow_datatype() {
    ...
    Result<std::shared_ptr<arrow::Array>> Loggable<datatypes::Float16Fields>::to_arrow(
        ...
        if (instances && num_instances > 0) {
            RR_RETURN_NOT_OK(Loggable<datatypes::Float16Fields>::fill_arrow_array_builder(
    ...
    rerun::Error Loggable<datatypes::Float16Fields>::fill_arrow_array_builder(
        arrow::StructBuilder* builder, const datatypes::Float16Fields* elements, size_t num_elements
    ) {
        if (builder == nullptr) {
