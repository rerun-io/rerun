...
namespace rerun {
    ...
    struct Loggable<datatypes::MixedFields> {
        static constexpr std::string_view ComponentType = "rerun.testing.datatypes.MixedFields";

        /// Returns the arrow data type this type corresponds to.
        static const std::shared_ptr<arrow::DataType>& arrow_datatype();

        /// Serializes an array of `rerun::datatypes::MixedFields` into an arrow array.
