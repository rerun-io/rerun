...
namespace rerun {
    const std::shared_ptr<arrow::DataType>& Loggable<datatypes::ScalarUnion>::arrow_datatype() {
        static const auto datatype = arrow::dense_union({
            ...
            arrow::field(
                ...
                arrow::list(arrow::field(
                    "item",
                    Loggable<rerun::datatypes::MixedFields>::arrow_datatype(),
                    false
                )),
                false
            ),
    ...
    Result<std::shared_ptr<arrow::Array>> Loggable<datatypes::ScalarUnion>::to_arrow(
        ...
        if (instances && num_instances > 0) {
            RR_RETURN_NOT_OK(Loggable<datatypes::ScalarUnion>::fill_arrow_array_builder(
    ...
    rerun::Error Loggable<datatypes::ScalarUnion>::fill_arrow_array_builder(
        ...
        for (size_t elem_idx = 0; elem_idx < num_elements; elem_idx += 1) {
            ...
            using TagType = datatypes::detail::ScalarUnionTag;
            switch (union_instance.get_union_tag()) {
                ...
                case TagType::craziness: {
                    ...
                    return rerun::Error(
                        ...
                        "Failed to serialize ScalarUnion::craziness: objects (Object { fqname: \"rerun.testing.datatypes.MixedFields\" }) in unions not yet implemented"
                    );
                } break;
