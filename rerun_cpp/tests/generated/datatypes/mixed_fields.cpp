...
namespace rerun {
    const std::shared_ptr<arrow::DataType>& Loggable<datatypes::MixedFields>::arrow_datatype() {
    ...
    Result<std::shared_ptr<arrow::Array>> Loggable<datatypes::MixedFields>::to_arrow(
        ...
        if (instances && num_instances > 0) {
            RR_RETURN_NOT_OK(Loggable<datatypes::MixedFields>::fill_arrow_array_builder(
    ...
    rerun::Error Loggable<datatypes::MixedFields>::fill_arrow_array_builder(
        arrow::StructBuilder* builder, const datatypes::MixedFields* elements, size_t num_elements
    ) {
        if (builder == nullptr) {
