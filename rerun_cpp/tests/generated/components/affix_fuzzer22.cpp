...
namespace rerun {
    const std::shared_ptr<arrow::DataType>& Loggable<components::AffixFuzzer22>::arrow_data_type() {
        static const auto datatype = Loggable<rerun::encodings::FixedSizeBytes>::arrow_data_type();
        return datatype;
    }
