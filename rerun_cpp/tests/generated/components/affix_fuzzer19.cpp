...
namespace rerun {
    namespace components {
        ...
        const std::shared_ptr<arrow::DataType> &AffixFuzzer19::arrow_field() {
            static const auto datatype = rerun::datatypes::AffixFuzzer5::arrow_field();
            return datatype;
        }
        ...
        Result<rerun::DataCell> AffixFuzzer19::to_data_cell(
            ...
            auto schema = arrow::schema(
                {arrow::field(AffixFuzzer19::NAME, AffixFuzzer19::arrow_field(), false)}
            );
