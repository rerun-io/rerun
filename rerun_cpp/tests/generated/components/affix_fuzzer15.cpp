...
namespace rerun {
    const std::shared_ptr<arrow::DataType>& Loggable<components::AffixFuzzer15>::arrow_data_type() {
        static const auto datatype = Loggable<rerun::encodings::ScalarUnion>::arrow_data_type();
        return datatype;
    }
