...
namespace rerun {
    ...
    Result<std::shared_ptr<arrow::Array>> Loggable<encodings::MixedFields>::to_arrow(
        ...
        if (instances && num_instances > 0) {
            RR_RETURN_NOT_OK(Loggable<encodings::MixedFields>::fill_arrow_array_builder(
    ...
    rerun::Error Loggable<encodings::MixedFields>::fill_arrow_array_builder(
        arrow::StructBuilder* builder, const encodings::MixedFields* elements, size_t num_elements
    ) {
        if (builder == nullptr) {
        ...
        }
        {
            ...
            for (size_t elem_idx = 0; elem_idx < num_elements; elem_idx += 1) {
                RR_RETURN_NOT_OK(
                    Loggable<rerun::encodings::FlattenedScalar>::fill_arrow_array_builder(
                        field_builder,
