...
namespace rerun {
    const std::shared_ptr<arrow::DataType>& Loggable<encodings::ScalarUnion>::arrow_data_type() {
        static const auto datatype = arrow::dense_union({
            ...
            arrow::field(
                ...
                arrow::list(arrow::field(
                    "item",
                    Loggable<rerun::encodings::MixedFields>::arrow_data_type(),
                    false
                )),
                false
            ),
    ...
    Result<std::shared_ptr<arrow::Array>> Loggable<encodings::ScalarUnion>::to_arrow(
        const encodings::ScalarUnion* instances, size_t num_instances
    ) {
        ...
        if (instances && num_instances > 0) {
            RR_RETURN_NOT_OK(Loggable<encodings::ScalarUnion>::fill_arrow_array_builder(
    ...
    rerun::Error Loggable<encodings::ScalarUnion>::fill_arrow_array_builder(
        arrow::DenseUnionBuilder* builder, const encodings::ScalarUnion* elements,
        size_t num_elements
    ) {
        if (builder == nullptr) {
        ...
        for (size_t elem_idx = 0; elem_idx < num_elements; elem_idx += 1) {
            ...
            using TagType = encodings::detail::ScalarUnionTag;
            switch (union_instance.get_union_tag()) {
                ...
                case TagType::craziness: {
                    ...
                    return rerun::Error(
                        ...
                        "Failed to serialize ScalarUnion::craziness: objects (Object { fqname: \"rerun.testing.encodings.MixedFields\" }) in unions not yet implemented"
                    );
                } break;
                case TagType::fixed_size_shenanigans: {
                    ...
                    return rerun::Error(
                        ErrorCode::NotImplemented,
                        "Failed to serialize ScalarUnion::fixed_size_shenanigans: FixedSizeListBuilder in unions not yet implemented"
                    );
                } break;
