...
namespace rerun {
    const std::shared_ptr<arrow::DataType>& Loggable<encodings::Float16Fields>::arrow_data_type() {
    ...
    Result<std::shared_ptr<arrow::Array>> Loggable<encodings::Float16Fields>::to_arrow(
        ...
        if (instances && num_instances > 0) {
            RR_RETURN_NOT_OK(Loggable<encodings::Float16Fields>::fill_arrow_array_builder(
    ...
    rerun::Error Loggable<encodings::Float16Fields>::fill_arrow_array_builder(
        arrow::StructBuilder* builder, const encodings::Float16Fields* elements, size_t num_elements
    ) {
        if (builder == nullptr) {
