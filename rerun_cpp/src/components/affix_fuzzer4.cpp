...
namespace rr {
    namespace components {
        ...
        arrow::Result<std::shared_ptr<arrow::ArrayBuilder>> AffixFuzzer4::to_arrow(
            arrow::MemoryPool *memory_pool, const AffixFuzzer4 *elements, size_t num_elements) {
            if (!memory_pool) {
            ...
            static_assert(sizeof(AffixFuzzer4) == sizeof(rr::datatypes::AffixFuzzer1),
