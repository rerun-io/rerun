...
namespace rr {
    namespace components {
        ...
        arrow::Result<std::shared_ptr<arrow::ArrayBuilder>> AffixFuzzer19::to_arrow(
            ...
            static_assert(sizeof(AffixFuzzer19) == sizeof(rr::datatypes::AffixFuzzer5),
                          "Expected fully transparent type.");
            auto builder = rr::datatypes::AffixFuzzer5::to_arrow(
                memory_pool,
