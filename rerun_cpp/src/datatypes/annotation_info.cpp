    ...
    namespace datatypes {
        const std::shared_ptr<arrow::DataType> &AnnotationInfo::to_arrow_datatype() {
            static const auto datatype = arrow::struct_({
                ...
                arrow::field("label", rr::components::Label::to_arrow_datatype(), true, nullptr),
                arrow::field("color", rr::components::Color::to_arrow_datatype(), true, nullptr),
            });
            return datatype;
        }
        ...
        arrow::Result<std::shared_ptr<arrow::StructBuilder>>
            ...
            return arrow::Result(std::make_shared<arrow::StructBuilder>(
                ...
                std::vector<std::shared_ptr<arrow::ArrayBuilder>>({
                    ...
                    rr::components::Label::new_arrow_array_builder(memory_pool).ValueOrDie(),
                    rr::components::Color::new_arrow_array_builder(memory_pool).ValueOrDie(),
                })
            ));
        }
