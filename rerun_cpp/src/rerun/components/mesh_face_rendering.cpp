...
namespace rerun {
    const std::shared_ptr<arrow::DataType>& Loggable<components::MeshFaceRendering>::arrow_datatype(
    ) {
    ...
    Result<std::shared_ptr<arrow::Array>> Loggable<components::MeshFaceRendering>::to_arrow(
        ...
        if (instances && num_instances > 0) {
            RR_RETURN_NOT_OK(Loggable<components::MeshFaceRendering>::fill_arrow_array_builder(
