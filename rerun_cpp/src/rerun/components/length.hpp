...
namespace rerun::components {
    ...
    struct Length {
      ...
      public:
        ...
        Length(rerun::encodings::Float32 length_) : length(length_) {}

        Length& operator=(rerun::encodings::Float32 length_) {
            length = length_;
            return *this;
        }
...
namespace rerun {
    static_assert(sizeof(rerun::encodings::Float32) == sizeof(components::Length));

    /// \private
    template <>
    struct Loggable<components::Length> {
        static constexpr std::string_view ComponentType = "rerun.components.Length";
