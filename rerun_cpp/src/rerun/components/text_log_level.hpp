...
// Based on "crates/build/re_type_definitions/rerun/components/text_log_level.def.rs".
...
namespace rerun::components {
    ...
    struct TextLogLevel {
      ...
      public:
        ...
        TextLogLevel(rerun::encodings::Utf8 value_) : value(std::move(value_)) {}

        TextLogLevel& operator=(rerun::encodings::Utf8 value_) {
...
namespace rerun {
    static_assert(sizeof(rerun::encodings::Utf8) == sizeof(components::TextLogLevel));

    /// \private
    template <>
    struct Loggable<components::TextLogLevel> {
        static constexpr std::string_view ComponentType = "rerun.components.TextLogLevel";
