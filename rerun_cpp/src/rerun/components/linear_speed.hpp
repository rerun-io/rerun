...
// Based on "crates/build/re_type_definitions/rerun/components/linear_speed.def.rs".
...
namespace rerun::components {
    ...
    struct LinearSpeed {
      ...
      public:
        ...
        LinearSpeed(rerun::encodings::Float64 speed_) : speed(speed_) {}

        LinearSpeed& operator=(rerun::encodings::Float64 speed_) {
            speed = speed_;
            return *this;
        }
...
namespace rerun {
    static_assert(sizeof(rerun::encodings::Float64) == sizeof(components::LinearSpeed));
