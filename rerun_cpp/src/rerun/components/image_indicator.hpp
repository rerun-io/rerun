        ...
        struct ImageIndicator {
          ...
          public:
            ...
            static Error fill_arrow_array_builder(
                arrow::NullBuilder* builder, const ImageIndicator* elements, size_t num_elements
            );

            /// Creates a Rerun DataCell from an array of ImageIndicator components.
            static Result<rerun::DataCell> to_data_cell(
                const ImageIndicator* instances, size_t num_instances
            );
        };
    } // namespace components
} // namespace rerun
