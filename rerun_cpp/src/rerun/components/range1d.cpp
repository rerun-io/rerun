...
namespace rerun {
    ...
    Result<std::shared_ptr<arrow::Array>> Loggable<components::Range1D>::to_arrow(
        ...
        if (instances && num_instances > 0) {
            RR_RETURN_NOT_OK(Loggable<components::Range1D>::fill_arrow_array_builder(
    ...
    rerun::Error Loggable<components::Range1D>::fill_arrow_array_builder(
