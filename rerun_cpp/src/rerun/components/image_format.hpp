...
namespace rerun::components {
    ...
    struct ImageFormat {
      ...
      public:
        ...
        ImageFormat(rerun::encodings::ImageFormat image_format_) : image_format(image_format_) {}
...
namespace rerun {
    static_assert(sizeof(rerun::encodings::ImageFormat) == sizeof(components::ImageFormat));
    ...
    struct Loggable<components::ImageFormat> {
        ...
        static Result<std::shared_ptr<arrow::Array>> to_arrow(
            ...
            if (num_instances == 0) {
                return Loggable<rerun::encodings::ImageFormat>::to_arrow(nullptr, 0);
                ...
                return Loggable<rerun::encodings::ImageFormat>::to_arrow(
