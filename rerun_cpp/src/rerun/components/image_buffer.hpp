...
// Based on "crates/build/re_type_definitions/rerun/components/image_buffer.def.rs".
...
namespace rerun::components {
    ...
    struct ImageBuffer {
      ...
      public:
        ...
        ImageBuffer(rerun::encodings::Blob buffer_) : buffer(std::move(buffer_)) {}

        ImageBuffer& operator=(rerun::encodings::Blob buffer_) {
...
namespace rerun {
    static_assert(sizeof(rerun::encodings::Blob) == sizeof(components::ImageBuffer));

    /// \private
    template <>
    struct Loggable<components::ImageBuffer> {
        static constexpr std::string_view ComponentType = "rerun.components.ImageBuffer";

        /// Returns the arrow data type this type corresponds to.
        static const std::shared_ptr<arrow::DataType>& arrow_data_type() {
            return Loggable<rerun::encodings::Blob>::arrow_data_type();
        }
        ...
        static Result<std::shared_ptr<arrow::Array>> to_arrow(
            ...
            if (num_instances == 0) {
                ...
                return Loggable<rerun::encodings::Blob>::to_arrow(
                    &instances->buffer,
                    num_instances
                );
            }
