...
// Based on "crates/build/re_type_definitions/rerun/components/depth_meter.def.rs".
...
namespace rerun::components {
    ...
    struct DepthMeter {
      ...
      public:
        ...
        DepthMeter(rerun::encodings::Float32 value_) : value(value_) {}

        DepthMeter& operator=(rerun::encodings::Float32 value_) {
            value = value_;
            return *this;
        }
...
namespace rerun {
    static_assert(sizeof(rerun::encodings::Float32) == sizeof(components::DepthMeter));
