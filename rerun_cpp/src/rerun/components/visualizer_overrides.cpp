...
namespace rerun {
    const std::shared_ptr<arrow::DataType>&
        Loggable<components::VisualizerOverrides>::arrow_datatype() {
        static const auto datatype = arrow::list(arrow::field("item", arrow::utf8(), false));
        return datatype;
    }

    rerun::Error Loggable<components::VisualizerOverrides>::fill_arrow_array_builder(
    ...
    Result<std::shared_ptr<arrow::Array>> Loggable<components::VisualizerOverrides>::to_arrow(
        ...
        if (instances && num_instances > 0) {
            RR_RETURN_NOT_OK(Loggable<components::VisualizerOverrides>::fill_arrow_array_builder(
