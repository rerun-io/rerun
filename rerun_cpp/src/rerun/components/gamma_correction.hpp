...
namespace rerun::components {
    ...
    struct GammaCorrection {
        rerun::encodings::Float32 gamma;

      public:
        GammaCorrection() = default;

        GammaCorrection(rerun::encodings::Float32 gamma_) : gamma(gamma_) {}

        GammaCorrection& operator=(rerun::encodings::Float32 gamma_) {
            gamma = gamma_;
            return *this;
        }
...
namespace rerun {
    static_assert(sizeof(rerun::encodings::Float32) == sizeof(components::GammaCorrection));
