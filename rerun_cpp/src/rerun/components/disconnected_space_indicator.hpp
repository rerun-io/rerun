...
namespace rerun {
    namespace components {
        ...
        struct DisconnectedSpaceIndicator {
            /// Name of the component, used for serialization.
            static const char* NAME;

          public:
            DisconnectedSpaceIndicator() = default;
            ...
            static Error fill_arrow_array_builder(
                arrow::NullBuilder* builder, const DisconnectedSpaceIndicator* elements,
                size_t num_elements
            );

            /// Creates a Rerun DataCell from an array of DisconnectedSpaceIndicator components.
            static Result<rerun::DataCell> to_data_cell(
                const DisconnectedSpaceIndicator* instances, size_t num_instances
            );
        };
    } // namespace components
} // namespace rerun
