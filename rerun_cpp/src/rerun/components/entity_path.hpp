...
// Based on "crates/build/re_type_definitions/rerun/components/entity_path.def.rs".
...
namespace rerun::components {
    ...
    struct EntityPath {
        rerun::encodings::EntityPath value;
      ...
      public:
        ...
        EntityPath(rerun::encodings::EntityPath value_) : value(std::move(value_)) {}

        EntityPath& operator=(rerun::encodings::EntityPath value_) {
...
namespace rerun {
    static_assert(sizeof(rerun::encodings::EntityPath) == sizeof(components::EntityPath));

    /// \private
    template <>
    struct Loggable<components::EntityPath> {
        static constexpr std::string_view ComponentType = "rerun.components.EntityPath";
