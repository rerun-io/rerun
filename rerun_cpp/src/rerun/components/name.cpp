...
namespace rerun {
    const std::shared_ptr<arrow::DataType>& Loggable<components::Name>::arrow_datatype() {
        static const auto datatype = Loggable<rerun::datatypes::Utf8>::arrow_datatype();
        return datatype;
    }

    rerun::Error Loggable<components::Name>::fill_arrow_array_builder(
    ...
    Result<std::shared_ptr<arrow::Array>> Loggable<components::Name>::to_arrow(
        ...
        if (instances && num_instances > 0) {
            RR_RETURN_NOT_OK(Loggable<components::Name>::fill_arrow_array_builder(
