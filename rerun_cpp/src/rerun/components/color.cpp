...
namespace rerun {
    namespace components {
        ...
        const std::shared_ptr<arrow::DataType> &Color::arrow_field() {
            static const auto datatype = rerun::datatypes::Color::arrow_field();
            return datatype;
        }
        ...
        Result<rerun::DataCell> Color::to_data_cell(const Color *instances, size_t num_instances) {
            ...
            auto schema = arrow::schema({arrow::field(Color::NAME, Color::arrow_field(), false)});
