...
namespace rerun::components {
    ...
    struct IsKeyframe {
        rerun::encodings::Bool is_keyframe;

      public:
        IsKeyframe() = default;

        IsKeyframe(rerun::encodings::Bool is_keyframe_) : is_keyframe(is_keyframe_) {}

        IsKeyframe& operator=(rerun::encodings::Bool is_keyframe_) {
...
namespace rerun {
    static_assert(sizeof(rerun::encodings::Bool) == sizeof(components::IsKeyframe));
