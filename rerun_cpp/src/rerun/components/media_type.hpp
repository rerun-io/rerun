...
namespace rerun::components {
    ...
    struct MediaType {
      ...
      public:
        ...
        MediaType(rerun::encodings::Utf8 value_) : value(std::move(value_)) {}

        MediaType& operator=(rerun::encodings::Utf8 value_) {
...
namespace rerun {
    static_assert(sizeof(rerun::encodings::Utf8) == sizeof(components::MediaType));
