...
namespace rerun::components {
    ...
    ///
    /// Entities can use `encodings::ClassId`s and `encodings::KeypointId`s to provide annotations, and
    ...
    struct AnnotationContext {
        ...
        rerun::Collection<rerun::encodings::ClassDescriptionMapElem> class_map;
      ...
      public:
        ...
        AnnotationContext(rerun::Collection<rerun::encodings::ClassDescriptionMapElem> class_map_)
            : class_map(std::move(class_map_)) {}

        AnnotationContext& operator=(
            rerun::Collection<rerun::encodings::ClassDescriptionMapElem> class_map_
        ) {
            class_map = std::move(class_map_);
            return *this;
        }
...
namespace rerun {
    ...
    struct Loggable<components::AnnotationContext> {
        static constexpr std::string_view ComponentType = "rerun.components.AnnotationContext";
