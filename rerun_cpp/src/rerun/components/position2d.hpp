...
// Based on "crates/build/re_type_definitions/rerun/components/position2d.def.rs".
...
namespace rerun::components {
    ...
    struct Position2D {
      ...
      public:
        ...
        Position2D(rerun::encodings::Vec2D xy_) : xy(xy_) {}

        Position2D& operator=(rerun::encodings::Vec2D xy_) {
            xy = xy_;
            return *this;
        }
...
namespace rerun {
    static_assert(sizeof(rerun::encodings::Vec2D) == sizeof(components::Position2D));
    ...
    struct Loggable<components::Position2D> {
        ...
        static Result<std::shared_ptr<arrow::Array>> to_arrow(
            ...
            if (num_instances == 0) {
                ...
                return Loggable<rerun::encodings::Vec2D>::to_arrow(&instances->xy, num_instances);
            }
        }
    };
} // namespace rerun
