...
// Based on "crates/build/re_type_definitions/rerun/components/pinhole_projection.def.rs".
...
namespace rerun::components {
    ...
    struct PinholeProjection {
        rerun::encodings::Mat3x3 image_from_camera;
      ...
      public:
        ...
        PinholeProjection(rerun::encodings::Mat3x3 image_from_camera_)
            : image_from_camera(image_from_camera_) {}

        PinholeProjection& operator=(rerun::encodings::Mat3x3 image_from_camera_) {
            image_from_camera = image_from_camera_;
            return *this;
        }
        ...
        /// Cast to the underlying Mat3x3 encoding
        operator rerun::encodings::Mat3x3() const {
...
namespace rerun {
    static_assert(sizeof(rerun::encodings::Mat3x3) == sizeof(components::PinholeProjection));
    ...
    struct Loggable<components::PinholeProjection> {
        ...
        static const std::shared_ptr<arrow::DataType>& arrow_data_type() {
            return Loggable<rerun::encodings::Mat3x3>::arrow_data_type();
        }
        ...
        static Result<std::shared_ptr<arrow::Array>> to_arrow(
            ...
            if (num_instances == 0) {
                return Loggable<rerun::encodings::Mat3x3>::to_arrow(nullptr, 0);
                ...
                return Loggable<rerun::encodings::Mat3x3>::to_arrow(
