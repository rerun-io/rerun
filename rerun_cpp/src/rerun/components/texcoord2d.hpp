...
namespace rerun::components {
    ...
    struct Texcoord2D {
      ...
      public:
        ...
        Texcoord2D(rerun::encodings::Vec2D uv_) : uv(uv_) {}

        Texcoord2D& operator=(rerun::encodings::Vec2D uv_) {
            uv = uv_;
            return *this;
        }
...
namespace rerun {
    static_assert(sizeof(rerun::encodings::Vec2D) == sizeof(components::Texcoord2D));
    ...
    struct Loggable<components::Texcoord2D> {
        ...
        static Result<std::shared_ptr<arrow::Array>> to_arrow(
            ...
            if (num_instances == 0) {
                ...
                return Loggable<rerun::encodings::Vec2D>::to_arrow(&instances->uv, num_instances);
            }
        }
    };
} // namespace rerun
