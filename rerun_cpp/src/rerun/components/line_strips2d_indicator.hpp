        ...
        struct LineStrips2DIndicator {
          ...
          public:
            ...
            static Error fill_arrow_array_builder(
                arrow::NullBuilder* builder, const LineStrips2DIndicator* elements,
                size_t num_elements
            );

            /// Creates a Rerun DataCell from an array of LineStrips2DIndicator components.
