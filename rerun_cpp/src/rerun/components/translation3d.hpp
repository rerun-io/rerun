...
namespace rerun::components {
    ...
    struct Translation3D {
      ...
      public:
        ...
        Translation3D(rerun::encodings::Vec3D vector_) : vector(vector_) {}

        Translation3D& operator=(rerun::encodings::Vec3D vector_) {
            vector = vector_;
            return *this;
        }
...
namespace rerun {
    static_assert(sizeof(rerun::encodings::Vec3D) == sizeof(components::Translation3D));
