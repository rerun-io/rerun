        ...
        struct TextDocumentIndicator {
          ...
          public:
            ...
            static Error fill_arrow_array_builder(
                arrow::NullBuilder* builder, const TextDocumentIndicator* elements,
                size_t num_elements
            );

            /// Creates a Rerun DataCell from an array of TextDocumentIndicator components.
