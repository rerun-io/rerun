...
namespace rerun::components {
    ...
    struct Scalar {
      ...
      public:
        ...
        Scalar(rerun::encodings::Float64 value_) : value(value_) {}

        Scalar& operator=(rerun::encodings::Float64 value_) {
            value = value_;
            return *this;
        }
...
namespace rerun {
    static_assert(sizeof(rerun::encodings::Float64) == sizeof(components::Scalar));
