...
// Based on "crates/build/re_type_definitions/rerun/components/draw_order.def.rs".
...
namespace rerun::components {
    ...
    struct DrawOrder {
      ...
      public:
        ...
        DrawOrder(rerun::encodings::Float32 value_) : value(value_) {}

        DrawOrder& operator=(rerun::encodings::Float32 value_) {
            value = value_;
            return *this;
        }
...
namespace rerun {
    static_assert(sizeof(rerun::encodings::Float32) == sizeof(components::DrawOrder));
