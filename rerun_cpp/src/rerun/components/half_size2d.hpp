...
namespace rerun::components {
    ...
    struct HalfSize2D {
      ...
      public:
        ...
        HalfSize2D(rerun::encodings::Vec2D xy_) : xy(xy_) {}

        HalfSize2D& operator=(rerun::encodings::Vec2D xy_) {
            xy = xy_;
            return *this;
        }
...
namespace rerun {
    static_assert(sizeof(rerun::encodings::Vec2D) == sizeof(components::HalfSize2D));

    /// \private
    template <>
    struct Loggable<components::HalfSize2D> {
        static constexpr std::string_view ComponentType = "rerun.components.HalfSize2D";
