...
namespace rerun::components {
    ...
    struct LatLon {
        rerun::encodings::DVec2D lat_lon;
      ...
      public:
        ...
        LatLon(rerun::encodings::DVec2D lat_lon_) : lat_lon(lat_lon_) {}

        LatLon& operator=(rerun::encodings::DVec2D lat_lon_) {
            lat_lon = lat_lon_;
            return *this;
        }
        ...
        /// Cast to the underlying DVec2D encoding
        operator rerun::encodings::DVec2D() const {
            return lat_lon;
        }
    };
} // namespace rerun::components
...
namespace rerun {
    static_assert(sizeof(rerun::encodings::DVec2D) == sizeof(components::LatLon));
    ...
    struct Loggable<components::LatLon> {
        ...
        static const std::shared_ptr<arrow::DataType>& arrow_data_type() {
            return Loggable<rerun::encodings::DVec2D>::arrow_data_type();
        }
        ...
        static Result<std::shared_ptr<arrow::Array>> to_arrow(
            ...
            if (num_instances == 0) {
                return Loggable<rerun::encodings::DVec2D>::to_arrow(nullptr, 0);
                ...
                return Loggable<rerun::encodings::DVec2D>::to_arrow(
                    &instances->lat_lon,
                    num_instances
                );
            }
