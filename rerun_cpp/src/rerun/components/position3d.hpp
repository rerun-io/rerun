    ...
    namespace components {
        ...
        struct Position3D {
          ...
          public:
            ...
            Position3D(const std::array<float, 3>& xyz_) : xyz(xyz_) {}

            Position3D& operator=(const std::array<float, 3>& xyz_) {
                xyz = xyz_;
                return *this;
            }

            Position3D(const float (&xyz_)[3]) : xyz(std::array{xyz_[0], xyz_[1], xyz_[2]}) {}
