...
// Based on "crates/build/re_type_definitions/rerun/components/stroke_width.def.rs".
...
namespace rerun::components {
    ...
    struct StrokeWidth {
        rerun::encodings::Float32 width;

      public:
        StrokeWidth() = default;

        StrokeWidth(rerun::encodings::Float32 width_) : width(width_) {}

        StrokeWidth& operator=(rerun::encodings::Float32 width_) {
            width = width_;
            return *this;
        }
...
namespace rerun {
    static_assert(sizeof(rerun::encodings::Float32) == sizeof(components::StrokeWidth));
