...
// Based on "crates/build/re_type_definitions/rerun/components/fill_ratio.def.rs".
...
namespace rerun::components {
    ...
    struct FillRatio {
      ...
      public:
        ...
        FillRatio(rerun::encodings::Float32 value_) : value(value_) {}

        FillRatio& operator=(rerun::encodings::Float32 value_) {
            value = value_;
            return *this;
        }
...
namespace rerun {
    static_assert(sizeof(rerun::encodings::Float32) == sizeof(components::FillRatio));

    /// \private
    template <>
    struct Loggable<components::FillRatio> {
        static constexpr std::string_view ComponentType = "rerun.components.FillRatio";
