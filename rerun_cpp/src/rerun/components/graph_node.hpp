...
// Based on "crates/build/re_type_definitions/rerun/components/graph_node.def.rs".
...
namespace rerun::components {
    ...
    struct GraphNode {
      ...
      public:
        ...
        GraphNode(rerun::encodings::Utf8 id_) : id(std::move(id_)) {}

        GraphNode& operator=(rerun::encodings::Utf8 id_) {
            id = std::move(id_);
            return *this;
        }
...
namespace rerun {
    static_assert(sizeof(rerun::encodings::Utf8) == sizeof(components::GraphNode));

    /// \private
    template <>
    struct Loggable<components::GraphNode> {
        static constexpr std::string_view ComponentType = "rerun.components.GraphNode";
        ...
        static Result<std::shared_ptr<arrow::Array>> to_arrow(
            ...
            if (num_instances == 0) {
                ...
                return Loggable<rerun::encodings::Utf8>::to_arrow(&instances->id, num_instances);
            }
        }
    };
} // namespace rerun
