...
// Based on "crates/build/re_type_definitions/rerun/components/line_strip3d.def.rs".
...
namespace rerun {
    const std::shared_ptr<arrow::DataType>& Loggable<components::LineStrip3D>::arrow_data_type() {
        static const auto datatype = arrow::list(
            arrow::field("item", Loggable<rerun::encodings::Vec3D>::arrow_data_type(), false)
        );
        return datatype;
    }
