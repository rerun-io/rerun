...
// Based on "crates/build/re_type_definitions/rerun/components/transform_frame_id.def.rs".
...
namespace rerun::components {
    ...
    struct TransformFrameId {
      ...
      public:
        ...
        TransformFrameId(rerun::encodings::Utf8 value_) : value(std::move(value_)) {}

        TransformFrameId& operator=(rerun::encodings::Utf8 value_) {
...
namespace rerun {
    static_assert(sizeof(rerun::encodings::Utf8) == sizeof(components::TransformFrameId));
