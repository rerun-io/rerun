...
namespace rerun::components {
    ...
    struct VideoSample {
      ...
      public:
        ...
        VideoSample(rerun::encodings::Blob buffer_) : buffer(std::move(buffer_)) {}

        VideoSample& operator=(rerun::encodings::Blob buffer_) {
...
namespace rerun {
    static_assert(sizeof(rerun::encodings::Blob) == sizeof(components::VideoSample));
