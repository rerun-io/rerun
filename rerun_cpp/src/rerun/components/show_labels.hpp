...
// Based on "crates/build/re_type_definitions/rerun/components/show_labels.def.rs".
...
namespace rerun::components {
    ...
    struct ShowLabels {
        ...
        rerun::encodings::Bool show_labels;

      public:
        ShowLabels() = default;

        ShowLabels(rerun::encodings::Bool show_labels_) : show_labels(show_labels_) {}

        ShowLabels& operator=(rerun::encodings::Bool show_labels_) {
...
namespace rerun {
    static_assert(sizeof(rerun::encodings::Bool) == sizeof(components::ShowLabels));

    /// \private
    template <>
    struct Loggable<components::ShowLabels> {
        static constexpr std::string_view ComponentType = "rerun.components.ShowLabels";
