...
namespace rerun::components {
    ...
    struct Radius {
      ...
      public:
        ...
        Radius(rerun::encodings::Float32 value_) : value(value_) {}

        Radius& operator=(rerun::encodings::Float32 value_) {
            value = value_;
            return *this;
        }
...
namespace rerun {
    static_assert(sizeof(rerun::encodings::Float32) == sizeof(components::Radius));
