...
// Based on "crates/build/re_type_definitions/rerun/components/color.def.rs".
...
namespace rerun::components {
    ...
    struct Color {
      ...
      public:
        ...
        Color(rerun::encodings::Rgba32 rgba_) : rgba(rgba_) {}

        Color& operator=(rerun::encodings::Rgba32 rgba_) {
            rgba = rgba_;
            return *this;
        }
        ...
        /// Cast to the underlying Rgba32 encoding
        operator rerun::encodings::Rgba32() const {
            return rgba;
        }
    };
} // namespace rerun::components
...
namespace rerun {
    static_assert(sizeof(rerun::encodings::Rgba32) == sizeof(components::Color));
    ...
    struct Loggable<components::Color> {
        ...
        static const std::shared_ptr<arrow::DataType>& arrow_data_type() {
            return Loggable<rerun::encodings::Rgba32>::arrow_data_type();
        }
        ...
        static Result<std::shared_ptr<arrow::Array>> to_arrow(
            ...
            if (num_instances == 0) {
                return Loggable<rerun::encodings::Rgba32>::to_arrow(nullptr, 0);
                ...
                return Loggable<rerun::encodings::Rgba32>::to_arrow(
                    &instances->rgba,
                    num_instances
                );
            }
