...
namespace rerun::components {
    ...
    struct TransformMat3x3 {
      ...
      public:
        ...
        TransformMat3x3(rerun::encodings::Mat3x3 matrix_) : matrix(matrix_) {}

        TransformMat3x3& operator=(rerun::encodings::Mat3x3 matrix_) {
            matrix = matrix_;
            return *this;
        }
...
namespace rerun {
    static_assert(sizeof(rerun::encodings::Mat3x3) == sizeof(components::TransformMat3x3));

    /// \private
    template <>
    struct Loggable<components::TransformMat3x3> {
        static constexpr std::string_view ComponentType = "rerun.components.TransformMat3x3";
