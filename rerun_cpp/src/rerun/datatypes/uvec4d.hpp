    ...
    namespace datatypes {
        ...
        struct UVec4D {
          ...
          public:
            ...
            UVec4D(const std::array<uint32_t, 4>& xyzw_) : xyzw(xyzw_) {}

            UVec4D& operator=(const std::array<uint32_t, 4>& xyzw_) {
                xyzw = xyzw_;
                return *this;
            }

            UVec4D(const uint32_t (&xyzw_)[4]) : xyzw({xyzw_[0], xyzw_[1], xyzw_[2], xyzw_[3]}) {}
