...
namespace rerun {
    namespace datatypes {
        const std::shared_ptr<arrow::DataType> &ClassDescriptionMapElem::arrow_field() {
            static const auto datatype = arrow::struct_({
                arrow::field("class_id", rerun::datatypes::ClassId::arrow_field(), false),
                arrow::field(
                    "class_description",
                    rerun::datatypes::ClassDescription::arrow_field(),
                    false
                ),
            });
            return datatype;
