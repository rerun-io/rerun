...
// Based on "crates/build/re_type_definitions/rerun/datatypes/tensor_buffer.def.rs".
...
namespace rerun {
    ...
    struct Loggable<datatypes::TensorBuffer> {
        static constexpr std::string_view ComponentType = "rerun.datatypes.TensorBuffer";
