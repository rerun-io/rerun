...
namespace rerun {
    const std::shared_ptr<arrow::DataType>&
        Loggable<datatypes::VisibleTimeRangeBoundary>::arrow_datatype() {
        static const auto datatype = arrow::struct_({
            arrow::field(
                "kind",
                Loggable<rerun::datatypes::VisibleTimeRangeBoundaryKind>::arrow_datatype(),
                false
            ),
    ...
    Result<std::shared_ptr<arrow::Array>> Loggable<datatypes::VisibleTimeRangeBoundary>::to_arrow(
        ...
        if (instances && num_instances > 0) {
            RR_RETURN_NOT_OK(
                Loggable<datatypes::VisibleTimeRangeBoundary>::fill_arrow_array_builder(
    ...
    rerun::Error Loggable<datatypes::VisibleTimeRangeBoundary>::fill_arrow_array_builder(
...

        {
            ...
            for (size_t elem_idx = 0; elem_idx < num_elements; elem_idx += 1) {
                RR_RETURN_NOT_OK(
                    Loggable<rerun::datatypes::VisibleTimeRangeBoundaryKind>::
