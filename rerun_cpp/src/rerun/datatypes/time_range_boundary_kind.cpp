...
namespace rerun {
    const std::shared_ptr<arrow::DataType>&
        Loggable<datatypes::TimeRangeBoundaryKind>::arrow_datatype() {
    ...
    Result<std::shared_ptr<arrow::Array>> Loggable<datatypes::TimeRangeBoundaryKind>::to_arrow(
        ...
        if (instances && num_instances > 0) {
            RR_RETURN_NOT_OK(Loggable<datatypes::TimeRangeBoundaryKind>::fill_arrow_array_builder(
    ...
    rerun::Error Loggable<datatypes::TimeRangeBoundaryKind>::fill_arrow_array_builder(
