...
namespace rerun::datatypes {
        ...
        TensorBuffer(std::vector<uint8_t>&& u8) : TensorBuffer(Collection<uint8_t>::take_ownership(std::move(u8))) {}
        TensorBuffer(const std::vector<uint8_t>& u8) : TensorBuffer(Collection<uint8_t>::borrow(u8.data(), u8.size())) {}
