...
namespace rerun {
    const std::shared_ptr<arrow::DataType>&
        Loggable<datatypes::VisibleTimeRangeBoundaryKind>::arrow_datatype() {
        static const auto datatype = arrow::sparse_union({
            arrow::field("_null_markers", arrow::null(), true, nullptr),
            arrow::field("RelativeToTimeCursor", arrow::null(), true),
            arrow::field("Absolute", arrow::null(), true),
    ...
    Result<std::shared_ptr<arrow::Array>>
        Loggable<datatypes::VisibleTimeRangeBoundaryKind>::to_arrow(
        ...
        if (instances && num_instances > 0) {
            RR_RETURN_NOT_OK(
                Loggable<datatypes::VisibleTimeRangeBoundaryKind>::fill_arrow_array_builder(
    ...
    rerun::Error Loggable<datatypes::VisibleTimeRangeBoundaryKind>::fill_arrow_array_builder(
        arrow::SparseUnionBuilder* builder, const datatypes::VisibleTimeRangeBoundaryKind* elements,
        size_t num_elements
    ) {
        if (builder == nullptr) {
