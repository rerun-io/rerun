...
namespace rerun {
    const std::shared_ptr<arrow::DataType>&
        Loggable<blueprint::datatypes::LatestAtQuery>::arrow_datatype() {
    ...
    Result<std::shared_ptr<arrow::Array>> Loggable<blueprint::datatypes::LatestAtQuery>::to_arrow(
        ...
        if (instances && num_instances > 0) {
            RR_RETURN_NOT_OK(
                Loggable<blueprint::datatypes::LatestAtQuery>::fill_arrow_array_builder(
    ...
    rerun::Error Loggable<blueprint::datatypes::LatestAtQuery>::fill_arrow_array_builder(
