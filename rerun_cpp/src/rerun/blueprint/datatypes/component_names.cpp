...
namespace rerun {
    const std::shared_ptr<arrow::DataType>&
        Loggable<blueprint::datatypes::ComponentNames>::arrow_datatype() {
        static const auto datatype = arrow::list(arrow::field("item", arrow::utf8(), false));
        return datatype;
    }

    Result<std::shared_ptr<arrow::Array>> Loggable<blueprint::datatypes::ComponentNames>::to_arrow(
        ...
        if (instances && num_instances > 0) {
            RR_RETURN_NOT_OK(
                Loggable<blueprint::datatypes::ComponentNames>::fill_arrow_array_builder(
    ...
    rerun::Error Loggable<blueprint::datatypes::ComponentNames>::fill_arrow_array_builder(
