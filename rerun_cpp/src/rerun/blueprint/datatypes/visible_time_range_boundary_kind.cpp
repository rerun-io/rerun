...
namespace rerun {
    const std::shared_ptr<arrow::DataType>&
        Loggable<blueprint::datatypes::VisibleTimeRangeBoundaryKind>::arrow_datatype() {
        static const auto datatype = arrow::sparse_union({
            arrow::field("_null_markers", arrow::null(), true, nullptr),
            arrow::field("RelativeToTimeCursor", arrow::null(), false),
            arrow::field("Absolute", arrow::null(), false),
            arrow::field("Infinite", arrow::null(), false),
        });
        return datatype;
    }

    rerun::Error
        Loggable<blueprint::datatypes::VisibleTimeRangeBoundaryKind>::fill_arrow_array_builder(
    ...
    Result<std::shared_ptr<arrow::Array>>
        Loggable<blueprint::datatypes::VisibleTimeRangeBoundaryKind>::to_arrow(
        ...
        if (instances && num_instances > 0) {
            RR_RETURN_NOT_OK(Loggable<blueprint::datatypes::VisibleTimeRangeBoundaryKind>::
