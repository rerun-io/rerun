...
namespace rerun {
    const std::shared_ptr<arrow::DataType>& Loggable<blueprint::datatypes::TimeInt>::arrow_datatype(
    ) {
        static const auto datatype = arrow::int64();
        return datatype;
    }

    rerun::Error Loggable<blueprint::datatypes::TimeInt>::fill_arrow_array_builder(
    ...
    Result<std::shared_ptr<arrow::Array>> Loggable<blueprint::datatypes::TimeInt>::to_arrow(
        ...
        if (instances && num_instances > 0) {
            RR_RETURN_NOT_OK(Loggable<blueprint::datatypes::TimeInt>::fill_arrow_array_builder(
