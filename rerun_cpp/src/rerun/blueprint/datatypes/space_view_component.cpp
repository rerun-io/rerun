...
namespace rerun {
    const std::shared_ptr<arrow::DataType>&
        Loggable<blueprint::datatypes::SpaceViewComponent>::arrow_datatype() {
    ...
    rerun::Error Loggable<blueprint::datatypes::SpaceViewComponent>::fill_arrow_array_builder(
    ...
    Result<std::shared_ptr<arrow::Array>>
        Loggable<blueprint::datatypes::SpaceViewComponent>::to_arrow(
        ...
        if (instances && num_instances > 0) {
            RR_RETURN_NOT_OK(
                Loggable<blueprint::datatypes::SpaceViewComponent>::fill_arrow_array_builder(
