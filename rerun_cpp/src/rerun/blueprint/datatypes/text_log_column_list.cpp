...
namespace rerun {
    ...
    Result<std::shared_ptr<arrow::Array>>
        Loggable<blueprint::datatypes::TextLogColumnList>::to_arrow(
        ...
        if (instances && num_instances > 0) {
            RR_RETURN_NOT_OK(
                Loggable<blueprint::datatypes::TextLogColumnList>::fill_arrow_array_builder(
    ...
    rerun::Error Loggable<blueprint::datatypes::TextLogColumnList>::fill_arrow_array_builder(
