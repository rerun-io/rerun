...
// Based on "crates/build/re_type_definitions/rerun/blueprint/components/enabled.def.rs".
...
namespace rerun::blueprint::components {
    ...
    struct Enabled {
      ...
      public:
        ...
        Enabled(rerun::encodings::Bool visible_) : visible(visible_) {}

        Enabled& operator=(rerun::encodings::Bool visible_) {
            visible = visible_;
            return *this;
        }
...
namespace rerun {
    static_assert(sizeof(rerun::encodings::Bool) == sizeof(blueprint::components::Enabled));
