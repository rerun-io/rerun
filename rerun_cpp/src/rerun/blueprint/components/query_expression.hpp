...
namespace rerun::blueprint::components {
    /// **Component**: An individual query expression used to filter a set of `encodings::EntityPath`s.
    ///
    ...
    struct QueryExpression {
        rerun::encodings::Utf8 filter;

      public:
        QueryExpression() = default;

        QueryExpression(rerun::encodings::Utf8 filter_) : filter(std::move(filter_)) {}

        QueryExpression& operator=(rerun::encodings::Utf8 filter_) {
...
namespace rerun {
    static_assert(sizeof(rerun::encodings::Utf8) == sizeof(blueprint::components::QueryExpression));
