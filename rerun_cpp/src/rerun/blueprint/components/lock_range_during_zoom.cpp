...
#include "lock_range_during_zoom.hpp"
...
namespace rerun {
    const std::shared_ptr<arrow::DataType>&
        Loggable<blueprint::components::LockRangeDuringZoom>::arrow_datatype() {
    ...
    Result<std::shared_ptr<arrow::Array>>
        ...
        if (instances && num_instances > 0) {
            RR_RETURN_NOT_OK(
                Loggable<blueprint::components::LockRangeDuringZoom>::fill_arrow_array_builder(
