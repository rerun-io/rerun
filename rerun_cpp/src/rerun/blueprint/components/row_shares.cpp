...
namespace rerun {
    const std::shared_ptr<arrow::DataType>&
        Loggable<blueprint::components::RowShares>::arrow_datatype() {
        static const auto datatype = arrow::list(arrow::field("item", arrow::float32(), false));
        return datatype;
    }

    rerun::Error Loggable<blueprint::components::RowShares>::fill_arrow_array_builder(
    ...
    Result<std::shared_ptr<arrow::Array>> Loggable<blueprint::components::RowShares>::to_arrow(
        ...
        if (instances && num_instances > 0) {
            RR_RETURN_NOT_OK(Loggable<blueprint::components::RowShares>::fill_arrow_array_builder(
