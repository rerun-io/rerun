...
// Based on "crates/build/re_type_definitions/rerun/blueprint/components/near_clip_plane.def.rs".
...
namespace rerun::blueprint::components {
    ...
    struct NearClipPlane {
        ...
        rerun::encodings::Float32 near_clip_plane;

      public:
        NearClipPlane() = default;

        NearClipPlane(rerun::encodings::Float32 near_clip_plane_)
            : near_clip_plane(near_clip_plane_) {}

        NearClipPlane& operator=(rerun::encodings::Float32 near_clip_plane_) {
            near_clip_plane = near_clip_plane_;
            return *this;
        }
...
namespace rerun {
    static_assert(
        sizeof(rerun::encodings::Float32) == sizeof(blueprint::components::NearClipPlane)
    );
