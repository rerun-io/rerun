...
namespace rerun::blueprint::components {
    ...
    struct VisualizerInstructionId {
        ...
        rerun::encodings::Uuid visualizer;

      public:
        VisualizerInstructionId() = default;

        VisualizerInstructionId(rerun::encodings::Uuid visualizer_) : visualizer(visualizer_) {}

        VisualizerInstructionId& operator=(rerun::encodings::Uuid visualizer_) {
        ...
        /// Cast to the underlying Uuid encoding
        operator rerun::encodings::Uuid() const {
            return visualizer;
        }
    };
} // namespace rerun::blueprint::components
...
namespace rerun {
    static_assert(
        sizeof(rerun::encodings::Uuid) == sizeof(blueprint::components::VisualizerInstructionId)
    );
    ...
    struct Loggable<blueprint::components::VisualizerInstructionId> {
        ...
        static Result<std::shared_ptr<arrow::Array>> to_arrow(
            ...
            if (num_instances == 0) {
                return Loggable<rerun::encodings::Uuid>::to_arrow(nullptr, 0);
                ...
                return Loggable<rerun::encodings::Uuid>::to_arrow(
