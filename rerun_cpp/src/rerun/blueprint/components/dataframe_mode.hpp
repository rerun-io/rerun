...
namespace rerun::blueprint::components {
    ...
    enum class DataframeMode : uint8_t {
...
namespace rerun {
    ...
    /// \private
    template <>
    struct Loggable<blueprint::components::DataframeMode> {
        static constexpr const char Name[] = "rerun.blueprint.components.DataframeMode";

        /// Returns the arrow data type this type corresponds to.
        static const std::shared_ptr<arrow::DataType>& arrow_datatype();

        /// Serializes an array of `rerun::blueprint:: components::DataframeMode` into an arrow array.
        ...
        static rerun::Error fill_arrow_array_builder(
            ...
            const blueprint::components::DataframeMode* elements, size_t num_elements
        );
    };
} // namespace rerun
