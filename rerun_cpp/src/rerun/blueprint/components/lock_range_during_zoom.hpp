...
namespace rerun::blueprint::components {
    ...
    struct LockRangeDuringZoom {
      ...
      public:
        ...
        LockRangeDuringZoom(rerun::encodings::Bool lock_range_) : lock_range(lock_range_) {}
...
namespace rerun {
    static_assert(
        sizeof(rerun::encodings::Bool) == sizeof(blueprint::components::LockRangeDuringZoom)
    );
