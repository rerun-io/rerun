...
namespace rerun {
    const std::shared_ptr<arrow::DataType>&
        Loggable<blueprint::components::ColumnShare>::arrow_datatype() {
    ...
    Result<std::shared_ptr<arrow::Array>> Loggable<blueprint::components::ColumnShare>::to_arrow(
        ...
        if (instances && num_instances > 0) {
            RR_RETURN_NOT_OK(Loggable<blueprint::components::ColumnShare>::fill_arrow_array_builder(
    ...
    rerun::Error Loggable<blueprint::components::ColumnShare>::fill_arrow_array_builder(
