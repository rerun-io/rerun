...
// Based on "crates/build/re_type_definitions/rerun/blueprint/components/apply_latest_at.def.rs".
...
namespace rerun::blueprint::components {
    ...
    struct ApplyLatestAt {
        rerun::encodings::Bool apply_latest_at;

      public:
        ApplyLatestAt() = default;

        ApplyLatestAt(rerun::encodings::Bool apply_latest_at_)
            : apply_latest_at(apply_latest_at_) {}

        ApplyLatestAt& operator=(rerun::encodings::Bool apply_latest_at_) {
            apply_latest_at = apply_latest_at_;
            return *this;
        }
...
namespace rerun {
    static_assert(sizeof(rerun::encodings::Bool) == sizeof(blueprint::components::ApplyLatestAt));
