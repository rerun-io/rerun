...
namespace rerun {
    const std::shared_ptr<arrow::DataType>&
        Loggable<blueprint::components::IncludedContent>::arrow_datatype() {
        static const auto datatype = Loggable<rerun::datatypes::EntityPath>::arrow_datatype();
        return datatype;
    }

    rerun::Error Loggable<blueprint::components::IncludedContent>::fill_arrow_array_builder(
    ...
    Result<std::shared_ptr<arrow::Array>>
        Loggable<blueprint::components::IncludedContent>::to_arrow(
        ...
        if (instances && num_instances > 0) {
            RR_RETURN_NOT_OK(
                Loggable<blueprint::components::IncludedContent>::fill_arrow_array_builder(
