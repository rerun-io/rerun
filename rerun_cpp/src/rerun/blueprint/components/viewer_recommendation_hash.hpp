...
// Based on "crates/build/re_type_definitions/rerun/blueprint/components/viewer_recommendation_hash.def.rs".
...
namespace rerun::blueprint::components {
    ...
    struct ViewerRecommendationHash {
        rerun::encodings::UInt64 value;

      public:
        ViewerRecommendationHash() = default;

        ViewerRecommendationHash(rerun::encodings::UInt64 value_) : value(value_) {}

        ViewerRecommendationHash& operator=(rerun::encodings::UInt64 value_) {
            value = value_;
            return *this;
        }
        ...
        /// Cast to the underlying UInt64 encoding
        operator rerun::encodings::UInt64() const {
            return value;
        }
    };
} // namespace rerun::blueprint::components
...
namespace rerun {
    static_assert(
        sizeof(rerun::encodings::UInt64) == sizeof(blueprint::components::ViewerRecommendationHash)
    );
    ...
    struct Loggable<blueprint::components::ViewerRecommendationHash> {
        ...
        static const std::shared_ptr<arrow::DataType>& arrow_data_type() {
            return Loggable<rerun::encodings::UInt64>::arrow_data_type();
        }
        ...
        static Result<std::shared_ptr<arrow::Array>> to_arrow(
            ...
            if (num_instances == 0) {
                return Loggable<rerun::encodings::UInt64>::to_arrow(nullptr, 0);
                ...
                return Loggable<rerun::encodings::UInt64>::to_arrow(
                    &instances->value,
                    num_instances
                );
            }
