...
namespace rerun {
    const std::shared_ptr<arrow::DataType>&
        Loggable<blueprint::components::BackgroundKind>::arrow_data_type() {
        static const auto datatype = arrow::uint8();
        return datatype;
    }

    Result<std::shared_ptr<arrow::Array>> Loggable<blueprint::components::BackgroundKind>::to_arrow(
