...
// Based on "crates/build/re_type_definitions/rerun/blueprint/components/root_container.def.rs".
...
namespace rerun::blueprint::components {
    ...
    struct RootContainer {
        ...
        rerun::encodings::Uuid id;

      public:
        RootContainer() = default;

        RootContainer(rerun::encodings::Uuid id_) : id(id_) {}

        RootContainer& operator=(rerun::encodings::Uuid id_) {
            id = id_;
            return *this;
        }
...
namespace rerun {
    static_assert(sizeof(rerun::encodings::Uuid) == sizeof(blueprint::components::RootContainer));
    ...
    struct Loggable<blueprint::components::RootContainer> {
        ...
        static Result<std::shared_ptr<arrow::Array>> to_arrow(
            ...
            if (num_instances == 0) {
                ...
                return Loggable<rerun::encodings::Uuid>::to_arrow(&instances->id, num_instances);
            }
        }
    };
} // namespace rerun
