...
namespace rerun::blueprint::components {
    ...
    struct ZoomLevel {
        ...
        rerun::encodings::Float64 zoom;

      public:
        ZoomLevel() = default;

        ZoomLevel(rerun::encodings::Float64 zoom_) : zoom(zoom_) {}

        ZoomLevel& operator=(rerun::encodings::Float64 zoom_) {
            zoom = zoom_;
            return *this;
        }
...
namespace rerun {
    static_assert(sizeof(rerun::encodings::Float64) == sizeof(blueprint::components::ZoomLevel));
