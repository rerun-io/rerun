...
namespace rerun {
    const std::shared_ptr<arrow::DataType>&
        ...
        static const auto datatype = arrow::sparse_union({
            ...
            arrow::field("Hidden", arrow::null(), true),
            arrow::field("Collapsed", arrow::null(), true),
            arrow::field("Expanded", arrow::null(), true),
        });
        return datatype;
    }
    ...
    Result<std::shared_ptr<arrow::Array>> Loggable<blueprint::components::PanelState>::to_arrow(
        ...
        if (instances && num_instances > 0) {
            RR_RETURN_NOT_OK(Loggable<blueprint::components::PanelState>::fill_arrow_array_builder(
