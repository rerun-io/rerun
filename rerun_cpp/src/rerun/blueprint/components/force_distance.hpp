...
// Based on "crates/build/re_type_definitions/rerun/blueprint/components/force_distance.def.rs".
...
namespace rerun::blueprint::components {
    ...
    struct ForceDistance {
        rerun::encodings::Float64 distance;

      public:
        ForceDistance() = default;

        ForceDistance(rerun::encodings::Float64 distance_) : distance(distance_) {}

        ForceDistance& operator=(rerun::encodings::Float64 distance_) {
            distance = distance_;
            return *this;
        }
...
namespace rerun {
    static_assert(
        sizeof(rerun::encodings::Float64) == sizeof(blueprint::components::ForceDistance)
    );
