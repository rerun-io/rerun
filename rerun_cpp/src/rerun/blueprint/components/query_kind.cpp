...
namespace rerun {
    const std::shared_ptr<arrow::DataType>&
        Loggable<blueprint::components::QueryKind>::arrow_datatype() {
    ...
    Result<std::shared_ptr<arrow::Array>> Loggable<blueprint::components::QueryKind>::to_arrow(
        ...
        if (instances && num_instances > 0) {
            RR_RETURN_NOT_OK(Loggable<blueprint::components::QueryKind>::fill_arrow_array_builder(
    ...
    rerun::Error Loggable<blueprint::components::QueryKind>::fill_arrow_array_builder(
        arrow::SparseUnionBuilder* builder, const blueprint::components::QueryKind* elements,
        size_t num_elements
    ) {
        if (builder == nullptr) {
