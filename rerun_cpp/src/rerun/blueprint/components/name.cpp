...
namespace rerun {
    const std::shared_ptr<arrow::DataType>& Loggable<blueprint::components::Name>::arrow_datatype(
    ) {
        static const auto datatype = arrow::utf8();
        return datatype;
    }

    rerun::Error Loggable<blueprint::components::Name>::fill_arrow_array_builder(
    ...
    Result<std::shared_ptr<arrow::Array>> Loggable<blueprint::components::Name>::to_arrow(
        ...
        if (instances && num_instances > 0) {
            RR_RETURN_NOT_OK(Loggable<blueprint::components::Name>::fill_arrow_array_builder(
