...
#include "included_space_views.hpp"
...
namespace rerun {
    const std::shared_ptr<arrow::DataType>&
        Loggable<blueprint::components::IncludedSpaceViews>::arrow_datatype() {
    ...
    rerun::Error Loggable<blueprint::components::IncludedSpaceViews>::fill_arrow_array_builder(
    ...
    Result<std::shared_ptr<arrow::Array>>
        Loggable<blueprint::components::IncludedSpaceViews>::to_arrow(
        ...
        if (instances && num_instances > 0) {
            RR_RETURN_NOT_OK(
                Loggable<blueprint::components::IncludedSpaceViews>::fill_arrow_array_builder(
