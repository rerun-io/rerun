...
namespace rerun {
    const std::shared_ptr<arrow::DataType>&
        Loggable<blueprint::components::QueryExpression>::arrow_datatype() {
        static const auto datatype = Loggable<rerun::datatypes::Utf8>::arrow_datatype();
        return datatype;
    }

    rerun::Error Loggable<blueprint::components::QueryExpression>::fill_arrow_array_builder(
        arrow::StringBuilder* builder, const blueprint::components::QueryExpression* elements,
        size_t num_elements
    ) {
        static_assert(
            sizeof(rerun::datatypes::Utf8) == sizeof(blueprint::components::QueryExpression)
        );
    ...
    Result<std::shared_ptr<arrow::Array>>
        Loggable<blueprint::components::QueryExpression>::to_arrow(
        ...
        if (instances && num_instances > 0) {
            RR_RETURN_NOT_OK(
                Loggable<blueprint::components::QueryExpression>::fill_arrow_array_builder(
