...
// Based on "crates/build/re_type_definitions/rerun/blueprint/components/map_provider.def.rs".
...
namespace rerun {
    ...
    struct Loggable<blueprint::components::MapProvider> {
        static constexpr std::string_view ComponentType = "rerun.blueprint.components.MapProvider";
