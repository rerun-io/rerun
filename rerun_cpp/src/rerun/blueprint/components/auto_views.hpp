...
// Based on "crates/build/re_type_definitions/rerun/blueprint/components/auto_views.def.rs".
...
namespace rerun::blueprint::components {
    ...
    ///
    struct AutoViews {
        rerun::encodings::Bool auto_views;

      public:
        AutoViews() = default;

        AutoViews(rerun::encodings::Bool auto_views_) : auto_views(auto_views_) {}

        AutoViews& operator=(rerun::encodings::Bool auto_views_) {
...
namespace rerun {
    static_assert(sizeof(rerun::encodings::Bool) == sizeof(blueprint::components::AutoViews));

    /// \private
    template <>
    struct Loggable<blueprint::components::AutoViews> {
        static constexpr std::string_view ComponentType = "rerun.blueprint.components.AutoViews";
