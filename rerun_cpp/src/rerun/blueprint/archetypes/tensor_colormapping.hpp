    ...
    struct TensorColormapping {
      ...
      public:
        static constexpr const char IndicatorComponentName[] =
            "rerun.blueprint.components.TensorColormappingIndicator";

        /// Indicator component, used to identify the archetype when converting to a list of components.
        using IndicatorComponent = rerun::components::IndicatorComponent<IndicatorComponentName>;

      public:
        TensorColormapping() = default;
        TensorColormapping(TensorColormapping&& other) = default;

        /// How scalar values map to colors.
        TensorColormapping with_colormap(rerun::components::Colormap _colormap) && {
        ...
        /// Raiuses the normalized values to the power of this value before mapping to color.
        /// Acts like an inverse brightness. Defaults to 1.0.
        TensorColormapping with_gamma(rerun::components::GammaCorrection _gamma) && {
...
namespace rerun {
    ...
    /// \private
    template <>
    struct AsComponents<blueprint::archetypes::TensorColormapping> {
