...
namespace rerun::encodings {
    namespace detail {
        ...
        union TimeRangeBoundaryData {
            ...
            rerun::encodings::TimeInt cursor_relative;

            /// Boundary is an absolute value.
            rerun::encodings::TimeInt absolute;
    ...
    /// **Encoding**: Left or right boundary of a time range.
    struct TimeRangeBoundary {
        ...
        /// Boundary is a value relative to the time cursor.
        static TimeRangeBoundary cursor_relative(rerun::encodings::TimeInt cursor_relative) {
            TimeRangeBoundary self;
            self._tag = detail::TimeRangeBoundaryTag::CursorRelative;
            new (&self._data.cursor_relative) rerun::encodings::TimeInt(std::move(cursor_relative));
            return self;
        }

        /// Boundary is an absolute value.
        static TimeRangeBoundary absolute(rerun::encodings::TimeInt absolute) {
            TimeRangeBoundary self;
            self._tag = detail::TimeRangeBoundaryTag::Absolute;
            new (&self._data.absolute) rerun::encodings::TimeInt(std::move(absolute));
            return self;
        }
        ...
        const rerun::encodings::TimeInt* get_cursor_relative() const {
        ...
        const rerun::encodings::TimeInt* get_absolute() const {
...
namespace rerun {
    ...
    /// \private
    template <>
    struct Loggable<encodings::TimeRangeBoundary> {
        static constexpr std::string_view ComponentType = "rerun.encodings.TimeRangeBoundary";

        /// Returns the arrow data type this type corresponds to.
        static const std::shared_ptr<arrow::DataType>& arrow_datatype();

        /// Serializes an array of `rerun::encodings::TimeRangeBoundary` into an arrow array.
