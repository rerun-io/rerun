...
namespace rerun {
    ...
    /// \private
    template <>
    struct Loggable<encodings::UVec2D> {
        static constexpr std::string_view ComponentType = "rerun.encodings.UVec2D";

        /// Returns the arrow data type this type corresponds to.
        static const std::shared_ptr<arrow::DataType>& arrow_datatype();

        /// Serializes an array of `rerun::encodings::UVec2D` into an arrow array.
        ...
        static rerun::Error fill_arrow_array_builder(
            arrow::FixedSizeListBuilder* builder, const encodings::UVec2D* elements,
            size_t num_elements
        );
    };
} // namespace rerun
