...
namespace rerun {
    ...
    /// \private
    template <>
    struct Loggable<encodings::Quaternion> {
        static constexpr std::string_view ComponentType = "rerun.encodings.Quaternion";

        /// Returns the arrow data type this type corresponds to.
        static const std::shared_ptr<arrow::DataType>& arrow_datatype();

        /// Serializes an array of `rerun::encodings::Quaternion` into an arrow array.
