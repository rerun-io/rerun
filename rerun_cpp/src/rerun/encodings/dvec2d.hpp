...
namespace rerun {
    ...
    /// \private
    template <>
    struct Loggable<encodings::DVec2D> {
        ...
        static Result<std::shared_ptr<arrow::Array>> to_arrow(
            const encodings::DVec2D* instances, size_t num_instances
        );

        /// Fills an arrow array builder with an array of this type.
        static rerun::Error fill_arrow_array_builder(
            arrow::FixedSizeListBuilder* builder, const encodings::DVec2D* elements,
            size_t num_elements
        );
    };
} // namespace rerun
