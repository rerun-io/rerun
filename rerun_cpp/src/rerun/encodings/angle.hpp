...
namespace rerun {
    ...
    /// \private
    template <>
    struct Loggable<encodings::Angle> {
        static constexpr std::string_view ComponentType = "rerun.encodings.Angle";

        /// Returns the arrow data type this type corresponds to.
        static const std::shared_ptr<arrow::DataType>& arrow_datatype();

        /// Serializes an array of `rerun::encodings::Angle` into an arrow array.
