...
namespace rerun {
    ...
    Result<std::shared_ptr<arrow::Array>> Loggable<encodings::TimeRangeBoundary>::to_arrow(
        const encodings::TimeRangeBoundary* instances, size_t num_instances
    ) {
        ...
        if (instances && num_instances > 0) {
            RR_RETURN_NOT_OK(Loggable<encodings::TimeRangeBoundary>::fill_arrow_array_builder(
    ...
    rerun::Error Loggable<encodings::TimeRangeBoundary>::fill_arrow_array_builder(
        arrow::DenseUnionBuilder* builder, const encodings::TimeRangeBoundary* elements,
        size_t num_elements
    ) {
        if (builder == nullptr) {
        ...
        for (size_t elem_idx = 0; elem_idx < num_elements; elem_idx += 1) {
            ...
            using TagType = encodings::detail::TimeRangeBoundaryTag;
