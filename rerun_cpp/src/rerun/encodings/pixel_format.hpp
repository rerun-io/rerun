...
namespace rerun::encodings {
    ...
    ///
    /// Most images can be described by a `encodings::ColorModel` and a `encodings::ChannelDatatype`,
    /// e.g. `RGB` and `U8` respectively.
    ///
    /// However, some image formats has chroma downsampling and/or
    /// use differing number of bits per channel, and that is what this `encodings::PixelFormat` is for.
    ///
    ...
    enum class PixelFormat : uint8_t {
        ...
        ///
        /// Also known as just "gray". This is virtually identical to a 8bit luminance/grayscale (see `encodings::ColorModel`).
        ///
        ...
        /// If not for this range limitation/remapping, this is almost identical to 8bit luminace/grayscale (see `encodings::ColorModel`).
        Y8_LimitedRange = 41,
...
namespace rerun {
    ...
    /// \private
    template <>
    struct Loggable<encodings::PixelFormat> {
        static constexpr std::string_view ComponentType = "rerun.encodings.PixelFormat";

        /// Returns the arrow data type this type corresponds to.
        static const std::shared_ptr<arrow::DataType>& arrow_datatype();

        /// Serializes an array of `rerun::encodings::PixelFormat` into an arrow array.
        ...
        static rerun::Error fill_arrow_array_builder(
            arrow::UInt8Builder* builder, const encodings::PixelFormat* elements,
            size_t num_elements
        );
    };
} // namespace rerun
