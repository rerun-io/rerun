...
namespace rerun {
    ...
    /// \private
    template <>
    struct Loggable<encodings::ImageFormat> {
        static constexpr std::string_view ComponentType = "rerun.encodings.ImageFormat";

        /// Returns the arrow data type this type corresponds to.
        static const std::shared_ptr<arrow::DataType>& arrow_datatype();

        /// Serializes an array of `rerun::encodings::ImageFormat` into an arrow array.
        ...
        static rerun::Error fill_arrow_array_builder(
            arrow::StructBuilder* builder, const encodings::ImageFormat* elements,
            size_t num_elements
        );
    };
} // namespace rerun
