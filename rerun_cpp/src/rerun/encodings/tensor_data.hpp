...
namespace rerun::encodings {
    ...
    struct TensorData {
        ...
        ///
        /// If set, should be the same length as `encodings::TensorData::shape`.
      ...
      public: // START of extensions from tensor_data_ext.cpp:
        ...
        TensorData(Collection<uint64_t> shape_, encodings::TensorBuffer buffer_)
...
namespace rerun {
    ...
    /// \private
    template <>
    struct Loggable<encodings::TensorData> {
        static constexpr std::string_view ComponentType = "rerun.encodings.TensorData";

        /// Returns the arrow data type this type corresponds to.
        static const std::shared_ptr<arrow::DataType>& arrow_datatype();

        /// Serializes an array of `rerun::encodings::TensorData` into an arrow array.
        ...
        static rerun::Error fill_arrow_array_builder(
            arrow::StructBuilder* builder, const encodings::TensorData* elements,
            size_t num_elements
        );
    };
} // namespace rerun
