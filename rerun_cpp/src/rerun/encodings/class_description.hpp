...
namespace rerun::encodings {
    ...
    /// the attached `encodings::AnnotationInfo` to derive labels and colors.
    ///
    ...
    /// `encodings::AnnotationInfo` specifically associated with the Keypoint.
    ///
    ...
    /// colored as described by the class's `encodings::AnnotationInfo`.
    struct ClassDescription {
        /// The `encodings::AnnotationInfo` for the class.
        rerun::encodings::AnnotationInfo info;

        /// The `encodings::AnnotationInfo` for all of the keypoints.
        rerun::Collection<rerun::encodings::AnnotationInfo> keypoint_annotations;

        /// The connections between keypoints.
        rerun::Collection<rerun::encodings::KeypointPair> keypoint_connections;
      ...
      public: // START of extensions from class_description_ext.cpp:
        ...
        ClassDescription(
            ...
            std::optional<encodings::Rgba32> color = std::nullopt
        )
            : info(id, label, color) {}
...
namespace rerun {
    ...
    /// \private
    template <>
    struct Loggable<encodings::ClassDescription> {
        static constexpr std::string_view ComponentType = "rerun.encodings.ClassDescription";

        /// Returns the arrow data type this type corresponds to.
        static const std::shared_ptr<arrow::DataType>& arrow_datatype();

        /// Serializes an array of `rerun::encodings::ClassDescription` into an arrow array.
        static Result<std::shared_ptr<arrow::Array>> to_arrow(
            const encodings::ClassDescription* instances, size_t num_instances
        );

        /// Fills an arrow array builder with an array of this type.
        static rerun::Error fill_arrow_array_builder(
            arrow::StructBuilder* builder, const encodings::ClassDescription* elements,
            size_t num_elements
        );
    };
} // namespace rerun
