...
namespace rerun {
    ...
    /// \private
    template <>
    struct Loggable<encodings::Mat3x3> {
        static constexpr std::string_view ComponentType = "rerun.encodings.Mat3x3";

        /// Returns the arrow data type this type corresponds to.
        static const std::shared_ptr<arrow::DataType>& arrow_datatype();

        /// Serializes an array of `rerun::encodings::Mat3x3` into an arrow array.
        ...
        static rerun::Error fill_arrow_array_builder(
            arrow::FixedSizeListBuilder* builder, const encodings::Mat3x3* elements,
            size_t num_elements
        );
    };
} // namespace rerun
