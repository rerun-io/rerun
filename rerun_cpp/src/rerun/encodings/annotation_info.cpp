...
namespace rerun {
    ...
    Result<std::shared_ptr<arrow::Array>> Loggable<encodings::AnnotationInfo>::to_arrow(
        ...
        if (instances && num_instances > 0) {
            RR_RETURN_NOT_OK(Loggable<encodings::AnnotationInfo>::fill_arrow_array_builder(
    ...
    rerun::Error Loggable<encodings::AnnotationInfo>::fill_arrow_array_builder(
        ...
        }
        {
            ...
            for (size_t elem_idx = 0; elem_idx < num_elements; elem_idx += 1) {
                ...
                if (element.color.has_value()) {
                    RR_RETURN_NOT_OK(Loggable<rerun::encodings::Rgba32>::fill_arrow_array_builder(
                        field_builder,
                        &element.color.value(),
                        1
                    ));
