...
// Based on "crates/build/re_type_definitions/rerun/encodings/tensor_buffer.def.rs".
...
namespace rerun {
    ...
    /// \private
    template <>
    struct Loggable<encodings::TensorBuffer> {
        static constexpr std::string_view ComponentType = "rerun.encodings.TensorBuffer";

        /// Returns the arrow data type this type corresponds to.
        static const std::shared_ptr<arrow::DataType>& arrow_datatype();

        /// Serializes an array of `rerun::encodings::TensorBuffer` into an arrow array.
        static Result<std::shared_ptr<arrow::Array>> to_arrow(
            const encodings::TensorBuffer* instances, size_t num_instances
        );

        /// Fills an arrow array builder with an array of this type.
        static rerun::Error fill_arrow_array_builder(
            arrow::DenseUnionBuilder* builder, const encodings::TensorBuffer* elements,
            size_t num_elements
        );
    };
} // namespace rerun
