...
namespace rerun {
    const std::shared_ptr<arrow::DataType>& Loggable<encodings::TensorBuffer>::arrow_data_type() {
    ...
    Result<std::shared_ptr<arrow::Array>> Loggable<encodings::TensorBuffer>::to_arrow(
        ...
        if (instances && num_instances > 0) {
            RR_RETURN_NOT_OK(Loggable<encodings::TensorBuffer>::fill_arrow_array_builder(
    ...
    rerun::Error Loggable<encodings::TensorBuffer>::fill_arrow_array_builder(
        ...
        for (size_t elem_idx = 0; elem_idx < num_elements; elem_idx += 1) {
            ...
            using TagType = encodings::detail::TensorBufferTag;
