...
namespace rerun {
    const std::shared_ptr<arrow::DataType>& Loggable<encodings::ClassDescription>::arrow_data_type(
    ) {
        static const auto datatype = arrow::struct_({
            arrow::field(
                "info",
                Loggable<rerun::encodings::AnnotationInfo>::arrow_data_type(),
                false
            ),
            arrow::field(
            ...
            arrow::field(
                ...
                arrow::list(arrow::field(
                    "item",
                    Loggable<rerun::encodings::KeypointPair>::arrow_data_type(),
                    false
                )),
                false
            ),
    ...
    Result<std::shared_ptr<arrow::Array>> Loggable<encodings::ClassDescription>::to_arrow(
        ...
        if (instances && num_instances > 0) {
            RR_RETURN_NOT_OK(Loggable<encodings::ClassDescription>::fill_arrow_array_builder(
    ...
    rerun::Error Loggable<encodings::ClassDescription>::fill_arrow_array_builder(
...

        {
            ...
            for (size_t elem_idx = 0; elem_idx < num_elements; elem_idx += 1) {
                RR_RETURN_NOT_OK(
                    Loggable<rerun::encodings::AnnotationInfo>::fill_arrow_array_builder(
                        field_builder,
        ...
        }
        {
            ...
            for (size_t elem_idx = 0; elem_idx < num_elements; elem_idx += 1) {
                ...
                if (element.keypoint_connections.data()) {
                    RR_RETURN_NOT_OK(
                        Loggable<rerun::encodings::KeypointPair>::fill_arrow_array_builder(
                            value_builder,
