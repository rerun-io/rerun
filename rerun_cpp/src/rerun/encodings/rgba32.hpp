...
namespace rerun {
    ...
    /// \private
    template <>
    struct Loggable<encodings::Rgba32> {
        static constexpr std::string_view ComponentType = "rerun.encodings.Rgba32";

        /// Returns the arrow data type this type corresponds to.
        static const std::shared_ptr<arrow::DataType>& arrow_datatype();

        /// Serializes an array of `rerun::encodings::Rgba32` into an arrow array.
