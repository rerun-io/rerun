...
namespace rerun {
    ...
    /// \private
    template <>
    struct Loggable<encodings::Mat4x4> {
        static constexpr std::string_view ComponentType = "rerun.encodings.Mat4x4";

        /// Returns the arrow data type this type corresponds to.
        static const std::shared_ptr<arrow::DataType>& arrow_datatype();

        /// Serializes an array of `rerun::encodings::Mat4x4` into an arrow array.
        ...
        static rerun::Error fill_arrow_array_builder(
            arrow::FixedSizeListBuilder* builder, const encodings::Mat4x4* elements,
            size_t num_elements
        );
    };
} // namespace rerun
