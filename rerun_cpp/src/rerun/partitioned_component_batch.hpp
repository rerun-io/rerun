...
namespace rerun {
    ...
    struct PartitionedComponentBatch {
      ...
      public:
        ...
        template <typename T>
        static Result<PartitionedComponentBatch> from_loggable(
        ...
        static Result<PartitionedComponentBatch> from_loggable(const Collection<T>& components) {
            return PartitionedComponentBatch::from_loggable(
                components,
        ...
        static Result<PartitionedComponentBatch> from_batch_and_lengths(
