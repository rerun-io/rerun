...
#include "graph_edges_directed.hpp"
...
namespace rerun {
    ...
    Result<std::vector<ComponentBatch>> AsComponents<archetypes::GraphEdgesDirected>::serialize(
        ...
        {
            auto indicator = GraphEdgesDirected::IndicatorComponent();
