...
namespace rerun::archetypes {
    Ellipses2D Ellipses2D::clear_fields() {
        auto archetype = Ellipses2D();
    ...
    Collection<ComponentColumn> Ellipses2D::columns(const Collection<uint32_t>& lengths_) {
    ...
    Collection<ComponentColumn> Ellipses2D::columns() {
        if (half_sizes.has_value()) {
...
namespace rerun {
    ...
    Result<Collection<ComponentBatch>> AsComponents<archetypes::Ellipses2D>::as_batches(
        const archetypes::Ellipses2D& archetype
    ) {
