...
namespace rerun::archetypes {
    Cones3D Cones3D::clear_fields() {
        auto archetype = Cones3D();
        archetype.lengths =
    ...
    Collection<ComponentColumn> Cones3D::columns() {
        if (lengths.has_value()) {
...
namespace rerun {
    ...
    Result<Collection<ComponentBatch>> AsComponents<archetypes::Cones3D>::as_batches(
        const archetypes::Cones3D& archetype
    ) {
