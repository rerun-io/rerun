...
namespace rerun::archetypes {
    Rays3D Rays3D::clear_fields() {
        auto archetype = Rays3D();
        archetype.vectors =
    ...
    Collection<ComponentColumn> Rays3D::columns(const Collection<uint32_t>& lengths_) {
    ...
    Collection<ComponentColumn> Rays3D::columns() {
        if (vectors.has_value()) {
...
namespace rerun {
    ...
    Result<Collection<ComponentBatch>> AsComponents<archetypes::Rays3D>::as_batches(
        const archetypes::Rays3D& archetype
    ) {
