...
namespace rerun::archetypes {
    ...
    struct Ellipsoids3D {
      ...
      public:
        // Extensions to generated type defined in 'ellipsoids3d_ext.cpp'
      ...
      public:
        ...
        ///
        /// If not specified, the centers will be at (0, 0, 0).
        Ellipsoids3D with_centers(Collection<rerun::components::Position3D> _centers) && {
        ...
        ///
        /// If not specified, the axes of the ellipsoid align with the axes of the coordinate system.
        Ellipsoids3D with_rotations(Collection<rerun::components::Rotation3D> _rotations) && {
