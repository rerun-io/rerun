    ...
    struct Transform3D {
      ...
      public:
        ...
        static constexpr auto Descriptor_translation = ComponentDescriptor(
            ArchetypeName, "translation", Loggable<rerun::components::Translation3D>::ComponentType
        );
