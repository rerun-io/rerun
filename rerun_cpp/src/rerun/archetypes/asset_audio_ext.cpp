...
namespace rerun::archetypes {
    ...
    Result<AssetAudio> AssetAudio::from_file_path(const std::filesystem::path& path) {
        ...
        if (!file || length < 0) {
            return Error(ErrorCode::FileReadFailure, "Failed to read file: " + path.string());
        }
        ...
        return AssetAudio::from_file_contents(
