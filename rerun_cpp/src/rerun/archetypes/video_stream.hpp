...
// Based on "crates/build/re_type_definitions/rerun/archetypes/video_stream.def.rs".
...
namespace rerun::archetypes {
    ...
    /// Individual frames can be displayed with `archetypes::VideoFrameReference`, which uses the active Viewer timeline.
    ///
