...
if(ON)
    if(NOT TARGET rerun_c)
        ...
        get_filename_component(RERUN_C_LIB_NAME "/Users/nick/repos/rerun/target//release/librerun_c.a" NAME)
...
if(OFF AND NOT OFF)
    ...
    if(NOT TARGET rerun_arrow_target)
        ...
        get_filename_component(RERUN_ARROW_LIB_NAME "" NAME)
    ...
    if(NOT TARGET arrow_targetBundledDeps)
        ...
        get_filename_component(RERUN_ARROW_DEPS_LIB_NAME "" NAME)
