...
* [rerun_c](../crates/rerun_c/) static libraries
...
In order to build without CMake, you have to add all files from the [src/](src/) folder
...
Refer to the [build instruction](../BUILD.md) at the repo root.

Keep in mind that all archetypes/components/datatypes are mostly generated by the [Rerun types builder](../crates/re_types_builder).
