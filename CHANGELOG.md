...
Table filtering just got a lot more capable.
You can now filter on timestamps, use new string operators like `starts with`, `ends with`, and `does not contain`, and combine these with improved numeric and boolean filtering.
These changes make it easier to slice and explore your data directly in the Viewer.
...
- Represent `std_msgs/msg/Empty` as empty list [#11460](https://github.com/rerun-io/rerun/pull/11460)
