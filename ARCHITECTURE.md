...
NOTE: `.rrd` files do not yet guarantee any backwards or forwards compatibility. One version of Rerun is able to open an `.rrd` file generated by *previous* Rerun version, but it will likely not work for older versions.
